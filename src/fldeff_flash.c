...
static const struct FlashStruct sTransitionTypes[] =
{
    ...
    {MAP_TYPE_BURIAL_GROUND,     MAP_TYPE_UNDERGROUND,  TRUE, FALSE, DoEnterCaveTransition},
    ...
    {MAP_TYPE_UNDERGROUND, MAP_TYPE_BURIAL_GROUND,     FALSE,  TRUE, DoExitCaveTransition},
