...
static const u8 sRubyFacilityClassToEmerald[RS_FACILITY_CLASSES_COUNT - 2][2] =
{
    ...
    {RS_FACILITY_CLASS_POKE_MANIAC, FACILITY_CLASS_POKE_MANIAC},
    ...
    {RS_FACILITY_CLASS_SCHOOLKID_M, FACILITY_CLASS_SCHOOLKID_M},
    {RS_FACILITY_CLASS_SCHOOLKID_F, FACILITY_CLASS_SCHOOLKID_F},
    {RS_FACILITY_CLASS_TEAMMATES, FACILITY_CLASS_TEAMMATES},
    {RS_FACILITY_CLASS_POKE_FAN_M, FACILITY_CLASS_POKE_FAN_M},
    {RS_FACILITY_CLASS_POKE_FAN_F, FACILITY_CLASS_POKE_FAN_F},
