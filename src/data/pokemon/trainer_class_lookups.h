const u8 gFacilityClassToPicIndex[] =
{
    ...
    [FACILITY_CLASS_POKE_MANIAC] = TRAINER_PIC_POKE_MANIAC,
    ...
    [FACILITY_CLASS_SCHOOLKID_M] = TRAINER_PIC_SCHOOLKID_M,
    [FACILITY_CLASS_SCHOOLKID_F] = TRAINER_PIC_SCHOOLKID_F,
    [FACILITY_CLASS_TEAMMATES] = TRAINER_PIC_TEAMMATES,
    [FACILITY_CLASS_POKE_FAN_M] = TRAINER_PIC_POKE_FAN_M,
    [FACILITY_CLASS_POKE_FAN_F] = TRAINER_PIC_POKE_FAN_F,
