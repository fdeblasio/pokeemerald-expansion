...
static const struct TrainerMon sParty_Parker[] = {
    ...
    .lvl = 28,
    .species = SPECIES_LOUDRED,
    .moves = {MOVE_TEETER_DANCE, MOVE_DIZZY_PUNCH, MOVE_NONE, MOVE_NONE}
    }
};
...
static const struct TrainerMon sParty_George[] = {
    ...
    .moves = {MOVE_STOCKPILE, MOVE_SWALLOW, MOVE_BODY_SLAM, MOVE_RECYCLE}
    }
};
...
static const struct TrainerMon sParty_Ambrose[] = {
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 43,
...
static const struct TrainerMon sParty_Bridley[] = {
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 44,
...
static const struct TrainerMon sParty_Gabe[] = {
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 43,
    .species = SPECIES_QWILFISH,
...
static const struct TrainerMon sParty_Mike[] = {
    ...
    .moves = {MOVE_SHOCK_WAVE, MOVE_CHARGE, MOVE_COTTON_SPORE, MOVE_THUNDER_WAVE}
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 19,
    .species = SPECIES_LUXIO,
    .moves = {MOVE_SHOCK_WAVE, MOVE_BITE, MOVE_CHARGE, MOVE_LEER}
    }
};
...
static const struct TrainerMon sParty_Nathan[] = {
    {
    .lvl = 60,
...
static const struct TrainerMon sParty_Erik[] = {
    {
    .lvl = 47,
    .species = SPECIES_GIGALITH,
    .ability = ABILITY_SAND_STREAM,
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .moves = {MOVE_STONE_EDGE, MOVE_BODY_PRESS, MOVE_IRON_DEFENSE, MOVE_SANDSTORM},
    },
    {
    .lvl = 47,
    ...
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .moves = {MOVE_POWER_GEM, MOVE_FLASH_CANNON, MOVE_BODY_PRESS, MOVE_STEALTH_ROCK},
    },
    {
    .lvl = 48,
    .species = SPECIES_GOLEM,
    ...
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .moves = {MOVE_ROCK_BLAST, MOVE_EARTHQUAKE, MOVE_BODY_PRESS, MOVE_STEALTH_ROCK},
    },
    {
    .lvl = 48,
    .species = SPECIES_AERODACTYL,
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .moves = {MOVE_ROCK_SLIDE, MOVE_DUAL_WINGBEAT, MOVE_IRON_HEAD, MOVE_AGILITY},
    },
    {
    .lvl = 50,
    .species = SPECIES_SUDOWOODO,
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .moves = {MOVE_HEAD_SMASH, MOVE_WOOD_HAMMER, MOVE_BODY_PRESS, MOVE_SUCKER_PUNCH},
    .heldItem = ITEM_SITRUS_BERRY,
    }
};

static const struct TrainerMon sParty_Angel[] = {
    {
    .lvl = 49,
    .species = SPECIES_SWELLOW,
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .moves = {MOVE_ACROBATICS, MOVE_FACADE, MOVE_STEEL_WING, MOVE_DOUBLE_TEAM},
    },
    {
    .lvl = 49,
    .species = SPECIES_PIDGEOT,
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .moves = {MOVE_ACROBATICS, MOVE_FACADE, MOVE_STEEL_WING, MOVE_TAILWIND},
    },
    {
    .lvl = 50,
    .species = SPECIES_ALTARIA,
...
static const struct TrainerMon sParty_Jose[] = {
    ...
    .species = SPECIES_CARNIVINE,
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .moves = {MOVE_SEED_BOMB, MOVE_CRUNCH, MOVE_SWORDS_DANCE, MOVE_INGRAIN},
    },
    {
    .lvl = 51,
    .species = SPECIES_CRADILY,
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .moves = {MOVE_GIGA_DRAIN, MOVE_ANCIENT_POWER, MOVE_LEECH_SEED, MOVE_INGRAIN},
    },
    {
    .lvl = 52,
    .species = SPECIES_BRELOOM,
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .moves = {MOVE_SEED_BOMB, MOVE_DRAIN_PUNCH, MOVE_ROCK_SLIDE, MOVE_SPORE},
    },
    {
    .lvl = 52,
    .species = SPECIES_EXEGGUTOR,
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .moves = {MOVE_GIGA_DRAIN, MOVE_PSYCHIC, MOVE_SUNNY_DAY, MOVE_CALM_MIND},
    },
    {
    .lvl = 54,
    .species = SPECIES_TANGROWTH,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .moves = {MOVE_GIGA_DRAIN, MOVE_SLUDGE_BOMB, MOVE_FOCUS_BLAST, MOVE_GRASSY_TERRAIN},
    .heldItem = ITEM_SITRUS_BERRY,
    }
};

static const struct TrainerMon sParty_Vannessa[] = {
    {
    .lvl = 53,
    .species = SPECIES_HONCHKROW,
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .moves = {MOVE_NIGHT_SLASH, MOVE_DRILL_PECK, MOVE_FOUL_PLAY, MOVE_SWAGGER},
    },
    {
    .lvl = 53,
    .species = SPECIES_ABSOL,
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .moves = {MOVE_NIGHT_SLASH, MOVE_PSYCHO_CUT, MOVE_X_SCISSOR, MOVE_SWORDS_DANCE},
    },
    {
    .lvl = 53,
    .species = SPECIES_WEAVILE,
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .moves = {MOVE_NIGHT_SLASH, MOVE_ICE_PUNCH, MOVE_ICE_SHARD, MOVE_SWORDS_DANCE},
    },
    {
    .lvl = 54,
...
static const struct TrainerMon sParty_Kenny1[] = {
    {
    .lvl = 16,
    .species = SPECIES_GASTLY,
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .moves = {MOVE_HEX, MOVE_SPITE, MOVE_CONFUSE_RAY, MOVE_MEAN_LOOK},
    },
    {
    .lvl = 16,
    .species = SPECIES_LITWICK,
    ...
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .moves = {MOVE_HEX, MOVE_EMBER, MOVE_CONFUSE_RAY, MOVE_MINIMIZE},
    },
    {
    .lvl = 19,
    ...
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .moves = {MOVE_HEX, MOVE_GUST, MOVE_FOCUS_ENERGY, MOVE_MINIMIZE},
    .heldItem = ITEM_SITRUS_BERRY,
    }
};
...
static const struct TrainerMon sParty_Frank1[] = {
    ...
    .species = SPECIES_VOLTORB,
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .moves = {MOVE_SHOCK_WAVE, MOVE_SWIFT, MOVE_ROLLOUT, MOVE_EERIE_IMPULSE},
    },
    {
    .lvl = 22,
    .species = SPECIES_MAREEP,
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .moves = {MOVE_SHOCK_WAVE, MOVE_COTTON_SPORE, MOVE_CHARGE, MOVE_THUNDER_WAVE},
    },
    {
    .lvl = 22,
    .species = SPECIES_ZANGOOSE,
    .iv = TRAINER_PARTY_IVS(26, 26, 26, 26, 26, 26),
    .moves = {MOVE_SHOCK_WAVE, MOVE_SLASH, MOVE_METAL_CLAW, MOVE_HONE_CLAWS},
    .nickname = COMPOUND_STRING("Zang")
    },
    {
    .lvl = 24,
    .species = SPECIES_ELEKID,
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .moves = {MOVE_SHOCK_WAVE, MOVE_SWIFT, MOVE_CHARGE, MOVE_THUNDER_WAVE},
...
static const struct TrainerMon sParty_Norman1[] = {
    ...
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .moves = {MOVE_FACADE, MOVE_DRILL_RUN, MOVE_GLARE, MOVE_DEFENSE_CURL},
    },
    {
    .lvl = 30,
    .species = SPECIES_SNORLAX,
    ...
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .moves = {MOVE_FACADE, MOVE_CRUNCH, MOVE_BLOCK, MOVE_YAWN},
    },
    {
    .lvl = 30,
    .species = SPECIES_LOUDRED,
    ...
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .moves = {MOVE_FACADE, MOVE_BITE, MOVE_ROAR, MOVE_HOWL},
    },
    {
    .lvl = 32,
    .species = SPECIES_LICKILICKY,
    .ability = ABILITY_THICK_FAT,
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .moves = {MOVE_FACADE, MOVE_LICK, MOVE_WRAP, MOVE_SUPERSONIC},
    .heldItem = ITEM_SITRUS_BERRY,
    }
};

static const struct TrainerMon sParty_Jorge1[] = {
    {
    .lvl = 32,
    .species = SPECIES_TORKOAL,
    .ability = ABILITY_DROUGHT,
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .moves = {MOVE_FLAMETHROWER, MOVE_CLEAR_SMOG, MOVE_RAPID_SPIN, MOVE_PROTECT},
    },
    {
    .lvl = 32,
    .species = SPECIES_HEATMOR,
    ...
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .moves = {MOVE_FLAMETHROWER, MOVE_BUG_BITE, MOVE_STOCKPILE, MOVE_SWALLOW},
    },
    {
    .lvl = 33,
    ...
    .ability = ABILITY_FLASH_FIRE,
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .moves = {MOVE_FLAMETHROWER, MOVE_CRUNCH, MOVE_AGILITY, MOVE_HOWL},
    .gender = TRAINER_MON_MALE,
    .nickname = COMPOUND_STRING("Leo")
    },
    {
    .lvl = 33,
    .species = SPECIES_NINETALES,
    ...
    .gender = TRAINER_MON_FEMALE,
    .nickname = COMPOUND_STRING("Kylie")
    },
    {
    .lvl = 35,
    .species = SPECIES_DARMANITAN,
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .moves = {MOVE_FLAMETHROWER, MOVE_HAMMER_ARM, MOVE_UPROAR, MOVE_WORK_UP},
    .heldItem = ITEM_SITRUS_BERRY,
    .gender = TRAINER_MON_MALE,
    .nickname = COMPOUND_STRING("Thomas")
    }
};
...
static const struct TrainerMon sParty_RafiAndKim1[] = {
    ...
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .moves = {MOVE_DRAIN_PUNCH, MOVE_BOUNCE, MOVE_ROOST, MOVE_SWORDS_DANCE},
    },
    {
    .lvl = 41,
    .species = SPECIES_PASSIMIAN,
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .moves = {MOVE_DRAIN_PUNCH, MOVE_BEAT_UP, MOVE_FOCUS_ENERGY, MOVE_BULK_UP},
    },
    {
    .lvl = 42,
    .species = SPECIES_SIRFETCHD,
    ...
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .moves = {MOVE_DRAIN_PUNCH, MOVE_KNOCK_OFF, MOVE_DUAL_CHOP, MOVE_BULK_UP},
    .heldItem = ITEM_FLAME_ORB,
    }
};

static const struct TrainerMon sParty_Eric1[] = {
    {
    .lvl = 44,
    .species = SPECIES_SEVIPER,
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    ...
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .moves = {MOVE_POISON_JAB, MOVE_EARTH_POWER, MOVE_CRUNCH, MOVE_TOXIC_SPIKES},
    },
    {
    .lvl = 45,
    .species = SPECIES_NIDOKING,
    .ability = ABILITY_POISON_POINT,
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .moves = {MOVE_POISON_JAB, MOVE_EARTH_POWER, MOVE_MEGAHORN, MOVE_TOXIC},
    },
    {
    .lvl = 45,
    .species = SPECIES_SWALOT,
    ...
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .moves = {MOVE_POISON_JAB, MOVE_BODY_SLAM, MOVE_YAWN, MOVE_AMNESIA},
    },
    {
    .lvl = 47,
    ...
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .moves = {MOVE_POISON_JAB, MOVE_SUCKER_PUNCH, MOVE_FLAMETHROWER, MOVE_TOXIC},
...
static const struct TrainerMon sParty_Bettan[] = {
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 42,
    .species = SPECIES_QWILFISH,
...
static const struct TrainerMon sParty_Junya[] = {
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 19,
    .species = SPECIES_VOLTORB,
    .moves = {MOVE_SHOCK_WAVE, MOVE_ROLLOUT, MOVE_CHARGE, MOVE_EERIE_IMPULSE}
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 19,
    .species = SPECIES_JOLTIK,
    .moves = {MOVE_SHOCK_WAVE, MOVE_BUG_BITE, MOVE_STRING_SHOT, MOVE_THUNDER_WAVE}
    }
};
...
static const struct TrainerMon sParty_Wallace[] = {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .moves = {MOVE_BLIZZARD, MOVE_FREEZE_DRY, MOVE_FLASH_CANNON, MOVE_LIGHT_SCREEN},
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .moves = {MOVE_ICICLE_CRASH, MOVE_EARTHQUAKE, MOVE_AQUA_JET, MOVE_BULK_UP},
    .gender = TRAINER_MON_MALE,
    },
    {
    .lvl = 56,
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .moves = {MOVE_BLIZZARD, MOVE_BUG_BUZZ, MOVE_DAZZLING_GLEAM, MOVE_QUIVER_DANCE},
    .gender = TRAINER_MON_FEMALE,
    },
    {
    .lvl = 56,
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .moves = {MOVE_ICICLE_CRASH, MOVE_EARTHQUAKE, MOVE_IRON_HEAD, MOVE_ICE_SHARD},
    .gender = TRAINER_MON_MALE,
    },
    {
    .lvl = 58,
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .moves = {MOVE_BLIZZARD, MOVE_SURF, MOVE_SIGNAL_BEAM, MOVE_BRINE},
    .gender = TRAINER_MON_MALE,
    .heldItem = ITEM_SITRUS_BERRY,
...
static const struct TrainerMon sParty_Lao1[] = {
    ...
    .lvl = 22,
    .species = SPECIES_TRAPINCH,
    .moves = {MOVE_DIG, MOVE_MUD_SLAP, MOVE_SAND_ATTACK, MOVE_ASTONISH}
    },
    {
    .lvl = 22,
    .species = SPECIES_STUNKY,
    .moves = {MOVE_ACID_SPRAY, MOVE_SMOKESCREEN, MOVE_POISON_GAS, MOVE_BITE}
    }
};
...
static const struct TrainerMon sParty_Lao2[] = {
    ...
    .lvl = 30,
    .species = SPECIES_GULPIN,
    .moves = {MOVE_ACID_SPRAY, MOVE_POISON_GAS, MOVE_TOXIC, MOVE_AMNESIA}
    },
    {
    .lvl = 30,
    .species = SPECIES_TORKOAL,
...
static const struct TrainerMon sParty_Lao4[] = {
    ...
    .moves = {MOVE_DIG, MOVE_MUD_SLAP, MOVE_SAND_ATTACK, MOVE_SUPERSONIC}
    },
    {
    .iv = TRAINER_PARTY_IVS(3, 3, 3, 3, 3, 3),
    .lvl = 36,
    .species = SPECIES_SKUNTANK,
    .moves = {MOVE_ACID_SPRAY, MOVE_SMOKESCREEN, MOVE_POISON_GAS, MOVE_SUCKER_PUNCH}
    }
};
...
static const struct TrainerMon sParty_Lao5[] = {
    ...
    .species = SPECIES_SKUNTANK,
    .moves = {MOVE_ACID_SPRAY, MOVE_SMOKESCREEN, MOVE_POISON_GAS, MOVE_NIGHT_SLASH}
    }
};
...
static const struct TrainerMon sParty_Madeline3[] = {
    ...
    .lvl = 36,
    .species = SPECIES_EXEGGCUTE,
    .moves = {MOVE_GIGA_DRAIN, MOVE_CONFUSION, MOVE_LEECH_SEED, MOVE_SUNNY_DAY}
    },
    {
    .iv = TRAINER_PARTY_IVS(2, 2, 2, 2, 2, 2),
    .lvl = 36,
...
static const struct TrainerMon sParty_Madeline5[] = {
    ...
    .lvl = 42,
    .species = SPECIES_EXEGGUTOR,
    .moves = {MOVE_SOLAR_BEAM, MOVE_PSYSHOCK, MOVE_LEECH_SEED, MOVE_SUNNY_DAY}
    },
    {
    .iv = TRAINER_PARTY_IVS(4, 4, 4, 4, 4, 4),
    .lvl = 42,
...
static const struct TrainerMon sParty_WallyVR1[] = {
    ...
    .species = SPECIES_GRUMPIG,
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .moves = {MOVE_PSYCHIC, MOVE_POWER_GEM, MOVE_DAZZLING_GLEAM, MOVE_TEETER_DANCE},
    },
    {
    .lvl = 46,
    .species = SPECIES_CHIMECHO,
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .moves = {MOVE_PSYCHIC, MOVE_UPROAR, MOVE_HEAL_BELL, MOVE_CALM_MIND},
    },
    {
    .lvl = 47,
    .species = SPECIES_ALAKAZAM,
    ...
    .species = SPECIES_BEHEEYEM,
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .moves = {MOVE_PSYCHIC, MOVE_FLASH_CANNON, MOVE_THUNDERBOLT, MOVE_RECOVER},
    },
    {
    .lvl = 49,
    .species = SPECIES_GALLADE,
...
static const struct TrainerMon sParty_Cristobal[] = {
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 43,
    .species = SPECIES_WHIRLIPEDE,
...
static const struct TrainerMon sParty_Kirk1[] = {
    {
    .lvl = 10,
    .species = SPECIES_PELIPPER,
...
static const struct TrainerMon sParty_Kirk2[] = {
    {
    .lvl = 19,
    .species = SPECIES_WHISMUR,
    },
...
static const struct TrainerMon sParty_Marino[] = {
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 30,
    .species = SPECIES_NUMEL,
...
static const struct TrainerMon sParty_Patty[] = {
    {
    .iv = TRAINER_PARTY_IVS(1, 1, 1, 1, 1, 1),
    .lvl = 29,
    .species = SPECIES_MIGHTYENA,
...
static const struct TrainerMon sParty_Kenny2[] = {
    {
    .lvl = 60,
    .species = SPECIES_MISMAGIUS,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .moves = {MOVE_HEX, MOVE_MYSTICAL_FIRE, MOVE_POWER_GEM, MOVE_WILL_O_WISP},
    },
    {
    .lvl = 63,
    .species = SPECIES_GENGAR,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .moves = {MOVE_HEX, MOVE_DREAM_EATER, MOVE_HYPNOSIS, MOVE_DESTINY_BOND},
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .moves = {MOVE_HEX, MOVE_FLAMETHROWER, MOVE_WILL_O_WISP, MOVE_MINIMIZE},
    .heldItem = ITEM_FLAME_ORB,
    },
    {
    .lvl = 65,
    ...
    .ability = ABILITY_UNBURDEN,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .moves = {MOVE_HEX, MOVE_AIR_SLASH, MOVE_STRENGTH_SAP, MOVE_TAILWIND},
    .heldItem = ITEM_SITRUS_BERRY,
    }
};

static const struct TrainerMon sParty_Kenny3[] = {
    {
    .lvl = 65,
    .species = SPECIES_GOLURK,
    .ability = ABILITY_IRON_FIST,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .moves = {MOVE_SHADOW_PUNCH, MOVE_HIGH_HORSEPOWER, MOVE_DRAIN_PUNCH, MOVE_ICE_PUNCH},
    },
    {
    .lvl = 65,
    .species = SPECIES_MISMAGIUS,
...
static const struct TrainerMon sParty_Kenny4[] = {
    {
    .lvl = 70,
    .species = SPECIES_GOLURK,
    .ability = ABILITY_IRON_FIST,
...
static const struct TrainerMon sParty_Kenny5[] = {
    {
    .lvl = 75,
    .species = SPECIES_MAROWAK_ALOLAN,
    ...
    .ability = ABILITY_IRON_FIST,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .moves = {MOVE_SHADOW_PUNCH, MOVE_HIGH_HORSEPOWER, MOVE_DRAIN_PUNCH, MOVE_THUNDER_PUNCH},
    },
    {
    .lvl = 75,
    .species = SPECIES_MISMAGIUS,
...
static const struct TrainerMon sParty_Frank2[] = {
    ...
    .species = SPECIES_ELECTRODE,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .moves = {MOVE_THUNDERBOLT, MOVE_SWIFT, MOVE_LIGHT_SCREEN, MOVE_ELECTRIC_TERRAIN},
    },
    {
    .lvl = 63,
    .species = SPECIES_AMPHAROS,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .moves = {MOVE_THUNDERBOLT, MOVE_POWER_GEM, MOVE_DAZZLING_GLEAM, MOVE_COTTON_GUARD},
    ...
    .species = SPECIES_ZANGOOSE,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .moves = {MOVE_THUNDER_PUNCH, MOVE_BODY_SLAM, MOVE_SEED_BOMB, MOVE_SWORDS_DANCE},
    ...
    .species = SPECIES_ELECTABUZZ,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .moves = {MOVE_THUNDERBOLT, MOVE_PSYCHIC, MOVE_LIGHT_SCREEN, MOVE_ELECTRIC_TERRAIN},
    .heldItem = ITEM_EVIOLITE,
    }
};
...
static const struct TrainerMon sParty_Frank3[] = {
    ...
    .species = SPECIES_RAICHU,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .moves = {MOVE_THUNDERBOLT, MOVE_GRASS_KNOT, MOVE_ELECTRIC_TERRAIN, MOVE_NASTY_PLOT},
    },
    {
    .lvl = 65,
    .species = SPECIES_ELECTRODE,
...
static const struct TrainerMon sParty_Frank5[] = {
    ...
    .species = SPECIES_LUXRAY,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .moves = {MOVE_WILD_CHARGE, MOVE_CRUNCH, MOVE_PSYCHIC_FANGS, MOVE_ICE_FANG},
    },
    {
    .lvl = 75,
    .species = SPECIES_RAICHU,
...
static const struct TrainerMon sParty_Carlos2[] = {
    ...
    .ability = ABILITY_SNIPER,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .moves = {MOVE_LUNGE, MOVE_CROSS_POISON, MOVE_TOXIC_THREAD, MOVE_SWORDS_DANCE},
    .ball = ITEM_NET_BALL,
    },
    {
    .lvl = 63,
    ...
    .ability = ABILITY_SPEED_BOOST,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .moves = {MOVE_LUNGE, MOVE_POISON_JAB, MOVE_BATON_PASS, MOVE_SWORDS_DANCE},
    ...
    .ability = ABILITY_TECHNICIAN,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .moves = {MOVE_LUNGE, MOVE_BULLET_PUNCH, MOVE_DUAL_WINGBEAT, MOVE_SWORDS_DANCE},
...
static const struct TrainerMon sParty_Carlos3[] = {
    {
    .lvl = 65,
    .species = SPECIES_GALVANTULA,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
...
static const struct TrainerMon sParty_Carlos4[] = {
    {
    .lvl = 70,
    .species = SPECIES_FROSMOTH,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .moves = {MOVE_BUG_BUZZ, MOVE_ICE_BEAM, MOVE_WIDE_GUARD, MOVE_QUIVER_DANCE},
    .ball = ITEM_NET_BALL,
    },
    {
    .lvl = 70,
...
static const struct TrainerMon sParty_Carlos5[] = {
    {
    .lvl = 75,
    .species = SPECIES_FROSMOTH,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
...
static const struct TrainerMon sParty_Norman2[] = {
    ...
    .ability = ABILITY_SERENE_GRACE,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .moves = {MOVE_HYPER_DRILL, MOVE_DRILL_RUN, MOVE_DRAGON_RUSH, MOVE_COIL},
    },
    {
    .lvl = 63,
    .species = SPECIES_SNORLAX,
...
static const struct TrainerMon sParty_Norman3[] = {
    ...
    .ability = ABILITY_THICK_FAT,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .moves = {MOVE_FACADE, MOVE_KNOCK_OFF, MOVE_POWER_WHIP, MOVE_BELLY_DRUM},
    .heldItem = ITEM_SITRUS_BERRY,
    }
};
...
static const struct TrainerMon sParty_Jorge2[] = {
    {
    .lvl = 60,
    .species = SPECIES_TORKOAL,
    .ability = ABILITY_DROUGHT,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .moves = {MOVE_FLAMETHROWER, MOVE_SOLAR_BEAM, MOVE_BODY_PRESS, MOVE_IRON_DEFENSE},
    },
    {
    .lvl = 60,
    .species = SPECIES_HEATMOR,
    .ability = ABILITY_WHITE_SMOKE,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .moves = {MOVE_FIRE_LASH, MOVE_DRAIN_PUNCH, MOVE_THROAT_CHOP, MOVE_HONE_CLAWS},
    },
    {
    .lvl = 63,
    .species = SPECIES_ARCANINE,
    .ability = ABILITY_FLASH_FIRE,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .moves = {MOVE_FLARE_BLITZ, MOVE_PLAY_ROUGH, MOVE_CRUNCH, MOVE_PSYCHIC_FANGS},
    ...
    .ability = ABILITY_DROUGHT,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .moves = {MOVE_FLAMETHROWER, MOVE_ENERGY_BALL, MOVE_SHADOW_BALL, MOVE_NASTY_PLOT},
    ...
    .ability = ABILITY_ZEN_MODE,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .moves = {MOVE_FLAMETHROWER, MOVE_PSYCHIC, MOVE_SOLAR_BEAM, MOVE_SUBSTITUTE},
...
static const struct TrainerMon sParty_Jorge3[] = {
    {
    .lvl = 65,
    .species = SPECIES_BLAZIKEN,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
...
static const struct TrainerMon sParty_Jorge4[] = {
    {
    .lvl = 70,
    .species = SPECIES_BLAZIKEN,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
...
static const struct TrainerMon sParty_Jorge5[] = {
    {
    .lvl = 75,
    .species = SPECIES_BLAZIKEN,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
...
static const struct TrainerMon sParty_RafiAndKim2[] = {
    ...
    .ability = ABILITY_TECHNICIAN,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .moves = {MOVE_DRAIN_PUNCH, MOVE_BULLET_SEED, MOVE_MACH_PUNCH, MOVE_SWORDS_DANCE},
    },
    {
    .lvl = 63,
    .species = SPECIES_HAWLUCHA,
    .ability = ABILITY_LIMBER,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .moves = {MOVE_HIGH_JUMP_KICK, MOVE_ACROBATICS, MOVE_FLYING_PRESS, MOVE_SWORDS_DANCE},
    },
    {
    .lvl = 63,
    .species = SPECIES_PASSIMIAN,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .moves = {MOVE_DRAIN_PUNCH, MOVE_ACROBATICS, MOVE_KNOCK_OFF, MOVE_BULK_UP},
    },
    {
    .lvl = 65,
    .species = SPECIES_SIRFETCHD,
    ...
    .ability = ABILITY_GUTS,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .moves = {MOVE_DRAIN_PUNCH, MOVE_ROCK_SLIDE, MOVE_KNOCK_OFF, MOVE_BULK_UP},
    .heldItem = ITEM_FLAME_ORB,
    }
};
...
static const struct TrainerMon sParty_RafiAndKim3[] = {
    ...
    .species = SPECIES_BLAZIKEN,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .moves = {MOVE_DRAIN_PUNCH, MOVE_BLAZE_KICK, MOVE_ACROBATICS, MOVE_SWORDS_DANCE},
    },
    {
    .lvl = 65,
    .species = SPECIES_BRELOOM,
...
static const struct TrainerMon sParty_Eric2[] = {
    {
    .lvl = 60,
    .species = SPECIES_SEVIPER,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .moves = {MOVE_POISON_JAB, MOVE_CRUNCH, MOVE_PSYCHIC_FANGS, MOVE_COIL},
    },
    {
    .lvl = 60,
    .species = SPECIES_NIDOQUEEN,
    .ability = ABILITY_POISON_POINT,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .moves = {MOVE_POISON_JAB, MOVE_HIGH_HORSEPOWER, MOVE_CRUNCH, MOVE_TOXIC_SPIKES},
    },
    {
    .lvl = 63,
    .species = SPECIES_NIDOKING,
    .ability = ABILITY_POISON_POINT,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .moves = {MOVE_POISON_JAB, MOVE_HIGH_HORSEPOWER, MOVE_MEGAHORN, MOVE_TOXIC},
    ...
    .ability = ABILITY_LIQUID_OOZE,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .moves = {MOVE_SLUDGE_BOMB, MOVE_GIGA_DRAIN, MOVE_ICE_BEAM, MOVE_SHADOW_BALL},
...
static const struct TrainerMon sParty_Eric3[] = {
    {
    .lvl = 65,
    .species = SPECIES_SCOLIPEDE,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .moves = {MOVE_POISON_JAB, MOVE_MEGAHORN, MOVE_TOXIC, MOVE_VENOM_DRENCH},
    },
    {
    .lvl = 65,
    .species = SPECIES_SEVIPER,
...
static const struct TrainerMon sParty_Eric4[] = {
    {
    .lvl = 70,
    .species = SPECIES_SCOLIPEDE,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
...
static const struct TrainerMon sParty_Eric5[] = {
    {
    .lvl = 75,
    .species = SPECIES_SCOLIPEDE,
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
...
static const struct TrainerMon sParty_Jake[] = {
    ...
    .lvl = 19,
    .species = SPECIES_KADABRA,
    .moves = {MOVE_SHOCK_WAVE, MOVE_PSYBEAM, MOVE_REFLECT, MOVE_KINESIS}
    }
};

static const struct TrainerMon sParty_Kylie[] = {
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 32,
    .species = SPECIES_NINETALES,
