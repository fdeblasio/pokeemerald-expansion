...
{
    [MAPSEC_LITTLEROOT_TOWN] = {MAP_GROUP_AND_NUM(MAP_LITTLEROOT_TOWN), HEAL_LOCATION_LITTLEROOT_TOWN_BRENDANS_HOUSE_2F},
    [MAPSEC_OLDALE_TOWN] = {MAP_GROUP_AND_NUM(MAP_OLDALE_TOWN), HEAL_LOCATION_OLDALE_TOWN},
    [MAPSEC_DEWFORD_TOWN] = {MAP_GROUP_AND_NUM(MAP_DEWFORD_TOWN), HEAL_LOCATION_DEWFORD_TOWN},
    [MAPSEC_LAVARIDGE_TOWN] = {MAP_GROUP_AND_NUM(MAP_LAVARIDGE_TOWN), HEAL_LOCATION_LAVARIDGE_TOWN},
    [MAPSEC_FALLARBOR_TOWN] = {MAP_GROUP_AND_NUM(MAP_FALLARBOR_TOWN), HEAL_LOCATION_FALLARBOR_TOWN},
    [MAPSEC_VERDANTURF_TOWN] = {MAP_GROUP_AND_NUM(MAP_VERDANTURF_TOWN), HEAL_LOCATION_VERDANTURF_TOWN},
    [MAPSEC_PACIFIDLOG_TOWN] = {MAP_GROUP_AND_NUM(MAP_PACIFIDLOG_TOWN), HEAL_LOCATION_PACIFIDLOG_TOWN},
    [MAPSEC_PETALBURG_CITY] = {MAP_GROUP_AND_NUM(MAP_PETALBURG_CITY), HEAL_LOCATION_PETALBURG_CITY},
    [MAPSEC_SLATEPORT_CITY] = {MAP_GROUP_AND_NUM(MAP_SLATEPORT_CITY), HEAL_LOCATION_SLATEPORT_CITY},
    [MAPSEC_MAUVILLE_CITY] = {MAP_GROUP_AND_NUM(MAP_MAUVILLE_CITY), HEAL_LOCATION_MAUVILLE_CITY},
    [MAPSEC_RUSTBORO_CITY] = {MAP_GROUP_AND_NUM(MAP_RUSTBORO_CITY), HEAL_LOCATION_RUSTBORO_CITY},
    [MAPSEC_FORTREE_CITY] = {MAP_GROUP_AND_NUM(MAP_FORTREE_CITY), HEAL_LOCATION_FORTREE_CITY},
    [MAPSEC_LILYCOVE_CITY] = {MAP_GROUP_AND_NUM(MAP_LILYCOVE_CITY), HEAL_LOCATION_LILYCOVE_CITY},
    [MAPSEC_MOSSDEEP_CITY] = {MAP_GROUP_AND_NUM(MAP_MOSSDEEP_CITY), HEAL_LOCATION_MOSSDEEP_CITY},
    [MAPSEC_SOOTOPOLIS_CITY] = {MAP_GROUP_AND_NUM(MAP_SOOTOPOLIS_CITY), HEAL_LOCATION_SOOTOPOLIS_CITY},
    [MAPSEC_EVER_GRANDE_CITY] = {MAP_GROUP_AND_NUM(MAP_EVER_GRANDE_CITY), HEAL_LOCATION_EVER_GRANDE_CITY},
    [MAPSEC_ROUTE_101] = {MAP_GROUP_AND_NUM(MAP_ROUTE101), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_102] = {MAP_GROUP_AND_NUM(MAP_ROUTE102), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_103] = {MAP_GROUP_AND_NUM(MAP_ROUTE103), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_104] = {MAP_GROUP_AND_NUM(MAP_ROUTE104), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_104_NORTH] = {MAP_GROUP_AND_NUM(MAP_ROUTE104_NORTH), HEAL_LOCATION_ROUTE_104},
    [MAPSEC_ROUTE_105] = {MAP_GROUP_AND_NUM(MAP_ROUTE105), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_106] = {MAP_GROUP_AND_NUM(MAP_ROUTE106), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_107] = {MAP_GROUP_AND_NUM(MAP_ROUTE107), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_108] = {MAP_GROUP_AND_NUM(MAP_ROUTE108), HEAL_LOCATION_ROUTE_108},
    [MAPSEC_ROUTE_109] = {MAP_GROUP_AND_NUM(MAP_ROUTE109), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_110] = {MAP_GROUP_AND_NUM(MAP_ROUTE110), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_111] = {MAP_GROUP_AND_NUM(MAP_ROUTE111), HEAL_LOCATION_ROUTE_111},
    [MAPSEC_ROUTE_112] = {MAP_GROUP_AND_NUM(MAP_ROUTE112), HEAL_LOCATION_ROUTE_112},
    [MAPSEC_ROUTE_113] = {MAP_GROUP_AND_NUM(MAP_ROUTE113), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_114] = {MAP_GROUP_AND_NUM(MAP_ROUTE114), HEAL_LOCATION_ROUTE_114},
    [MAPSEC_ROUTE_115] = {MAP_GROUP_AND_NUM(MAP_ROUTE115), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_116] = {MAP_GROUP_AND_NUM(MAP_ROUTE116), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_117] = {MAP_GROUP_AND_NUM(MAP_ROUTE117), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_118] = {MAP_GROUP_AND_NUM(MAP_ROUTE118), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_119] = {MAP_GROUP_AND_NUM(MAP_ROUTE119), HEAL_LOCATION_ROUTE_119},
    [MAPSEC_ROUTE_120] = {MAP_GROUP_AND_NUM(MAP_ROUTE120), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_121] = {MAP_GROUP_AND_NUM(MAP_ROUTE121), HEAL_LOCATION_ROUTE_121},
    [MAPSEC_ROUTE_122] = {MAP_GROUP_AND_NUM(MAP_ROUTE122), HEAL_LOCATION_ROUTE_122},
    [MAPSEC_ROUTE_123] = {MAP_GROUP_AND_NUM(MAP_ROUTE123), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_124] = {MAP_GROUP_AND_NUM(MAP_ROUTE124), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_125] = {MAP_GROUP_AND_NUM(MAP_ROUTE125), HEAL_LOCATION_ROUTE_125},
    [MAPSEC_ROUTE_126] = {MAP_GROUP_AND_NUM(MAP_ROUTE126), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_127] = {MAP_GROUP_AND_NUM(MAP_ROUTE127), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_128] = {MAP_GROUP_AND_NUM(MAP_ROUTE128), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_129] = {MAP_GROUP_AND_NUM(MAP_ROUTE129), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_130] = {MAP_GROUP_AND_NUM(MAP_ROUTE130), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_131] = {MAP_GROUP_AND_NUM(MAP_ROUTE131), HEAL_LOCATION_ROUTE_131},
    [MAPSEC_ROUTE_132] = {MAP_GROUP_AND_NUM(MAP_ROUTE132), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_133] = {MAP_GROUP_AND_NUM(MAP_ROUTE133), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_134] = {MAP_GROUP_AND_NUM(MAP_ROUTE134), HEAL_LOCATION_NONE},
    [MAPSEC_PALLET_TOWN] = {MAP_GROUP_AND_NUM(MAP_PALLET_TOWN), HEAL_LOCATION_PALLET_TOWN},
    [MAPSEC_VIRIDIAN_CITY] = {MAP_GROUP_AND_NUM(MAP_VIRIDIAN_CITY), HEAL_LOCATION_VIRIDIAN_CITY},
    [MAPSEC_PEWTER_CITY] = {MAP_GROUP_AND_NUM(MAP_PEWTER_CITY), HEAL_LOCATION_PEWTER_CITY},
    [MAPSEC_CERULEAN_CITY] = {MAP_GROUP_AND_NUM(MAP_CERULEAN_CITY), HEAL_LOCATION_CERULEAN_CITY},
    [MAPSEC_LAVENDER_TOWN] = {MAP_GROUP_AND_NUM(MAP_LAVENDER_TOWN), HEAL_LOCATION_LAVENDER_TOWN},
    [MAPSEC_VERMILION_CITY] = {MAP_GROUP_AND_NUM(MAP_VERMILION_CITY), HEAL_LOCATION_VERMILION_CITY},
    [MAPSEC_CELADON_CITY] = {MAP_GROUP_AND_NUM(MAP_CELADON_CITY), HEAL_LOCATION_CELADON_CITY},
    [MAPSEC_FUCHSIA_CITY] = {MAP_GROUP_AND_NUM(MAP_FUCHSIA_CITY), HEAL_LOCATION_FUCHSIA_CITY},
    [MAPSEC_CINNABAR_ISLAND] = {MAP_GROUP_AND_NUM(MAP_CINNABAR_ISLAND), HEAL_LOCATION_CINNABAR_ISLAND},
    [MAPSEC_INDIGO_PLATEAU] = {MAP_GROUP_AND_NUM(MAP_INDIGO_PLATEAU_EXTERIOR), HEAL_LOCATION_INDIGO_PLATEAU},
    [MAPSEC_SAFFRON_CITY] = {MAP_GROUP_AND_NUM(MAP_SAFFRON_CITY), HEAL_LOCATION_SAFFRON_CITY},
    [MAPSEC_ROUTE_4_POKECENTER] = {MAP_GROUP_AND_NUM(MAP_ROUTE4), HEAL_LOCATION_ROUTE4},
    [MAPSEC_ROUTE_10_POKECENTER] = {MAP_GROUP_AND_NUM(MAP_ROUTE10), HEAL_LOCATION_ROUTE10},
    [MAPSEC_ROUTE_1] = {MAP_GROUP_AND_NUM(MAP_ROUTE1), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_2] = {MAP_GROUP_AND_NUM(MAP_ROUTE2), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_3] = {MAP_GROUP_AND_NUM(MAP_ROUTE3), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_4] = {MAP_GROUP_AND_NUM(MAP_ROUTE4), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_5] = {MAP_GROUP_AND_NUM(MAP_ROUTE5), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_6] = {MAP_GROUP_AND_NUM(MAP_ROUTE6), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_7] = {MAP_GROUP_AND_NUM(MAP_ROUTE7), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_8] = {MAP_GROUP_AND_NUM(MAP_ROUTE8), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_9] = {MAP_GROUP_AND_NUM(MAP_ROUTE9), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_10] = {MAP_GROUP_AND_NUM(MAP_ROUTE10), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_11] = {MAP_GROUP_AND_NUM(MAP_ROUTE11), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_12] = {MAP_GROUP_AND_NUM(MAP_ROUTE12), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_13] = {MAP_GROUP_AND_NUM(MAP_ROUTE13), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_14] = {MAP_GROUP_AND_NUM(MAP_ROUTE14), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_15] = {MAP_GROUP_AND_NUM(MAP_ROUTE15), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_16] = {MAP_GROUP_AND_NUM(MAP_ROUTE16), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_17] = {MAP_GROUP_AND_NUM(MAP_ROUTE17), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_18] = {MAP_GROUP_AND_NUM(MAP_ROUTE18), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_19] = {MAP_GROUP_AND_NUM(MAP_ROUTE19), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_20] = {MAP_GROUP_AND_NUM(MAP_ROUTE20), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_21] = {MAP_GROUP_AND_NUM(MAP_ROUTE21_NORTH), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_22] = {MAP_GROUP_AND_NUM(MAP_ROUTE22), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_23] = {MAP_GROUP_AND_NUM(MAP_ROUTE23), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_24] = {MAP_GROUP_AND_NUM(MAP_ROUTE24), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_25] = {MAP_GROUP_AND_NUM(MAP_ROUTE25), HEAL_LOCATION_NONE},
    [MAPSEC_VIRIDIAN_FOREST] = {MAP_GROUP_AND_NUM(MAP_PALLET_TOWN), HEAL_LOCATION_NONE},
    [MAPSEC_MT_MOON] = {MAP_GROUP_AND_NUM(MAP_PALLET_TOWN), HEAL_LOCATION_NONE},
    [MAPSEC_S_S_ANNE] = {MAP_GROUP_AND_NUM(MAP_PALLET_TOWN), HEAL_LOCATION_NONE},
    [MAPSEC_UNDERGROUND_PATH] = {MAP_GROUP_AND_NUM(MAP_PALLET_TOWN), HEAL_LOCATION_NONE},
    [MAPSEC_UNDERGROUND_PATH_2] = {MAP_GROUP_AND_NUM(MAP_PALLET_TOWN), HEAL_LOCATION_NONE},
    [MAPSEC_DIGLETTS_CAVE] = {MAP_GROUP_AND_NUM(MAP_PALLET_TOWN), HEAL_LOCATION_NONE},
    [MAPSEC_KANTO_VICTORY_ROAD] = {MAP_GROUP_AND_NUM(MAP_PALLET_TOWN), HEAL_LOCATION_NONE},
    [MAPSEC_ROCKET_HIDEOUT] = {MAP_GROUP_AND_NUM(MAP_PALLET_TOWN), HEAL_LOCATION_NONE},
    [MAPSEC_SILPH_CO] = {MAP_GROUP_AND_NUM(MAP_PALLET_TOWN), HEAL_LOCATION_NONE},
    [MAPSEC_POKEMON_MANSION] = {MAP_GROUP_AND_NUM(MAP_PALLET_TOWN), HEAL_LOCATION_NONE},
    [MAPSEC_KANTO_SAFARI_ZONE] = {MAP_GROUP_AND_NUM(MAP_PALLET_TOWN), HEAL_LOCATION_NONE},
    [MAPSEC_POKEMON_LEAGUE] = {MAP_GROUP_AND_NUM(MAP_PALLET_TOWN), HEAL_LOCATION_NONE},
    [MAPSEC_ROCK_TUNNEL] = {MAP_GROUP_AND_NUM(MAP_PALLET_TOWN), HEAL_LOCATION_NONE},
    [MAPSEC_SEAFOAM_ISLANDS] = {MAP_GROUP_AND_NUM(MAP_PALLET_TOWN), HEAL_LOCATION_NONE},
    [MAPSEC_POKEMON_TOWER] = {MAP_GROUP_AND_NUM(MAP_PALLET_TOWN), HEAL_LOCATION_NONE},
    [MAPSEC_CERULEAN_CAVE] = {MAP_GROUP_AND_NUM(MAP_PALLET_TOWN), HEAL_LOCATION_NONE},
    [MAPSEC_POWER_PLANT] = {MAP_GROUP_AND_NUM(MAP_PALLET_TOWN), HEAL_LOCATION_NONE},
    [MAPSEC_ONE_ISLAND] = {MAP_GROUP_AND_NUM(MAP_ONE_ISLAND), HEAL_LOCATION_ONE_ISLAND},
    [MAPSEC_TWO_ISLAND] = {MAP_GROUP_AND_NUM(MAP_TWO_ISLAND), HEAL_LOCATION_TWO_ISLAND},
    [MAPSEC_THREE_ISLAND] = {MAP_GROUP_AND_NUM(MAP_THREE_ISLAND), HEAL_LOCATION_THREE_ISLAND},
    [MAPSEC_FOUR_ISLAND] = {MAP_GROUP_AND_NUM(MAP_FOUR_ISLAND), HEAL_LOCATION_FOUR_ISLAND},
    [MAPSEC_FIVE_ISLAND] = {MAP_GROUP_AND_NUM(MAP_FIVE_ISLAND), HEAL_LOCATION_FIVE_ISLAND},
    [MAPSEC_SEVEN_ISLAND] = {MAP_GROUP_AND_NUM(MAP_SEVEN_ISLAND), HEAL_LOCATION_SEVEN_ISLAND},
    [MAPSEC_SIX_ISLAND] = {MAP_GROUP_AND_NUM(MAP_SIX_ISLAND), HEAL_LOCATION_SIX_ISLAND},
    [MAPSEC_KINDLE_ROAD] = {MAP_GROUP_AND_NUM(MAP_ONE_ISLAND_KINDLE_ROAD), HEAL_LOCATION_NONE},
    [MAPSEC_TREASURE_BEACH] = {MAP_GROUP_AND_NUM(MAP_ONE_ISLAND_TREASURE_BEACH), HEAL_LOCATION_NONE},
    [MAPSEC_CAPE_BRINK] = {MAP_GROUP_AND_NUM(MAP_TWO_ISLAND_CAPE_BRINK), HEAL_LOCATION_NONE},
    [MAPSEC_BOND_BRIDGE] = {MAP_GROUP_AND_NUM(MAP_THREE_ISLAND_BOND_BRIDGE), HEAL_LOCATION_NONE},
    [MAPSEC_THREE_ISLE_PORT] = {MAP_GROUP_AND_NUM(MAP_THREE_ISLAND_PORT), HEAL_LOCATION_NONE},
    [MAPSEC_RESORT_GORGEOUS] = {MAP_GROUP_AND_NUM(MAP_FIVE_ISLAND_RESORT_GORGEOUS), HEAL_LOCATION_NONE},
    [MAPSEC_WATER_LABYRINTH] = {MAP_GROUP_AND_NUM(MAP_FIVE_ISLAND_WATER_LABYRINTH), HEAL_LOCATION_NONE},
    [MAPSEC_FIVE_ISLE_MEADOW] = {MAP_GROUP_AND_NUM(MAP_FIVE_ISLAND_MEADOW), HEAL_LOCATION_NONE},
    [MAPSEC_MEMORIAL_PILLAR] = {MAP_GROUP_AND_NUM(MAP_FIVE_ISLAND_MEMORIAL_PILLAR), HEAL_LOCATION_NONE},
    [MAPSEC_OUTCAST_ISLAND] = {MAP_GROUP_AND_NUM(MAP_SIX_ISLAND_OUTCAST_ISLAND), HEAL_LOCATION_NONE},
    [MAPSEC_GREEN_PATH] = {MAP_GROUP_AND_NUM(MAP_SIX_ISLAND_GREEN_PATH), HEAL_LOCATION_NONE},
    [MAPSEC_WATER_PATH] = {MAP_GROUP_AND_NUM(MAP_SIX_ISLAND_WATER_PATH), HEAL_LOCATION_NONE},
    [MAPSEC_RUIN_VALLEY] = {MAP_GROUP_AND_NUM(MAP_SIX_ISLAND_RUIN_VALLEY), HEAL_LOCATION_NONE},
    [MAPSEC_TRAINER_TOWER] = {MAP_GROUP_AND_NUM(MAP_SEVEN_ISLAND_TRAINER_TOWER), HEAL_LOCATION_NONE},
    [MAPSEC_CANYON_ENTRANCE] = {MAP_GROUP_AND_NUM(MAP_SEVEN_ISLAND_SEVAULT_CANYON_ENTRANCE), HEAL_LOCATION_NONE},
    [MAPSEC_SEVAULT_CANYON] = {MAP_GROUP_AND_NUM(MAP_SEVEN_ISLAND_SEVAULT_CANYON), HEAL_LOCATION_NONE},
    [MAPSEC_TANOBY_RUINS] = {MAP_GROUP_AND_NUM(MAP_SEVEN_ISLAND_TANOBY_RUINS), HEAL_LOCATION_NONE},
    [MAPSEC_SEVII_ISLE_22] = {MAP_GROUP_AND_NUM(MAP_PALLET_TOWN), HEAL_LOCATION_NONE},
    [MAPSEC_SEVII_ISLE_23] = {MAP_GROUP_AND_NUM(MAP_PALLET_TOWN), HEAL_LOCATION_NONE},
    [MAPSEC_SEVII_ISLE_24] = {MAP_GROUP_AND_NUM(MAP_PALLET_TOWN), HEAL_LOCATION_NONE},
    [MAPSEC_NAVEL_ROCK_FRLG] = {MAP_GROUP_AND_NUM(MAP_NAVEL_ROCK_EXTERIOR_FRLG), HEAL_LOCATION_NONE},
    [MAPSEC_MT_EMBER] = {MAP_GROUP_AND_NUM(MAP_PALLET_TOWN), HEAL_LOCATION_NONE},
    [MAPSEC_BERRY_FOREST] = {MAP_GROUP_AND_NUM(MAP_PALLET_TOWN), HEAL_LOCATION_NONE},
    [MAPSEC_ICEFALL_CAVE] = {MAP_GROUP_AND_NUM(MAP_PALLET_TOWN), HEAL_LOCATION_NONE},
    [MAPSEC_ROCKET_WAREHOUSE] = {MAP_GROUP_AND_NUM(MAP_PALLET_TOWN), HEAL_LOCATION_NONE},
    [MAPSEC_TRAINER_TOWER_2] = {MAP_GROUP_AND_NUM(MAP_PALLET_TOWN), HEAL_LOCATION_NONE},
    [MAPSEC_DOTTED_HOLE] = {MAP_GROUP_AND_NUM(MAP_PALLET_TOWN), HEAL_LOCATION_NONE},
    [MAPSEC_LOST_CAVE] = {MAP_GROUP_AND_NUM(MAP_PALLET_TOWN), HEAL_LOCATION_NONE},
    [MAPSEC_PATTERN_BUSH] = {MAP_GROUP_AND_NUM(MAP_PALLET_TOWN), HEAL_LOCATION_NONE},
    [MAPSEC_ALTERING_CAVE_FRLG] = {MAP_GROUP_AND_NUM(MAP_PALLET_TOWN), HEAL_LOCATION_NONE},
    [MAPSEC_TANOBY_CHAMBERS] = {MAP_GROUP_AND_NUM(MAP_PALLET_TOWN), HEAL_LOCATION_NONE},
    [MAPSEC_THREE_ISLE_PATH] = {MAP_GROUP_AND_NUM(MAP_PALLET_TOWN), HEAL_LOCATION_NONE},
    [MAPSEC_TANOBY_KEY] = {MAP_GROUP_AND_NUM(MAP_PALLET_TOWN), HEAL_LOCATION_NONE},
    [MAPSEC_BIRTH_ISLAND_FRLG] = {MAP_GROUP_AND_NUM(MAP_BIRTH_ISLAND_EXTERIOR_FRLG), HEAL_LOCATION_NONE},
    [MAPSEC_MONEAN_CHAMBER] = {MAP_GROUP_AND_NUM(MAP_PALLET_TOWN), HEAL_LOCATION_NONE},
    [MAPSEC_LIPTOO_CHAMBER] = {MAP_GROUP_AND_NUM(MAP_PALLET_TOWN), HEAL_LOCATION_NONE},
    [MAPSEC_WEEPTH_CHAMBER] = {MAP_GROUP_AND_NUM(MAP_PALLET_TOWN), HEAL_LOCATION_NONE},
    [MAPSEC_DILFORD_CHAMBER] = {MAP_GROUP_AND_NUM(MAP_PALLET_TOWN), HEAL_LOCATION_NONE},
    [MAPSEC_SCUFIB_CHAMBER] = {MAP_GROUP_AND_NUM(MAP_PALLET_TOWN), HEAL_LOCATION_NONE},
    [MAPSEC_RIXY_CHAMBER] = {MAP_GROUP_AND_NUM(MAP_PALLET_TOWN), HEAL_LOCATION_NONE},
    [MAPSEC_VIAPOIS_CHAMBER] = {MAP_GROUP_AND_NUM(MAP_PALLET_TOWN), HEAL_LOCATION_NONE},
    [MAPSEC_EMBER_SPA] = {MAP_GROUP_AND_NUM(MAP_PALLET_TOWN), HEAL_LOCATION_NONE},
};
...
<<<<<<< HEAD
    RED_OUTLINE(FLOWER_SHOP, ROUTE_104_NORTH),
=======
    RED_OUTLINE(FLOWER_SHOP, ROUTE_104),
>>>>>>> 9d54700586 (Added Fly to the flower shop)
    ...
    RED_OUTLINE(SHOAL_CAVE, ROUTE_125),
...
<<<<<<< HEAD
    case MAPSEC_ROUTE_104_NORTH:
=======
    case MAPSEC_ROUTE_104:
>>>>>>> 9d54700586 (Added Fly to the flower shop)
        return FlagGet(FLAG_LANDMARK_FLOWER_SHOP) ? MAPSECTYPE_BATTLE_FRONTIER : MAPSECTYPE_ROUTE;
    ...
    case MAPSEC_ROUTE_125:
        return FlagGet(FLAG_LANDMARK_SHOAL_CAVE) ? MAPSECTYPE_BATTLE_FRONTIER : MAPSECTYPE_ROUTE;
    case MAPSEC_ROUTE_131:
        return FlagGet(FLAG_LANDMARK_SKY_PILLAR) ? MAPSECTYPE_BATTLE_FRONTIER : MAPSECTYPE_ROUTE;
...
static void TryCreateRedOutlineFlyDestIcons(void)
{
    ...
    for (i = 0; sRedOutlineFlyDestinations[i][1] != MAPSEC_NONE; i++)
    {
        if (FlagGet(sRedOutlineFlyDestinations[i][0]))
        {
            ...
            if (mapSecId == MAPSEC_ROUTE_119 || mapSecId == MAPSEC_ROUTE_122 || mapSecId == MAPSEC_ROUTE_125)
                y++;
