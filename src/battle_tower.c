...
const u8 gTowerMaleFacilityClasses[30] =
{
    ...
    FACILITY_CLASS_SCHOOLKID_M,
    FACILITY_CLASS_POKE_FAN_M,
...
const u8 gTowerFemaleFacilityClasses[20] =
{
    ...
    FACILITY_CLASS_SCHOOLKID_F,
    FACILITY_CLASS_POKE_FAN_F,
...
const u16 gTowerMaleTrainerGfxIds[30] =
{
    ...
    OBJ_EVENT_GFX_SCHOOLKID_M,
    OBJ_EVENT_GFX_POKE_FAN_M,
...
static const u8 sRubyFacilityClassToEmerald[RS_FACILITY_CLASSES_COUNT - 2][2] =
{
    ...
    RS_TO_E_FACILITY_CLASS(DUNCAN),
    {RS_FACILITY_CLASS_KYLE_1, FACILITY_CLASS_KYLE},
    RS_TO_E_FACILITY_CLASS(KYLE_2),
    RS_TO_E_FACILITY_CLASS(KYLE_3),
    {RS_FACILITY_CLASS_KELLI_1, FACILITY_CLASS_KELLI},
    RS_TO_E_FACILITY_CLASS(KELLI_2),
    RS_TO_E_FACILITY_CLASS(KELLI_3),
