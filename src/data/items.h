...
#define STATUS_MEDICINE_INFO(Item)               \
    .price = (I_PRICE >= GEN_7) ? 200 : 250,     \
    .pocket = POCKET_MEDICINE,                   \
    .sortType = ITEM_TYPE_STATUS_RECOVERY,       \
    .type = ITEM_USE_PARTY_MENU,                 \
    .fieldUseFunc = ItemUseOutOfBattle_Medicine, \
    .battleUsage = EFFECT_ITEM_CURE_STATUS,      \
    .effect = gItemEffect_##Item,                \
    .flingPower = 30,                            \
    ...
    [ITEM_PARALYZE_HEAL] =
    {
        ...
        .description = COMPOUND_STRING(
            "Heals a paralyzed\n"
            "Pokémon."),
        STATUS_MEDICINE_INFO(ParalyzeHeal),
    },
    ...
    [ITEM_AWAKENING] =
    {
        ...
        .description = COMPOUND_STRING(
            "Awakens a sleeping\n"
            "Pokémon."),
        STATUS_MEDICINE_INFO(Awakening),
    },
...
#define APRICORN_INFO(Color)                      \
    .name = ITEM_NAME(#Color " Apricorn"),        \
    ...
    .iconPalette = gItemIconPalette_##Color##Apricorn
...
#define EXTRA_TM_INFO(Number, Move)           \
    ...
    EXTRA_TM_INFO(112, "Zing Zap"),
    EXTRA_TM_INFO(113, "Tailwind"),
    EXTRA_TM_INFO(114, "Sky Uppercut"),
    EXTRA_TM_INFO(115, "Struggle Bug"),
    EXTRA_TM_INFO(116, "Psybeam"),
    EXTRA_TM_INFO(117, "Hyper Voice"),
