...
#define SPECIES_POSTGAME_GRASS_STARTER  SPECIES_CHIKORITA
#define SPECIES_POSTGAME_FIRE_STARTER   SPECIES_CYNDAQUIL
#define SPECIES_POSTGAME_WATER_STARTER  SPECIES_TOTODILE
