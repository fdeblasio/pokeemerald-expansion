...
static const u8 sOpponentBerrySets[NUM_NPC_BERRIES * 2][3] =
{
    ...
    {ITEM_TO_BERRY(ITEM_TAMATO_BERRY) - 1, ITEM_TO_BERRY(ITEM_FIGY_BERRY) - 1,  ITEM_TO_BERRY(ITEM_ASPEAR_BERRY) - 1},   // player chose Cheri Berry
    {ITEM_TO_BERRY(ITEM_CORNN_BERRY) - 1,  ITEM_TO_BERRY(ITEM_WIKI_BERRY) - 1, ITEM_TO_BERRY(ITEM_CHERI_BERRY) - 1},   // player chose Chesto Berry
    {ITEM_TO_BERRY(ITEM_MAGOST_BERRY) - 1, ITEM_TO_BERRY(ITEM_MAGO_BERRY) - 1,  ITEM_TO_BERRY(ITEM_CHESTO_BERRY) - 1},  // player chose Pecha Berry
    {ITEM_TO_BERRY(ITEM_RABUTA_BERRY) - 1,  ITEM_TO_BERRY(ITEM_AGUAV_BERRY) - 1, ITEM_TO_BERRY(ITEM_PECHA_BERRY) - 1},   // player chose Rawst Berry
    {ITEM_TO_BERRY(ITEM_NOMEL_BERRY) - 1,  ITEM_TO_BERRY(ITEM_IAPAPA_BERRY) - 1,  ITEM_TO_BERRY(ITEM_RAWST_BERRY) - 1},  // player chose Aspear Berry

    // These sets are used if the player chose a different berry (set is selected by player's berry % 5)
    {ITEM_TO_BERRY(ITEM_CHERI_BERRY) - 1,  ITEM_TO_BERRY(ITEM_ASPEAR_BERRY) - 1,  ITEM_TO_BERRY(ITEM_RAWST_BERRY) - 1},   // player chose Leppa, Figy, Razz, Pomeg, Tamato, Spelon, ...
    {ITEM_TO_BERRY(ITEM_CHESTO_BERRY) - 1, ITEM_TO_BERRY(ITEM_CHERI_BERRY) - 1,  ITEM_TO_BERRY(ITEM_ASPEAR_BERRY) - 1},  // player chose Oran, Wiki, Bluk, Kelpsy, Cornn, Pamtre, ...
    {ITEM_TO_BERRY(ITEM_PECHA_BERRY) - 1,  ITEM_TO_BERRY(ITEM_CHESTO_BERRY) - 1, ITEM_TO_BERRY(ITEM_CHERI_BERRY) - 1},   // player chose Persim, Mago, Nanab, Qualot, Magost, Watmel, ...
    {ITEM_TO_BERRY(ITEM_RAWST_BERRY) - 1,  ITEM_TO_BERRY(ITEM_PECHA_BERRY) - 1,  ITEM_TO_BERRY(ITEM_CHESTO_BERRY) - 1},  // player chose Lum, Aguav, Wepear, Hondew, Rabuta, Durin, ...
    {ITEM_TO_BERRY(ITEM_ASPEAR_BERRY) - 1, ITEM_TO_BERRY(ITEM_RAWST_BERRY) - 1, ITEM_TO_BERRY(ITEM_PECHA_BERRY) - 1},   // player chose Sitrus, Iapapa, Pinap, Grepa, Nomel, Belue, ...
};
