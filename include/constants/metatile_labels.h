...
// gTileset_KylesMaysHouse
#define METATILE_KylesMaysHouse_BookOnTable       0x293
#define METATILE_KylesMaysHouse_KylePC_Off     0x25A
#define METATILE_KylesMaysHouse_KylePC_On      0x27F
#define METATILE_KylesMaysHouse_MayPC_Off         0x259
#define METATILE_KylesMaysHouse_MayPC_On          0x27E
#define METATILE_KylesMaysHouse_MovingBox_Closed  0x268
#define METATILE_KylesMaysHouse_MovingBox_Open    0x270
