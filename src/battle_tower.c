...
{
    {FACILITY_CLASS_RUIN_MANIAC, OBJ_EVENT_GFX_RUIN_MANIAC},
    {FACILITY_CLASS_TUBER_M, OBJ_EVENT_GFX_TUBER_M},
    {FACILITY_CLASS_ACE_TRAINER_M, OBJ_EVENT_GFX_ACE_TRAINER_M},
    {FACILITY_CLASS_RICH_BOY, OBJ_EVENT_GFX_RICH_BOY},
    {FACILITY_CLASS_POKEMANIAC, OBJ_EVENT_GFX_POKE_MANIAC},
    ...
    {FACILITY_CLASS_BUG_MANIAC, OBJ_EVENT_GFX_BUG_MANIAC},
    ...
    {FACILITY_CLASS_COLLECTOR, OBJ_EVENT_GFX_COLLECTOR},
...
{
    {FACILITY_CLASS_AROMA_LADY, OBJ_EVENT_GFX_AROMA_LADY},
    {FACILITY_CLASS_TUBER_F, OBJ_EVENT_GFX_TUBER_F},
    {FACILITY_CLASS_ACE_TRAINER_F, OBJ_EVENT_GFX_ACE_TRAINER_F},
    {FACILITY_CLASS_HEX_MANIAC, OBJ_EVENT_GFX_HEX_MANIAC},
    {FACILITY_CLASS_LADY, OBJ_EVENT_GFX_LADY},
    {FACILITY_CLASS_BEAUTY, OBJ_EVENT_GFX_BEAUTY},
    {FACILITY_CLASS_PSYCHIC_F, OBJ_EVENT_GFX_LASS},
    {FACILITY_CLASS_SCHOOLKID_F, OBJ_EVENT_GFX_PSYCHIC_F},
    {FACILITY_CLASS_POKE_FAN_F, OBJ_EVENT_GFX_SCHOOLKID_F},
...
{
    RS_TO_E_FACILITY_CLASS(AQUA_LEADER_ARCHIE),
    RS_TO_E_FACILITY_CLASS(AQUA_GRUNT_M),
    RS_TO_E_FACILITY_CLASS(AQUA_GRUNT_F),
    RS_TO_E_FACILITY_CLASS(AROMA_LADY),
    RS_TO_E_FACILITY_CLASS(RUIN_MANIAC),
    RS_TO_E_FACILITY_CLASS(INTERVIEWER),
    RS_TO_E_FACILITY_CLASS(TUBER_F),
    RS_TO_E_FACILITY_CLASS(TUBER_M),
    RS_TO_E_FACILITY_CLASS(ACE_TRAINER_M),
    RS_TO_E_FACILITY_CLASS(ACE_TRAINER_F),
    RS_TO_E_FACILITY_CLASS(HEX_MANIAC),
    RS_TO_E_FACILITY_CLASS(LADY),
    RS_TO_E_FACILITY_CLASS(BEAUTY),
    RS_TO_E_FACILITY_CLASS(RICH_BOY),
    RS_TO_E_FACILITY_CLASS(POKE_MANIAC),
    RS_TO_E_FACILITY_CLASS(SWIMMER_M),
    RS_TO_E_FACILITY_CLASS(BLACK_BELT),
    RS_TO_E_FACILITY_CLASS(GUITARIST),
    RS_TO_E_FACILITY_CLASS(KINDLER),
    RS_TO_E_FACILITY_CLASS(CAMPER),
    RS_TO_E_FACILITY_CLASS(BUG_MANIAC),
    RS_TO_E_FACILITY_CLASS(PSYCHIC_M),
    RS_TO_E_FACILITY_CLASS(PSYCHIC_F),
    RS_TO_E_FACILITY_CLASS(GENTLEMAN),
    ...
    RS_TO_E_FACILITY_CLASS(SCHOOLKID_M),
    RS_TO_E_FACILITY_CLASS(SCHOOLKID_F),
    RS_TO_E_FACILITY_CLASS(TEAMMATES),
    RS_TO_E_FACILITY_CLASS(POKE_FAN_M),
    RS_TO_E_FACILITY_CLASS(POKE_FAN_F),
    RS_TO_E_FACILITY_CLASS(EXPERT_M),
    RS_TO_E_FACILITY_CLASS(EXPERT_F),
    RS_TO_E_FACILITY_CLASS(YOUNGSTER),
    {RS_FACILITY_CLASS_CHAMPION, FACILITY_CLASS_CHAMPION_WALLACE},
    RS_TO_E_FACILITY_CLASS(FISHERMAN),
    RS_TO_E_FACILITY_CLASS(CYCLING_TRIATHLETE_M),
    RS_TO_E_FACILITY_CLASS(CYCLING_TRIATHLETE_F),
    RS_TO_E_FACILITY_CLASS(RUNNING_TRIATHLETE_M),
    RS_TO_E_FACILITY_CLASS(RUNNING_TRIATHLETE_F),
    RS_TO_E_FACILITY_CLASS(SWIMMING_TRIATHLETE_M),
    RS_TO_E_FACILITY_CLASS(SWIMMING_TRIATHLETE_F),
    RS_TO_E_FACILITY_CLASS(DRAGON_TAMER),
    RS_TO_E_FACILITY_CLASS(BIRD_KEEPER),
    RS_TO_E_FACILITY_CLASS(NINJA_BOY),
    RS_TO_E_FACILITY_CLASS(BATTLE_GIRL),
    RS_TO_E_FACILITY_CLASS(PARASOL_LADY),
    RS_TO_E_FACILITY_CLASS(SWIMMER_F),
    RS_TO_E_FACILITY_CLASS(PICNICKER),
    RS_TO_E_FACILITY_CLASS(TWINS),
    RS_TO_E_FACILITY_CLASS(SAILOR),
    RS_TO_E_FACILITY_CLASS(COLLECTOR),
    RS_TO_E_FACILITY_CLASS(WALLY),
    {RS_FACILITY_CLASS_BRENDAN_1, FACILITY_CLASS_BRENDAN},
    RS_TO_E_FACILITY_CLASS(BRENDAN_2),
    RS_TO_E_FACILITY_CLASS(BRENDAN_3),
    {RS_FACILITY_CLASS_MAY_1, FACILITY_CLASS_MAY},
    RS_TO_E_FACILITY_CLASS(MAY_2),
    RS_TO_E_FACILITY_CLASS(MAY_3),
    RS_TO_E_FACILITY_CLASS(PKMN_BREEDER_M),
    RS_TO_E_FACILITY_CLASS(PKMN_BREEDER_F),
    RS_TO_E_FACILITY_CLASS(PKMN_RANGER_M),
    RS_TO_E_FACILITY_CLASS(PKMN_RANGER_F),
    {RS_FACILITY_CLASS_MAGMA_LEADER, FACILITY_CLASS_MAGMA_LEADER_MAXIE},
    RS_TO_E_FACILITY_CLASS(MAGMA_GRUNT_M),
    RS_TO_E_FACILITY_CLASS(MAGMA_GRUNT_F),
    RS_TO_E_FACILITY_CLASS(LASS),
    RS_TO_E_FACILITY_CLASS(BUG_CATCHER),
    RS_TO_E_FACILITY_CLASS(HIKER),
    RS_TO_E_FACILITY_CLASS(YOUNG_COUPLE),
    RS_TO_E_FACILITY_CLASS(OLD_COUPLE),
...
} static const sPartnerTrainerTextTables[] =
{
    ...
    {FACILITY_CLASS_SCHOOLKID_M,           sPartnerTextsSchoolKidM},
    ...
    {FACILITY_CLASS_POKE_FAN_M,            sPartnerTextsPokefanM},
    ...
    {FACILITY_CLASS_POKE_MANIAC,           sPartnerTextsPokemaniac},
    ...
    {FACILITY_CLASS_SCHOOLKID_F,           sPartnerTextsSchoolKidF},
    {FACILITY_CLASS_PKMN_BREEDER_F,        sPartnerTextsPkmnBreederF},
    {FACILITY_CLASS_POKE_FAN_F,            sPartnerTextsPokefanF},
