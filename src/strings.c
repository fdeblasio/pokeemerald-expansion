...
const u8 gText_PokenavAndBag[] = _C("PokéNav and Bag");
...
const u8 gPCText_Pokecenter[] = _C("PokéCenter");
...
const u8 gText_PutAwayPokenav[] = _C("Put away the PokéNav.");
...
const u8 gText_ReturnToPokenavMenu[] = _C("Return to the PokéNav menu.");
...
const u8 gText_MoveOkBack[] = _C("{DPAD_NONE}Move  {A_BUTTON}OK  {B_BUTTON}Back");
