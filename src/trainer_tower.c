...
static const struct SinglesTrainerInfo sSingleBattleTrainerInfo[] = {
    ...
    {OBJ_EVENT_GFX_JUGGLER,          FACILITY_CLASS_GUITARIST,          MALE},
    {OBJ_EVENT_GFX_JUGGLER,          FACILITY_CLASS_KINDLER,            MALE},
    {OBJ_EVENT_GFX_POKE_MANIAC_FRLG, FACILITY_CLASS_BUG_MANIAC,         MALE},
    {OBJ_EVENT_GFX_BOY,              FACILITY_CLASS_SCHOOLKID_M,        MALE},
    {OBJ_EVENT_GFX_WOMAN_1_FRLG,     FACILITY_CLASS_SCHOOLKID_F,        FEMALE},
    {OBJ_EVENT_GFX_BALDING_MAN,      FACILITY_CLASS_POKE_FAN_M,         MALE},
    {OBJ_EVENT_GFX_WOMAN_3_FRLG,     FACILITY_CLASS_POKE_FAN_F,         FEMALE},
    ...
    {OBJ_EVENT_GFX_POKE_MANIAC_FRLG, FACILITY_CLASS_POKE_MANIAC,        MALE},
    ...
    {OBJ_EVENT_GFX_BURGLAR,          FACILITY_CLASS_BURGLAR_FRLG,       MALE},
    ...
    {OBJ_EVENT_GFX_PSYCHIC_M_FRLG,   FACILITY_CLASS_PSYCHIC_M_FRLG,     MALE},
    {OBJ_EVENT_GFX_ROCKER,           FACILITY_CLASS_ROCKER_FRLG,        MALE},
    {OBJ_EVENT_GFX_JUGGLER,          FACILITY_CLASS_JUGGLER_FRLG,       MALE},
    {OBJ_EVENT_GFX_JUGGLER,          FACILITY_CLASS_BIRD_KEEPER,        MALE},
...
static const struct DoublesTrainerInfo sDoubleBattleTrainerInfo[] = {
    {OBJ_EVENT_GFX_BEAUTY_FRLG,      OBJ_EVENT_GFX_WOMAN_1_FRLG,     FACILITY_CLASS_TEAMMATES,         FEMALE, FEMALE},
...
static const struct TrainerEncounterMusicPairs sTrainerEncounterMusicLUT[] = {
    ...
    {FACILITY_CLASS_POKE_FAN_F,             TRAINER_ENCOUNTER_MUSIC_INTENSE},
    {FACILITY_CLASS_PSYCHIC_M_FRLG,         TRAINER_ENCOUNTER_MUSIC_INTENSE},
    ...
    {FACILITY_CLASS_POKE_MANIAC,            TRAINER_ENCOUNTER_MUSIC_GIRL},
