...
static const struct {
    ...
    {MAP_BATTLE_SCENE_PHOEBE, BATTLE_ENVIRONMENT_TYPE_PSYCHIC},
    {MAP_BATTLE_SCENE_GLACIA, BATTLE_ENVIRONMENT_TYPE_FLYING},
    {MAP_BATTLE_SCENE_DRAKE,  BATTLE_ENVIRONMENT_TYPE_FIGHTING},
