...
#define SQUAWKABILLY_INFO                                \
    ...
    [SPECIES_TADBULB] =
    {
        ...
        .abilities = { ABILITY_OWN_TEMPO, ABILITY_STATIC, ABILITY_VOLT_ABSORB },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_BELLIBOLT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1),
        .abilities = { ABILITY_ELECTROMORPHOSIS, ABILITY_STATIC, ABILITY_VOLT_ABSORB },
        .bodyColor = BODY_COLOR_GREEN,
...
#define MEGA_TATSUGIRI_INFO                               \
    ...
    [SPECIES_SCREAM_TAIL] =
    {
        ...
        .catchRate = SPECIAL_CATCH_RATE(50),
        .expYield = 285,
        .evYield_HP = 3,
        .itemRare = ITEM_BOOSTER_ENERGY,
        .genderRatio = MON_GENDERLESS,
    ...
    [SPECIES_BAXCALIBUR] =
    {
        ...
        .baseSpDefense = 86,
        .types = MON_TYPES(TYPE_DRAGON, TYPE_ICE),
        .catchRate = DEFAULT_CATCH_RATE(10),
        .expYield = 300,
        .evYield_Attack = 3,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 40,
    ...
    [SPECIES_WO_CHIEN] =
    {
        ...
        .catchRate = SPECIAL_CATCH_RATE(6),
        .expYield = 285,
        .evYield_SpDefense = 3,
        .genderRatio = MON_GENDERLESS,
        .eggCycles = 50,
    ...
    [SPECIES_ROARING_MOON] =
    {
        ...
        .catchRate = SPECIAL_CATCH_RATE(10),
        .expYield = 295,
        .evYield_Attack = 3,
        .itemRare = ITEM_BOOSTER_ENERGY,
        .genderRatio = MON_GENDERLESS,
    ...
    [SPECIES_WALKING_WAKE] =
    {
        ...
        .catchRate = SPECIAL_CATCH_RATE(5),
        .expYield = 295,
        .evYield_SpAttack = 3,
        .itemRare = ITEM_BOOSTER_ENERGY,
        .genderRatio = MON_GENDERLESS,
...
#define OGERPON_SPECIES_INFO(Form1, Form2, type, ability, color, frontYOffset, iconpalette, isTeraform)    \
    ...
    [SPECIES_TERAPAGOS_NORMAL] =
    {
        ...
        .catchRate = SPECIAL_CATCH_RATE(255),
        .expYield = 90,
        .evYield_Defense = 1,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 5,
