...
const u32 gBattleTerrainPalette_StadiumSidney[] = INCBIN_U32("graphics/battle_terrain/stadium/dark.gbapal.lz");
const u32 gBattleTerrainPalette_StadiumPhoebe[] = INCBIN_U32("graphics/battle_terrain/stadium/palette4.gbapal.lz");
const u32 gBattleTerrainPalette_StadiumGlacia[] = INCBIN_U32("graphics/battle_terrain/stadium/grass.gbapal.lz");
...
const u32 gBattleTerrainPalette_StadiumDark[] = INCBIN_U32("graphics/battle_terrain/stadium/dark.gbapal.lz");
const u32 gBattleTerrainPalette_StadiumFlying[] = INCBIN_U32("graphics/battle_terrain/stadium/flying.gbapal.lz");
const u32 gBattleTerrainPalette_StadiumGrass[] = INCBIN_U32("graphics/battle_terrain/stadium/grass.gbapal.lz");
const u32 gBattleTerrainPalette_StadiumIce[] = INCBIN_U32("graphics/battle_terrain/stadium/ice.gbapal.lz");
const u32 gBattleTerrainPalette_StadiumRock[] = INCBIN_U32("graphics/battle_terrain/stadium/rock.gbapal.lz");
