...
#define LEFT_FOSSIL  ITEM_ROOT_FOSSIL
#define RIGHT_FOSSIL ITEM_CLAW_FOSSIL

#define SCANNER_REWARD_1 ITEM_DEEP_SEA_TOOTH
#define SCANNER_REWARD_2 ITEM_DEEP_SEA_SCALE

#if JUAN_POISON
#define TRENDY_TM ITEM_TM_WATER_PULSE
#define JUAN_TM   ITEM_TM_SLUDGE_BOMB
#else
#define TRENDY_TM ITEM_TM_SLUDGE_BOMB
#define JUAN_TM   ITEM_TM_WATER_PULSE
#endif
