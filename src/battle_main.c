...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    TRAINER_CLASS(SWIMMER_M, "Swimmer♂", 2, BALL_DIVE),
    ...
    TRAINER_CLASS(TUBER_F, "Tuber", 1, BALL_DIVE),
    TRAINER_CLASS(TUBER_M, "Tuber", 1, BALL_DIVE),
    ...
    TRAINER_CLASS(SWIMMER_F, "Swimmer♀", 2, BALL_DIVE),
