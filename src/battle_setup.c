...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    REMATCH(ROXANNE, MAP_RUSTBORO_CITY),
    REMATCH(BRAWLY, MAP_DEWFORD_TOWN),
    REMATCH(WATTSON, MAP_MAUVILLE_CITY),
    REMATCH(FLANNERY, MAP_LAVARIDGE_TOWN),
    REMATCH(NORMAN, MAP_PETALBURG_CITY),
    REMATCH(WINONA, MAP_FORTREE_CITY),
    REMATCH(TATE_AND_LIZA, MAP_MOSSDEEP_CITY),
    REMATCH(JUAN, MAP_SOOTOPOLIS_CITY),
