...
static const u16 sContestLadyMonGfxId[] =
{
    ...
    [CONTEST_CATEGORY_BEAUTY] = OBJ_EVENT_GFX_SPECIES(SKITTY),
    [CONTEST_CATEGORY_CUTE]   = OBJ_EVENT_GFX_POOCHYENA,
    [CONTEST_CATEGORY_SMART]  = OBJ_EVENT_GFX_SPECIES(KECLEON),
    [CONTEST_CATEGORY_TOUGH]  = OBJ_EVENT_GFX_SPECIES(PIKACHU)
};
