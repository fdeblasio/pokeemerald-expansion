...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    TRAINER_CLASS(SCIENTIST_FRLG, "Scientist", 12),
    ...
    TRAINER_CLASS(CHANNELER_FRLG, "Channeler", 8),
    ...
    TRAINER_CLASS(CRUSH_KIN_FRLG, "Crush Kin", 6),
