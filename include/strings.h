...
extern const u8 gText_DefaultNameFrank[];
extern const u8 gText_DefaultNameFelix[];
extern const u8 gText_DefaultNameJake[];
extern const u8 gText_DefaultNameJunya[];
extern const u8 gText_DefaultNameRafi[];
...
extern const u8 gText_DefaultNameEmily[];
extern const u8 gText_DefaultNameKim[];
...
extern const u8 gText_RisingVoltage1BP[];
extern const u8 gText_GrassyGlide1BP[];
extern const u8 gText_ExpandingForce1BP[];
extern const u8 gText_ZenHeadbutt1BP[];
extern const u8 gText_Scald1BP[];
extern const u8 gText_PsychoCut1BP[];
extern const u8 gText_Lunge1BP[];
extern const u8 gText_ThroatChop1BP[];
extern const u8 gText_SolarBlade1BP[];
extern const u8 gText_DualWingbeat1BP[];
extern const u8 gText_ScorchingSands1BP[];
extern const u8 gText_KnockOff1BP[];
extern const u8 gText_MegaPunch1BP[];
extern const u8 gText_MegaKick1BP[];
extern const u8 gText_ElectricTerrain1BP[];
extern const u8 gText_GrassyTerrain1BP[];
...
extern const u8 gText_IcyWind1BP[];
extern const u8 gText_Swift1BP[];
extern const u8 gText_SeismicToss1BP[];
extern const u8 gText_Counter1BP[];
extern const u8 gText_DreamEater1BP[];
...
extern const u8 gText_TMContainedVar1[];
...
extern const u8 gTrickHouse_Mechadoll_Hariyama[];
extern const u8 gTrickHouse_Mechadoll_Lotad[];
extern const u8 gTrickHouse_Mechadoll_Wingull[];
extern const u8 gTrickHouse_Mechadoll_Wurmple[];
