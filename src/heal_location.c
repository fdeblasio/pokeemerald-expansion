...
{
    if (IsLastHealLocation(HEAL_LOCATION_LITTLEROOT_TOWN_KELLIS_HOUSE)
        || IsLastHealLocation(HEAL_LOCATION_LITTLEROOT_TOWN_KELLIS_HOUSE_2F)
        || IsLastHealLocation(HEAL_LOCATION_LITTLEROOT_TOWN_KYLES_HOUSE)
        || IsLastHealLocation(HEAL_LOCATION_LITTLEROOT_TOWN_KYLES_HOUSE_2F))
        return TRUE;
