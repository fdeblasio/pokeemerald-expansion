...
{
    [HEAL_LOCATION_LITTLEROOT_TOWN_KYLES_HOUSE_2F - 1] =
    {
        .group = MAP_GROUP(LITTLEROOT_TOWN_KYLES_HOUSE_1F),
        .map = MAP_NUM(LITTLEROOT_TOWN_KYLES_HOUSE_1F),
        .x = 2,
        .y = 7,
    },
    [HEAL_LOCATION_LITTLEROOT_TOWN_KELLIS_HOUSE_2F - 1] =
    {
        .group = MAP_GROUP(LITTLEROOT_TOWN_KELLIS_HOUSE_1F),
        .map = MAP_NUM(LITTLEROOT_TOWN_KELLIS_HOUSE_1F),
        .x = 8,
        .y = 7,
    },
    ...
    [HEAL_LOCATION_LITTLEROOT_TOWN_KYLES_HOUSE - 1] =
    {
        .group = MAP_GROUP(LITTLEROOT_TOWN_KYLES_HOUSE_1F),
        .map = MAP_NUM(LITTLEROOT_TOWN_KYLES_HOUSE_1F),
        .x = 2,
    ...
    [HEAL_LOCATION_LITTLEROOT_TOWN_KELLIS_HOUSE - 1] =
    {
        .group = MAP_GROUP(LITTLEROOT_TOWN_KELLIS_HOUSE_1F),
        .map = MAP_NUM(LITTLEROOT_TOWN_KELLIS_HOUSE_1F),
        .x = 8,
...
{
    [HEAL_LOCATION_LITTLEROOT_TOWN_KYLES_HOUSE_2F - 1] = 1,
    [HEAL_LOCATION_LITTLEROOT_TOWN_KELLIS_HOUSE_2F - 1] = 1,
    ...
    [HEAL_LOCATION_LITTLEROOT_TOWN_KYLES_HOUSE - 1] = 1,
    [HEAL_LOCATION_LITTLEROOT_TOWN_KELLIS_HOUSE - 1] = 1,
