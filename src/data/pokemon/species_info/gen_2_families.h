...
#define TOGEPI_FAMILY_TYPE1 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_NORMAL)
    ...
    [SPECIES_TOGEPI] =
    {
        ...
        .abilities = { ABILITY_EARLY_BIRD, ABILITY_SERENE_GRACE, ABILITY_SUPER_LUCK },
    ...
    [SPECIES_AMPHAROS_MEGA] =
    {
        ...
        .baseDefense   = 105,
        .baseSpeed     = 65,
>>>>>>> f515eda5ee (Updated Seaking, Ampharos, Hisuian Growlithe, and Hisuian Zorua)
        .baseSpAttack  = 165,
        .baseSpDefense = 110,
    ...
    [SPECIES_MURKROW] =
    {
        ...
        .catchRate = BOOSTED_CATCH_RATE(30),
...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset)   \
    ...
    [SPECIES_WYNAUT] =
    {
        ...
        .baseSpDefense = 48,
        .types = MON_TYPES(TYPE_PSYCHIC),
        .catchRate = DEFAULT_CATCH_RATE(125),
    ...
    [SPECIES_GIRAFARIG] =
    {
        ...
        .catchRate = BOOSTED_CATCH_RATE(90),
    ...
    [SPECIES_GLIGAR] =
    {
        ...
        .catchRate = BOOSTED_CATCH_RATE(60),
    ...
    [SPECIES_SNEASLER] =
    {
        ...
        .baseSpDefense = 80,
        .types = MON_TYPES(TYPE_FIGHTING, TYPE_POISON),
        .catchRate = DEFAULT_CATCH_RATE(20),
        .expYield = 102,
        .evYield_Attack = 2,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 20,
    ...
    [SPECIES_MANTINE] =
    {
        .baseHP        = P_UPDATED_STATS >= GEN_7 ? 90 : 65,
        .baseAttack    = 40,
        .baseDefense   = 70,
        .baseSpeed     = 70,
        .baseSpAttack  = 90,
    ...
    [SPECIES_SMEARGLE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_TRACE, ABILITY_TECHNICIAN, ABILITY_MOODY },
    #else
