...
extern const struct CompressedSpriteSheet gSpriteSheet_IntroKyle[];
...
extern const struct CompressedSpriteSheet gSpriteSheet_CreditsKyle[];
...
extern const struct CompressedSpriteSheet gSpriteSheet_CreditsRivalKyle[];
