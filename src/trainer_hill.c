...
} static const sTrainerClassesAndMusic[] =
{
    ...
    {TRAINER_CLASS_SWIMMER, TRAINER_ENCOUNTER_MUSIC_FEMALE},
    {TRAINER_CLASS_POKE_FAN, TRAINER_ENCOUNTER_MUSIC_TWINS},
    ...
    {TRAINER_CLASS_TEAMMATES, TRAINER_ENCOUNTER_MUSIC_TWINS},
    ...
    {TRAINER_CLASS_TUBER, TRAINER_ENCOUNTER_MUSIC_MALE},
    {TRAINER_CLASS_TUBER, TRAINER_ENCOUNTER_MUSIC_GIRL},
    ...
    {TRAINER_CLASS_SCHOOLKID, TRAINER_ENCOUNTER_MUSIC_MALE},
};
