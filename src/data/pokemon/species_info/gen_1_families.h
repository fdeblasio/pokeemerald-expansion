...
#define CAP_PIKACHU_INFO(Cap)                                             \
    ...
    .trainerScale = 256,                                                  \
    .trainerOffset = 0,                                                   \
    .frontPic = gMonFrontPic_Pikachu##Cap,                                \
    .frontPicSize = MON_COORDS_SIZE(48, 48),                              \
    .frontPicYOffset = 9,                                                 \
    .frontAnimFrames = sAnims_SingleFramePlaceHolder,                     \
    .frontAnimId = ANIM_FLASH_YELLOW,                                     \
    .backPic = gMonBackPic_Pikachu##Cap,                                  \
    .backPicSize = MON_COORDS_SIZE(64, 56),                               \
    .backPicYOffset = 4,                                                  \
    .backAnimId = BACK_ANIM_SHAKE_FLASH_YELLOW,                           \
    .palette = gMonPalette_Pikachu##Cap,                                  \
    .shinyPalette = gMonShinyPalette_Pikachu##Cap,                        \
    .iconSprite = gMonIcon_Pikachu##Cap,                                  \
    .iconPalIndex = 0,                                                    \
    .pokemonJumpType = PKMN_JUMP_TYPE_NORMAL,                             \
    SHADOW(-3, 5, SHADOW_SIZE_M)                                          \
    FOOTPRINT(Pikachu)                                                    \
    ...
    [SPECIES_CLEFFA] =
    {
        ...
        .catchRate = DEFAULT_CATCH_RATE(150),
    ...
    [SPECIES_IGGLYBUFF] =
    {
        ...
        .catchRate = DEFAULT_CATCH_RATE(170),
    ...
    [SPECIES_JIGGLYPUFF] =
    {
        ...
        .baseDefense   = 35,
        .baseSpeed     = 35,
        .baseSpAttack  = P_UPDATED_STATS >= GEN_2 ? 60 : 25,
        .baseSpDefense = 35,
        .types = JIGGLYPUFF_FAMILY_TYPES,
        .catchRate = DEFAULT_CATCH_RATE(170),
...
#define PARTNER_MACHOP_ABILITIES { ABILITY_PUMMEL, ABILITY_NO_GUARD, ABILITY_GUTS }
    ...
    [SPECIES_MACHOP_PARTNER] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_MachopPartner,
        .frontPicSize = MON_COORDS_SIZE(48, 48),
        .frontPicYOffset = 8,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 6),
        ...
        .frontAnimId = ANIM_V_STRETCH,
        .backPic = gMonBackPic_MachopPartner,
        .backPicSize = MON_COORDS_SIZE(48, 56),
        .backPicYOffset = 6,
        .backAnimId = BACK_ANIM_JOLT_RIGHT,
        .palette = gMonPalette_MachopPartner,
        .shinyPalette = gMonShinyPalette_MachopPartner,
        .iconSprite = gMonIcon_MachopPartner,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
        SHADOW(0, 3, SHADOW_SIZE_S)
        FOOTPRINT(Machop)
        ...
        .eggMoveLearnset = sMachopEggMoveLearnset,
        .formSpeciesIdTable = sMachopFormSpeciesIdTable,
        .evolutions = EVOLUTION({EVO_LEVEL, 16, SPECIES_MACHOKE_PARTNER}),
    },
    ...
    [SPECIES_MACHOKE_PARTNER] =
    {
        ...
        .trainerScale = 257,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_MachokePartner,
        .frontPicSize = MON_COORDS_SIZE(56, 56),
        .frontPicYOffset = 4,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 20),
        ...
        .frontAnimId = ANIM_V_SHAKE,
        .backPic = gMonBackPic_MachokePartner,
        .backPicSize = MON_COORDS_SIZE(64, 48),
        .backPicYOffset = 8,
        .backAnimId = BACK_ANIM_V_SHAKE,
        .palette = gMonPalette_MachokePartner,
        .shinyPalette = gMonShinyPalette_MachokePartner,
        .iconSprite = gMonIcon_MachokePartner,
        .iconPalIndex = 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
        SHADOW(-1, 9, SHADOW_SIZE_M)
        FOOTPRINT(Machoke)
...
#define MACHAMP_PARTNER_SPE 65
    ...
    [SPECIES_MACHAMP_PARTNER] =
    {
        ...
        .baseAttack    = MACHAMP_PARTNER_ATK,
        .baseDefense   = MACHAMP_PARTNER_DEF,
        .baseSpeed     = MACHAMP_PARTNER_SPE,
        .baseSpAttack  = MACHAMP_PARTNER_SPA,
        .baseSpDefense = MACHAMP_PARTNER_SPD,
        .types = MON_TYPES(TYPE_FIGHTING),
        .catchRate = DEFAULT_CATCH_RATE(45),
        .expYield = MACHAMP_EXP_YIELD,
        .evYield_Attack = 3,
        ...
        .trainerScale = 269,
        .trainerOffset = -1,
        .frontPic = gMonFrontPic_MachampPartner,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 0,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 11),
        ...
        .frontAnimId = ANIM_H_JUMPS,
        .backPic = gMonBackPic_MachampPartner,
        .backPicSize = MON_COORDS_SIZE(64, 56),
        .backPicYOffset = 7,
        .backAnimId = BACK_ANIM_V_SHAKE,
        .palette = gMonPalette_MachampPartner,
        .shinyPalette = gMonShinyPalette_MachampPartner,
        .iconSprite = gMonIcon_MachampPartner,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
        SHADOW(7, 13, SHADOW_SIZE_L)
        FOOTPRINT(Machamp)
...
#define MAGNEMITE_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_2 ? TYPE_STEEL : TYPE_ELECTRIC)
    ...
    [SPECIES_FARFETCHD] =
    {
        ...
        .baseSpeed     = 70,
        .baseSpAttack  = 60,
        .baseSpDefense = P_UPDATED_STATS >= GEN_2 ? 65 : 58,
        .types = MON_TYPES(TYPE_NORMAL, TYPE_FLYING),
...
#define GENGAR_SP_DEF (P_UPDATED_STATS >= GEN_2 ? 75 : 130)
    ...
    [SPECIES_DROWZEE] =
    {
        ...
        .baseDefense   = 45,
        .baseSpeed     = 45,
        .baseSpAttack  = P_UPDATED_STATS >= GEN_2 ? 70 : 90,
        .baseSpDefense = 90,
        .types = MON_TYPES(TYPE_PSYCHIC),
        .catchRate = DEFAULT_CATCH_RATE(190),
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_INSOMNIA, ABILITY_INNER_FOCUS, ABILITY_STAKEOUT },
    #else
    ...
    [SPECIES_HYPNO] =
    {
        ...
        .baseDefense   = 70,
        .baseSpeed     = 70,
        .baseSpAttack  = P_UPDATED_STATS >= GEN_2 ? 95 : 115,
        .baseSpDefense = 115,
        .types = MON_TYPES(TYPE_PSYCHIC),
        .catchRate = DEFAULT_CATCH_RATE(75),
    ...
    [SPECIES_TYROGUE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_GUTS, ABILITY_VITAL_SPIRIT, ABILITY_STEADFAST },
    #else
    ...
    [SPECIES_HAPPINY] =
    {
        ...
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 250 : 255,
        .evYield_HP = 1,
    ...
    [SPECIES_MIME_JR] =
    {
        ...
        .types = MON_TYPES(TYPE_PSYCHIC),
    #endif
        .catchRate = DEFAULT_CATCH_RATE(145),
    ...
    [SPECIES_MAGIKARP] =
    {
        ...
        .baseDefense   = 55,
        .baseSpeed     = 80,
        .baseSpAttack  = P_UPDATED_STATS >= GEN_2 ? 10 : 20,
        .baseSpDefense = 20,
        .types = MON_TYPES(TYPE_WATER),
        .catchRate = DEFAULT_CATCH_RATE(255),
    ...
    [SPECIES_DITTO] =
    {
        ...
        .baseSpDefense = 50,
        .types = MON_TYPES(TYPE_NORMAL),
        .catchRate = DEFAULT_CATCH_RATE(35),
...
#if P_FAMILY_EEVEE
#define EEVEE_SP_ATK (P_UPDATED_STATS >= GEN_2 ? 55 : 65)
