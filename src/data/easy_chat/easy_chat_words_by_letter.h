...
#define DOUBLE_SPECIES_HOENN_FIRST(Species) \
    DOUBLE_SPECIES_NAME                     \
    EC_POKEMON(Species),                    \
    EC_POKEMON_NATIONAL(Species)

#define DOUBLE_SPECIES_NATIONAL_FIRST(Species) \
    DOUBLE_SPECIES_NAME                        \
    EC_POKEMON_NATIONAL(Species),              \
    EC_POKEMON(Species)
...
const u16 gEasyChatWordsByLetter_A[] = {
    ...
    EC_WORD_ABOUT,
    EC_WORD_ABOVE,
    DOUBLE_SPECIES_HOENN_FIRST(ABRA),
    EC_WORD_ABSENT,
    EC_POKEMON(ABSOL),
    EC_WORD_ABSOLUTELY,
    EC_MOVE(ABSORB),
    ...
    EC_WORD_AIR_LOCK,
    EC_WORD_AIYEEH,
    DOUBLE_SPECIES_HOENN_FIRST(ALAKAZAM),
    EC_WORD_ALL,
    EC_WORD_ALL_RIGHT,
    EC_WORD_ALLOW,
    EC_WORD_ALLOWANCE,
    ...
    EC_WORD_AWFULLY,
    EC_WORD_AWW,
    DOUBLE_SPECIES_HOENN_FIRST(AZUMARILL),
    EC_POKEMON(AZURILL),
};
...
const u16 gEasyChatWordsByLetter_B[] = {
    ...
    EC_POKEMON(BELDUM),
    EC_WORD_BELIEVE,
    DOUBLE_SPECIES_HOENN_FIRST(BELLOSSOM),
...
const u16 gEasyChatWordsByLetter_C[] = {
    ...
    EC_WORD_CHILDREN,
    EC_POKEMON(CHIMECHO),
    DOUBLE_SPECIES_HOENN_FIRST(CHINCHOU),
    EC_WORD_CHLOROPHYLL,
    EC_WORD_CHOICE,
    EC_WORD_CHOOSE,
    EC_WORD_CHORES,
    ...
    EC_POKEMON(CORPHISH),
    EC_WORD_CORRECT,
    DOUBLE_SPECIES_HOENN_FIRST(CORSOLA),
    ...
    EC_WORD_CRIES,
    DOUBLE_SPECIES_HOENN_FIRST(CROBAT),
...
const u16 gEasyChatWordsByLetter_D[] = {
    ...
    EC_WORD_DO,
    EC_WORD_DOCILE,
    DOUBLE_SPECIES_HOENN_FIRST(DODRIO),
    DOUBLE_SPECIES_HOENN_FIRST(DODUO),
    EC_WORD_DOES,
    EC_WORD_DOESN_T,
    EC_WORD_DON_T,
    EC_WORD_DONE,
    DOUBLE_SPECIES_HOENN_FIRST(DONPHAN),
...
const u16 gEasyChatWordsByLetter_E[] = {
    ...
    DOUBLE_SPECIES_HOENN_FIRST(ELECTRODE),
...
const u16 gEasyChatWordsByLetter_G[] = {
    ...
    EC_WORD_GENIUS,
    DOUBLE_SPECIES_HOENN_FIRST(GEODUDE),
    EC_WORD_GET,
    EC_WORD_GETS,
    EC_WORD_GHOST,
    EC_WORD_GIDDY,
    ...
    EC_WORD_GIGGLE,
    EC_WORD_GIMME,
    DOUBLE_SPECIES_HOENN_FIRST(GIRAFARIG),
    EC_WORD_GIRL,
    EC_WORD_GIVE,
    EC_WORD_GIVE_ME,
    EC_WORD_GIVE_UP,
    ...
    DOUBLE_SPECIES_HOENN_FIRST(GLOOM),
    EC_WORD_GO,
    EC_WORD_GO_AHEAD,
    EC_WORD_GO_EASY,
    EC_WORD_GO_HOME,
    EC_WORD_GOES,
    EC_WORD_GOING,
    DOUBLE_SPECIES_HOENN_FIRST(GOLBAT),
    EC_WORD_GOLD,
    DOUBLE_SPECIES_HOENN_FIRST(GOLDEEN),
    DOUBLE_SPECIES_HOENN_FIRST(GOLDUCK),
    DOUBLE_SPECIES_HOENN_FIRST(GOLEM),
    EC_WORD_GOOD,
    EC_WORD_GOOD_BYE,
    EC_POKEMON(GOREBYSS),
    EC_WORD_GOT,
    ...
    DOUBLE_SPECIES_HOENN_FIRST(GRAVELER),
    EC_WORD_GREAT,
    EC_WORD_GREEN,
    DOUBLE_SPECIES_HOENN_FIRST(GRIMER),
    EC_POKEMON(GROUDON),
    EC_WORD_GROUND,
    EC_WORD_GROUP,
    EC_POKEMON(GROVYLE),
    ...
    EC_WORD_GWAH,
    EC_WORD_GWAHAHAHA,
    DOUBLE_SPECIES_HOENN_FIRST(GYARADOS),
};
...
const u16 gEasyChatWordsByLetter_H[] = {
    ...
    EC_WORD_HER,
    DOUBLE_SPECIES_HOENN_FIRST(HERACROSS),
    EC_WORD_HERE,
    EC_WORD_HERE_GOES,
    EC_WORD_HERE_I_COME,
    EC_WORD_HERE_IT_IS,
    ...
    EC_MOVE2(HORN_DRILL),
    DOUBLE_SPECIES_HOENN_FIRST(HORSEA),
    EC_WORD_HOT,
...
const u16 gEasyChatWordsByLetter_I[] = {
    ...
    EC_WORD_IF_I_LOSE,
    EC_WORD_IF_I_WIN,
    DOUBLE_SPECIES_HOENN_FIRST(IGGLYBUFF),
    EC_WORD_IGNORANT,
    EC_WORD_ILLUMINATE,
    EC_POKEMON(ILLUMISE),
    EC_WORD_IMMUNITY,
...
const u16 gEasyChatWordsByLetter_J[] = {
    DOUBLE_SPECIES_HOENN_FIRST(JIGGLYPUFF),
    EC_POKEMON(JIRACHI),
    EC_WORD_JOKING,
...
const u16 gEasyChatWordsByLetter_K[] = {
    ...
    DOUBLE_SPECIES_HOENN_FIRST(KADABRA),
    ...
    EC_MOVE(KINESIS),
    DOUBLE_SPECIES_HOENN_FIRST(KINGDRA),
    ...
    EC_WORD_KNOW,
    EC_WORD_KNOWS,
    DOUBLE_SPECIES_HOENN_FIRST(KOFFING),
...
const u16 gEasyChatWordsByLetter_L[] = {
    ...
    EC_POKEMON(LAIRON),
    EC_WORD_LALALA,
    DOUBLE_SPECIES_HOENN_FIRST(LANTURN),
...
const u16 gEasyChatWordsByLetter_M[] = {
    EC_MOVE2(MACH_PUNCH),
    DOUBLE_SPECIES_HOENN_FIRST(MACHAMP),
    EC_WORD_MACHINE,
    DOUBLE_SPECIES_HOENN_FIRST(MACHOKE),
    DOUBLE_SPECIES_HOENN_FIRST(MACHOP),
    EC_WORD_MAGAZINE,
    EC_POKEMON_NATIONAL(MAGBY),
    DOUBLE_SPECIES_HOENN_FIRST(MAGCARGO),
    EC_MOVE2(MAGIC_COAT),
    EC_MOVE2(MAGICAL_LEAF),
    DOUBLE_SPECIES_HOENN_FIRST(MAGIKARP),
    EC_WORD_MAGMA_ARMOR,
    EC_POKEMON_NATIONAL(MAGMAR),
    DOUBLE_SPECIES_HOENN_FIRST(MAGNEMITE),
    EC_WORD_MAGNET_PULL,
    DOUBLE_SPECIES_HOENN_FIRST(MAGNETON),
    EC_MOVE2(MAGNITUDE),
    EC_WORD_MAIL,
    EC_WORD_MAKE,
    EC_WORD_MAKING,
    ...
    DOUBLE_SPECIES_HOENN_FIRST(MARILL),
    ...
    EC_POKEMON(MUDKIP),
    EC_WORD_MUFUFU,
    DOUBLE_SPECIES_HOENN_FIRST(MUK),
...
const u16 gEasyChatWordsByLetter_N[] = {
    EC_WORD_NAME,
    EC_WORD_NAP,
    DOUBLE_SPECIES_HOENN_FIRST(NATU),
    EC_WORD_NATURAL,
    ...
    EC_WORD_NIGHTTIME,
    EC_POKEMON(NINCADA),
    DOUBLE_SPECIES_HOENN_FIRST(NINETALES),
    EC_POKEMON(NINJASK),
    EC_WORD_NITWIT,
    EC_WORD_NO,
    EC_WORD_NO_MATCH,
...
const u16 gEasyChatWordsByLetter_O[] = {
    ...
    DOUBLE_SPECIES_HOENN_FIRST(ODDISH),
    EC_MOVE(ODOR_SLEUTH),
    EC_WORD_OF,
    EC_WORD_OFF,
    EC_WORD_OFFENSIVE,
...
const u16 gEasyChatWordsByLetter_P[] = {
    ...
    DOUBLE_SPECIES_HOENN_FIRST(PSYDUCK),
    EC_MOVE(PSYWAVE),
...
const u16 gEasyChatWordsByLetter_R[] = {
    EC_WORD_RADIO,
    EC_MOVE(RAGE),
    DOUBLE_SPECIES_HOENN_FIRST(RAICHU),
    ...
    EC_MOVE2(REVENGE),
    EC_MOVE(REVERSAL),
    DOUBLE_SPECIES_HOENN_FIRST(RHYDON),
    DOUBLE_SPECIES_HOENN_FIRST(RHYHORN),
    EC_WORD_RIBBON,
    EC_WORD_RICKETY,
    EC_WORD_RIGHT,
    EC_WORD_RIPPED,
...
const u16 gEasyChatWordsByLetter_S[] = {
    ...
    EC_WORD_SAND_VEIL,
    EC_MOVE(SAND_ATTACK),
    DOUBLE_SPECIES_HOENN_FIRST(SANDSHREW),
    DOUBLE_SPECIES_HOENN_FIRST(SANDSLASH),
    EC_MOVE(SANDSTORM),
    EC_WORD_SAPPHIRE,
    EC_WORD_SATISFIED,
    EC_WORD_SATURDAY,
    ...
    DOUBLE_SPECIES_HOENN_FIRST(SEADRA),
    DOUBLE_SPECIES_HOENN_FIRST(SEAKING),
    EC_POKEMON(SEALEO),
    EC_WORD_SEARCH,
    EC_WORD_SECRET,
    EC_WORD_SECRET_BASE,
    ...
    EC_WORD_SINK,
    EC_WORD_SISTER,
    DOUBLE_SPECIES_HOENN_FIRST(SKARMORY),
    EC_MOVE(SKETCH),
    EC_WORD_SKILL,
    EC_MOVE(SKILL_SWAP),
    EC_WORD_SKILLED,
    ...
    DOUBLE_SPECIES_HOENN_FIRST(SLUGMA),
    EC_WORD_SMACK,
    EC_WORD_SMALL,
    EC_WORD_SMART,
    EC_WORD_SMARTNESS,
    ...
    DOUBLE_SPECIES_HOENN_FIRST(STARMIE),
    EC_WORD_START,
    DOUBLE_SPECIES_HOENN_FIRST(STARYU),
    EC_WORD_STATIC,
...
const u16 gEasyChatWordsByLetter_T[] = {
    ...
    EC_MOVE2(TELEPORT),
    EC_WORD_TELEVISION,
    DOUBLE_SPECIES_HOENN_FIRST(TENTACOOL),
    DOUBLE_SPECIES_HOENN_FIRST(TENTACRUEL),
    EC_WORD_TERRIBLE,
    EC_WORD_TEST,
    EC_WORD_THAN,
    EC_WORD_THANK_YOU,
...
const u16 gEasyChatWordsByLetter_V[] = {
    ...
    EC_WORD_VIEWING,
    EC_POKEMON(VIGOROTH),
    DOUBLE_SPECIES_HOENN_FIRST(VILEPLUME),
    EC_MOVE2(VINE_WHIP),
    ...
    DOUBLE_SPECIES_HOENN_FIRST(VOLTORB),
    EC_WORD_VORACIOUS,
    DOUBLE_SPECIES_HOENN_FIRST(VULPIX),
};
...
const u16 gEasyChatWordsByLetter_W[] = {
    ...
    DOUBLE_SPECIES_HOENN_FIRST(WEEZING),
    EC_WORD_WEIRD,
    EC_WORD_WELCOME,
    EC_WORD_WELL,
    EC_WORD_WELL_THEN,
    ...
    EC_WORD_WHOSE,
    EC_WORD_WHY,
    DOUBLE_SPECIES_HOENN_FIRST(WIGGLYTUFF),
    EC_WORD_WILD,
    EC_WORD_WILL,
    ...
    EC_WORD_WITHOUT,
    EC_WORD_WOBBLY,
    DOUBLE_SPECIES_HOENN_FIRST(WOBBUFFET),
    EC_WORD_WOMAN,
    EC_WORD_WON,
    EC_WORD_WON_T,
    EC_WORD_WONDER,
...
const u16 gEasyChatWordsByLetter_X[] = {
    DOUBLE_SPECIES_HOENN_FIRST(XATU),
};
...
const u16 gEasyChatWordsByLetter_Z[] = {
    ...
    DOUBLE_SPECIES_HOENN_FIRST(ZUBAT),
};
...
const u16 gEasyChatWordsByLetter_UnusedJapaneseHi[] = {
    ...
    EC_POKEMON_NATIONAL(WEEDLE),
    EC_WORD_HERO,
    DOUBLE_SPECIES_NATIONAL_FIRST(PIKACHU),
    EC_MOVE2(LIGHT_SCREEN),
    EC_WORD_SHINE,
    EC_WORD_LOW,
    EC_POKEMON_NATIONAL(CLEFABLE),
    ...
    EC_POKEMON_NATIONAL(PIDGEOTTO),
    EC_WORD_LEFT,
    DOUBLE_SPECIES_NATIONAL_FIRST(PICHU),
    EC_MOVE2(SCRATCH),
    EC_WORD_SURPRISE,
    EC_MOVE2(HYPER_FANG),
    EC_POKEMON_NATIONAL(CLEFAIRY),
    ...
    EC_WORD_AWFUL,
    EC_POKEMON_NATIONAL(CHARMANDER),
    DOUBLE_SPECIES_NATIONAL_FIRST(STARYU),
    EC_WORD_ALONE,
    EC_POKEMON_NATIONAL(CYNDAQUIL),
    EC_MOVE2(EMBER),
    EC_POKEMON(VIBRAVA),
    ...
    EC_MOVE2(DIZZY_PUNCH),
    EC_WORD_LIGHTNINGROD,
    DOUBLE_SPECIES_NATIONAL_FIRST(VOLTORB),
    EC_WORD_DAYTIME,
    EC_MOVE2(BULK_UP),
    EC_WORD_NAP,
    EC_WORD_HEROINE,
...
const u16 gEasyChatWordsByLetter_UnusedJapaneseFu[] = {
    ...
    EC_MOVE2(IMPRISON),
    EC_POKEMON_NATIONAL(FLAREON),
    DOUBLE_SPECIES_NATIONAL_FIRST(ALAKAZAM),
    EC_POKEMON_NATIONAL(MAGMAR),
    EC_POKEMON(GRUMPIG),
    EC_MOVE2(FEATHER_DANCE),
    EC_POKEMON_NATIONAL(FORRETRESS),
    EC_MOVE2(WHIRLWIND),
    EC_WORD_COMPOUNDEYES,
    DOUBLE_SPECIES_NATIONAL_FIRST(WIGGLYTUFF),
    EC_MOVE2(BEAT_UP),
    EC_WORD_MYSTERY,
    EC_POKEMON_NATIONAL(IVYSAUR),
    EC_POKEMON_NATIONAL(BULBASAUR),
    ...
    EC_WORD_LOL,
    EC_MOVE2(BLIZZARD),
    DOUBLE_SPECIES_NATIONAL_FIRST(IGGLYBUFF),
    EC_WORD_SNORT,
    EC_MOVE2(STOMP),
    EC_WORD_INSOMNIA,
    EC_WORD_WINTER,
    ...
    EC_POKEMON_NATIONAL(ARTICUNO),
    EC_WORD_WANNABE,
    DOUBLE_SPECIES_NATIONAL_FIRST(JIGGLYPUFF),
    EC_POKEMON_NATIONAL(SNUBBULL),
    EC_WORD_SHAKY,
    EC_MOVE2(CRUSH_CLAW),
    EC_MOVE2(BLAZE_KICK),
...
const u16 gEasyChatWordsByLetter_UnusedJapaneseHe[] = {
    ...
    EC_WORD_LOUSY,
    EC_WORD_HEHEHE,
    DOUBLE_SPECIES_NATIONAL_FIRST(GRIMER),
    DOUBLE_SPECIES_NATIONAL_FIRST(MUK),
    EC_WORD_LIQUID_OOZE,
    EC_MOVE2(SLUDGE),
    EC_MOVE2(SLUDGE_BOMB),
    EC_MOVE2(GLARE),
    EC_WORD_HEH,
    DOUBLE_SPECIES_NATIONAL_FIRST(HERACROSS),
    EC_POKEMON(PELIPPER),
    EC_POKEMON_NATIONAL(HOUNDOOM),
    EC_POKEMON_NATIONAL(PERSIAN),
    EC_WORD_RIPPED,
...
const u16 gEasyChatWordsByLetter_UnusedJapaneseMa[] = {
    ...
    EC_MOVE2(WRAP),
    EC_MOVE2(SPIKES),
    DOUBLE_SPECIES_NATIONAL_FIRST(MAGCARGO),
    EC_MOVE2(MAGNITUDE),
    EC_POKEMON(MAKUHITA),
    DOUBLE_SPECIES_NATIONAL_FIRST(SLUGMA),
    EC_WORD_MAGMA_ARMOR,
    EC_POKEMON_NATIONAL(QUILAVA),
    EC_WORD_OVERDO,
    EC_WORD_LOSS,
    ...
    EC_WORD_LIKE,
    EC_POKEMON_NATIONAL(BELLSPROUT),
    DOUBLE_SPECIES_NATIONAL_FIRST(WEEZING),
    EC_WORD_SMELL,
    EC_WORD_YET,
    EC_WORD_MISTAKE,
    EC_POKEMON(LINOONE),
    ...
    EC_MOVE2(PROTECT),
    EC_POKEMON(CASCOON),
    DOUBLE_SPECIES_NATIONAL_FIRST(MARILL),
    DOUBLE_SPECIES_NATIONAL_FIRST(AZUMARILL),
    EC_MOVE2(DEFENSE_CURL),
    EC_WORD_AS_IF,
    EC_POKEMON(SWALOT),
    DOUBLE_SPECIES_NATIONAL_FIRST(ELECTRODE),
    EC_MOVE2(ROLLING_KICK),
    EC_WORD_COMICS,
    EC_POKEMON_NATIONAL(MANKEY),
    EC_WORD_SATISFIED,
...
const u16 gEasyChatWordsByLetter_UnusedJapaneseMe[] = {
    ...
    EC_WORD_MESSAGE,
    EC_WORD_AWFULLY,
    DOUBLE_SPECIES_NATIONAL_FIRST(TENTACOOL),
    EC_WORD_FIERY,
    EC_POKEMON_NATIONAL(MAREEP),
    EC_MOVE2(ATTRACT),
    EC_WORD_CUTE_CHARM,
...
const u16 gEasyChatWordsByLetter_UnusedJapaneseYu[] = {
    ...
    EC_WORD_FORGET,
    EC_POKEMON(CRADILY),
    DOUBLE_SPECIES_NATIONAL_FIRST(KADABRA),
};
...
const u16 gEasyChatWordsByLetter_UnusedJapaneseRa[] = {
    EC_POKEMON_NATIONAL(RAIKOU),
    EC_WORD_WEEK,
    DOUBLE_SPECIES_NATIONAL_FIRST(RAICHU),
    EC_WORD_RIVAL,
    EC_WORD_LIFE,
    EC_POKEMON(MANECTRIC),
    EC_WORD_SIMPLE,
    ...
    EC_POKEMON_NATIONAL(LAPRAS),
    EC_WORD_LOVEY_DOVEY,
    DOUBLE_SPECIES_NATIONAL_FIRST(VILEPLUME),
    EC_WORD_LALALA,
    EC_POKEMON(RALTS),
    EC_WORD_FORGETS,
    EC_WORD_APPEARS,
    EC_WORD_RANK,
    DOUBLE_SPECIES_NATIONAL_FIRST(LANTURN),
};
...
const u16 gEasyChatWordsByLetter_UnusedJapaneseRe[] = {
    DOUBLE_SPECIES_NATIONAL_FIRST(MAGNETON),
    EC_MOVE2(ICE_PUNCH),
    EC_MOVE2(ICE_BEAM),
    EC_POKEMON(REGICE),
    EC_POKEMON(REGISTEEL),
...
const u16 gEasyChatWordsByLetter_UnusedJapaneseRo[] = {
    EC_MOVE2(SKULL_BASH),
    DOUBLE_SPECIES_NATIONAL_FIRST(VULPIX),
    EC_POKEMON(ROSELIA),
    EC_MOVE2(LOCK_ON),
    EC_MOVE2(ROCK_BLAST),
    EC_WORD_ROMANTIC,
...
const u16 gEasyChatWordsByLetter_UnusedJapaneseWa[] = {
    ...
    EC_MOVE2(STRUGGLE),
    EC_WORD_BADLY,
    DOUBLE_SPECIES_NATIONAL_FIRST(MACHOP),
};
