...
#define SPECIES_BIRTH_ISLAND      SPECIES_SOLGALEO
...
#define SPECIES_SLATEPORT_FAN_CLUB_3        SPECIES_MEOWTH_ALOLAN
...
#define SPECIES_BATTLE_FRONTIER_TRADE_GET   SPECIES_GROWLITHE_HISUIAN
