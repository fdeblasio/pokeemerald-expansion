...
[DIFFICULTY_NORMAL][TRAINER_WINONA_1] =
{
    ...
    .party = (const struct TrainerMon[]) {
        ...
        .ability = ABILITY_CHLOROPHYLL,
        IVS(25),
        .moves = {MOVE_SEED_BOMB, MOVE_AIR_SLASH, MOVE_SWEET_SCENT, MOVE_GROWTH},
        .gender = TRAINER_MON_MALE,
        },
        {
        .lvl = CAP_GYM_6 - 3,
        ...
        .ability = ABILITY_NATURAL_CURE,
        IVS(25),
        .moves = {MOVE_SEED_BOMB, MOVE_SLUDGE_BOMB, MOVE_WEATHER_BALL, MOVE_TOXIC_SPIKES},
        .gender = TRAINER_MON_FEMALE,
        },
        {
        .lvl = CAP_GYM_6 - 2,
        ...
        .ability = ABILITY_CHLOROPHYLL,
        IVS(25),
        .moves = {MOVE_SEED_BOMB, MOVE_SLUDGE_BOMB, MOVE_MOONBLAST, MOVE_GRASSY_TERRAIN},
        .gender = TRAINER_MON_MALE,
        },
        {
        .lvl = CAP_GYM_6 - 2,
        ...
        IVS(26),
        .moves = {MOVE_SEED_BOMB, MOVE_NIGHT_SLASH, MOVE_GRASS_WHISTLE, MOVE_FAKE_OUT},
        .gender = TRAINER_MON_MALE,
        },
        {
        .lvl = CAP_GYM_6,
        ...
        .ability = ABILITY_POISON_HEAL,
        IVS(30),
        .moves = {MOVE_SEED_BOMB, MOVE_DRAIN_PUNCH, MOVE_GROWTH, MOVE_SPORE},
        .gender = TRAINER_MON_MALE,
        .heldItem = ITEM_SITRUS_BERRY,
        .ball = ITEM_POKE_BALL,
        }
...
[DIFFICULTY_NORMAL][TRAINER_TATE_AND_LIZA_1] =
{
    ...
    .party = (const struct TrainerMon[]) {
        ...
        IVS(30),
        .moves = {MOVE_DRAGON_PULSE, MOVE_IRON_HEAD, MOVE_CRUNCH, MOVE_SCARY_FACE},
        .gender = TRAINER_MON_FEMALE,
        },
        {
        .lvl = CAP_GYM_7 - 3,
        ...
        .ability = ABILITY_STORM_DRAIN,
        IVS(30),
        .moves = {MOVE_DRAGON_PULSE, MOVE_MUDDY_WATER, MOVE_MIRROR_COAT, MOVE_NASTY_PLOT},
        .gender = TRAINER_MON_FEMALE,
        },
        {
        .lvl = CAP_GYM_7 - 2,
        ...
        IVS(30),
        .moves = {MOVE_DRAGON_PULSE, MOVE_CRUNCH, MOVE_FOCUS_ENERGY, MOVE_DRAGON_DANCE},
        .gender = TRAINER_MON_FEMALE,
        },
        {
        .lvl = CAP_GYM_7 - 2,
...
[DIFFICULTY_NORMAL][TRAINER_SIDNEY] =
{
    ...
    .partySize = 5,
    .party = (const struct TrainerMon[]) {
        SIDNEY_HONCHKROW(FALSE, E4_TIER3),
        SIDNEY_ABSOL(FALSE, E4_TIER3),
        SIDNEY_KINGAMBIT(FALSE, E4_TIER2),
        SIDNEY_MALAMAR(FALSE, E4_TIER2),
        SIDNEY_MANDIBUZZ(FALSE, E4_ACE),
    },
},
...
[DIFFICULTY_NORMAL][TRAINER_SIDNEY_REMATCH] =
{
    ...
    .party = (const struct TrainerMon[]) {
        ...
        SIDNEY_ABSOL(TRUE, E4_TIER3),
        SIDNEY_KINGAMBIT(TRUE, E4_TIER2),
        SIDNEY_MALAMAR(TRUE, E4_TIER2),
        SIDNEY_MANDIBUZZ(TRUE, E4_ACE),
    },
},
...
[DIFFICULTY_NORMAL][TRAINER_DRAKE] =
{
    ...
    .party = (const struct TrainerMon[]) {
        ...
        RAFAEL_SIRFETCHD(FALSE, E4_TIER2),
...
[DIFFICULTY_NORMAL][TRAINER_DRAKE_REMATCH] =
{
    ...
    .party = (const struct TrainerMon[]) {
        ...
        RAFAEL_SIRFETCHD(TRUE, E4_TIER2),
...
#define JERRY_PAWNIARD(Level) \
    .lvl = Level,             \
    .species = Level < 35 ? SPECIES_PAWNIARD : (Level < REMATCH_4_LEVEL_6 ? SPECIES_BISHARP : SPECIES_KINGAMBIT), \
    .ability = 1,             \
    .gender = TRAINER_MON_MALE
...
[DIFFICULTY_NORMAL][TRAINER_JERRY_2] =
{
    ...
    .party = (const struct TrainerMon[]) {
        ...
        {
        JERRY_PAWNIARD(REMATCH_2_LEVEL_2),
        IVS(2),
        }
    },
},
...
[DIFFICULTY_NORMAL][TRAINER_JERRY_3] =
{
    ...
    .party = (const struct TrainerMon[]) {
        ...
        {
        JERRY_PAWNIARD(REMATCH_3_LEVEL_3),
        IVS(3),
        }
    },
},
...
[DIFFICULTY_NORMAL][TRAINER_JERRY_4] =
{
    ...
    .party = (const struct TrainerMon[]) {
        ...
        {
        JERRY_PAWNIARD(REMATCH_4_LEVEL_3),
        IVS(4),
        }
    },
},
...
[DIFFICULTY_NORMAL][TRAINER_JERRY_5] =
{
    ...
    .party = (const struct TrainerMon[]) {
        ...
        {
        JERRY_PAWNIARD(REMATCH_5_LEVEL_3),
        IVS(6),
        }
    },
},
...
#define NOB_MANKEY(Level)            \
    {                                \
    .lvl = Level,                    \
    .species = Level < REMATCH_2_LEVEL_6 ? SPECIES_MANKEY : (Level < REMATCH_3_LEVEL_6 ? SPECIES_PRIMEAPE : SPECIES_ANNIHILAPE), \
    .nature = NATURE_ADAMANT,        \
...
[DIFFICULTY_NORMAL][TRAINER_NOB_5] =
{
    ...
    .party = (const struct TrainerMon[]) {
        ...
        NOB_MANKEY(REMATCH_5_MINI_BOSS),
    },
},
...
PETALBURG_GYM_TRAINER(RANDALL, "Kenny",    M, X_SPEED,      SWELLOW,    SALAC_BERRY,  QUICK_ATTACK, AGILITY,     WING_ATTACK,  NONE),
PETALBURG_GYM_TRAINER(MARY,    "Kylie",    F, X_ACCURACY,   DELCATTY,   MICLE_BERRY,  SWIFT,        SHOCK_WAVE,  FEINT_ATTACK, DISARMING_VOICE),
PETALBURG_GYM_TRAINER(PARKER,  "Junya",    M, HYPER_POTION, SPINDA,     PERSIM_BERRY, TEETER_DANCE, DIZZY_PUNCH, PSYBEAM,      NONE),
PETALBURG_GYM_TRAINER(ALEXIA,  "Bessie",   F, X_DEFENSE,    WIGGLYTUFF, GANLON_BERRY, DEFENSE_CURL, FACADE,      BODY_PRESS,   NONE),
PETALBURG_GYM_TRAINER(GEORGE,  "Jorge",    M, HYPER_POTION, VIGOROTH,   SITRUS_BERRY, SLACK_OFF,    DRAIN_PUNCH, ENDURE,       NONE),
PETALBURG_GYM_TRAINER(JODY,    "Cassidy",  F, X_ATTACK,     RUFFLET,    LIECHI_BERRY, SWORDS_DANCE, CRUSH_CLAW,  NONE,         NONE),
PETALBURG_GYM_TRAINER(BERKE,   "Arsanuos", M, DIRE_HIT,     FARFETCHD,  LEEK,         SLASH,        NONE,        NONE,         NONE),
...
[DIFFICULTY_NORMAL][TRAINER_JACKSON_2] =
{
    ...
    .party = (const struct TrainerMon[]) {
        {
        JACKSON_TROPIUS(REMATCH_2_LEVEL_1),
        },
        {
...
[DIFFICULTY_NORMAL][TRAINER_JACKSON_3] =
{
    ...
    .party = (const struct TrainerMon[]) {
        ...
        {
        JACKSON_TROPIUS(REMATCH_3_LEVEL_1),
        },
        {
...
[DIFFICULTY_NORMAL][TRAINER_JACKSON_4] =
{
    ...
    .party = (const struct TrainerMon[]) {
        ...
        {
        JACKSON_TROPIUS(REMATCH_4_LEVEL_1),
        },
        {
...
[DIFFICULTY_NORMAL][TRAINER_JACKSON_5] =
{
    ...
    .party = (const struct TrainerMon[]) {
        ...
        {
        JACKSON_TROPIUS(REMATCH_5_MINI_BOSS),
        },
        {
...
[DIFFICULTY_NORMAL][TRAINER_ROBERT_3] =
{
    ...
    .party = (const struct TrainerMon[]) {
        ...
        {
        ROBERT_SPEAROW(REMATCH_3_LEVEL_2),
        IVS(3),
        }
    },
},
...
[DIFFICULTY_NORMAL][TRAINER_ROBERT_4] =
{
    ...
    .party = (const struct TrainerMon[]) {
        ...
        {
        ROBERT_SPEAROW(REMATCH_4_LEVEL_2),
        IVS(4),
        }
    },
},
...
[DIFFICULTY_NORMAL][TRAINER_ROBERT_5] =
{
    ...
    .party = (const struct TrainerMon[]) {
        ...
        {
        ROBERT_SPEAROW(REMATCH_5_MINI_BOSS),
        IVS(5),
        }
    },
},
...
MOSSDEEP_GYM_TRAINER(PRESTON,  "Preston",  DRAGON_TAMER,  DRUDDIGON),
MOSSDEEP_GYM_TRAINER(MAURA,    "Maura",    ACE_TRAINER_F, NOIVERN),
MOSSDEEP_GYM_TRAINER(SAMANTHA, "Samantha", ACE_TRAINER_F, VIBRAVA),
MOSSDEEP_GYM_TRAINER(BLAKE,    "Blake",    DRAGON_TAMER,  FRAXURE),
MOSSDEEP_GYM_TRAINER(MACEY,    "Macey",    ACE_TRAINER_F, CYCLIZAR),
MOSSDEEP_GYM_TRAINER(CLIFFORD, "Clifford", GENTLEMAN,     KINGDRA),
MOSSDEEP_GYM_TRAINER(KATHLEEN, "Kathleen", ACE_TRAINER_F, BAGON),
MOSSDEEP_GYM_TRAINER(NICHOLAS, "Nicholas", DRAGON_TAMER,  SHELGON),
MOSSDEEP_GYM_TRAINER(NATE,     "Nate",     DRAGON_TAMER,  AXEW),
MOSSDEEP_GYM_TRAINER(VIRGIL,   "Virgil",   DRAGON_TAMER,  DRAMPA),
MOSSDEEP_GYM_TRAINER(SYLVIA,   "Hong",     ACE_TRAINER_F, TATSUGIRI_CURLY),
MOSSDEEP_GYM_TRAINER(HANNAH,   "Serena",   ACE_TRAINER_F, TATSUGIRI_STRETCHY),
