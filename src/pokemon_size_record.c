...
void GetSeedotSizeRecordInfo(void)
{
    ...
    GetMonSizeRecordInfo(SPECIES_VOLTORB, sizeRecord);
}
...
void CompareSeedotSize(void)
{
    ...
    gSpecialVar_Result = CompareMonSize(SPECIES_VOLTORB, sizeRecord);
}
...
void GetLotadSizeRecordInfo(void)
{
    ...
    GetMonSizeRecordInfo(SPECIES_CUBCHOO, sizeRecord);
}
...
void CompareLotadSize(void)
{
    ...
    gSpecialVar_Result = CompareMonSize(SPECIES_CUBCHOO, sizeRecord);
}
