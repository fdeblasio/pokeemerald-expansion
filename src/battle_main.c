...
{
    TRAINER_CLASS(PKMN_TRAINER_1, "{PKMN} Trainer", 15, POKE),
    TRAINER_CLASS(PKMN_TRAINER_2, "{PKMN} Trainer", DEFAULT_MONEY, POKE),
    TRAINER_CLASS(HIKER, "Hiker", 10, HEAVY),
    TRAINER_CLASS(TEAM_AQUA, "Team Aqua", 5, DIVE),
    TRAINER_CLASS(PKMN_BREEDER, "{PKMN} Breeder", 10, FRIEND),
    TRAINER_CLASS(COOLTRAINER, "Ace Trainer", 12, ULTRA),
    TRAINER_CLASS(BIRD_KEEPER, "Bird Keeper", 8, NEST),
    TRAINER_CLASS(COLLECTOR, "Collector", 15, PREMIER),
    TRAINER_CLASS(SWIMMER_M, "Swimmer♂", 2, DIVE),
    TRAINER_CLASS(TEAM_MAGMA, "Team Magma", 5, HEAVY),
    TRAINER_CLASS(EXPERT, "Expert", 10, ULTRA),
    TRAINER_CLASS(AQUA_ADMIN, "Aqua Admin", 10, DIVE),
    TRAINER_CLASS(BLACK_BELT, "Black Belt", 8, ULTRA),
    TRAINER_CLASS(AQUA_LEADER, "Aqua Leader", 20, DIVE),
    TRAINER_CLASS(HEX_MANIAC, "Hex Maniac", 6, DUSK),
    TRAINER_CLASS(AROMA_LADY, "Aroma Lady", 10, POKE),
    TRAINER_CLASS(RUIN_MANIAC, "Ruin Maniac", 15, TIMER),
    TRAINER_CLASS(INTERVIEWER, "Interviewers", 12, POKE),
    TRAINER_CLASS(TUBER_F, "Tuber", 1, DIVE),
    TRAINER_CLASS(TUBER_M, "Tuber", 1, DIVE),
    TRAINER_CLASS(LADY, "Lady", 50, LUXURY),
    TRAINER_CLASS(BEAUTY, "Beauty", 20, GREAT),
    TRAINER_CLASS(RICH_BOY, "Rich Boy", 50, LUXURY),
    TRAINER_CLASS(POKEMANIAC, "Poké Maniac", 15, POKE),
    TRAINER_CLASS(GUITARIST, "Guitarist", 8, POKE),
    TRAINER_CLASS(KINDLER, "Kindler", 8, POKE),
    TRAINER_CLASS(CAMPER, "Camper", 4, POKE),
    TRAINER_CLASS(PICNICKER, "Picnicker", 4, POKE),
    TRAINER_CLASS(BUG_MANIAC, "Bug Maniac", 15, NET),
    TRAINER_CLASS(PSYCHIC, "Psychic", 6, POKE),
    TRAINER_CLASS(GENTLEMAN, "Gentleman", 50, LUXURY),
    TRAINER_CLASS(ELITE_FOUR, "Elite Four", 25, ULTRA),
    TRAINER_CLASS(LEADER, "Leader", 25, ULTRA),
    TRAINER_CLASS(SCHOOL_KID, "Schoolkid", 5, POKE),
    TRAINER_CLASS(SR_AND_JR, "Teammates", 4, POKE),
    TRAINER_CLASS(WINSTRATE, "Winstrates'", 10, ULTRA),
    TRAINER_CLASS(POKEFAN, "Poké Fan", 20, REPEAT),
    TRAINER_CLASS(YOUNGSTER, "Youngster", 4, POKE),
    TRAINER_CLASS(CHAMPION, "Champion", 50, ULTRA),
    TRAINER_CLASS(FISHERMAN, "Fisherman", 10, LURE),
    TRAINER_CLASS(TRIATHLETE, "Triathlete", 10, QUICK),
    TRAINER_CLASS(DRAGON_TAMER, "Dragon Tamer", 12, ULTRA),
    TRAINER_CLASS(NINJA_BOY, "Ninja Boy", 3, POKE),
    TRAINER_CLASS(BATTLE_GIRL, "Battle Girl", 6, POKE),
    TRAINER_CLASS(PARASOL_LADY, "Parasol Lady", 10, POKE),
    TRAINER_CLASS(SWIMMER_F, "Swimmer♀", 2, DIVE),
    TRAINER_CLASS(TWINS, "Twins", 3, POKE),
    TRAINER_CLASS(SAILOR, "Sailor", 8, DIVE),
    TRAINER_CLASS(COOLTRAINER_2, "Cool Trainer", DEFAULT_MONEY, CHERISH),
    TRAINER_CLASS(MAGMA_ADMIN, "Magma Admin", 10, HEAVY),
    TRAINER_CLASS(RIVAL, "{PKMN} Trainer", 15, POKE),
    TRAINER_CLASS(BUG_CATCHER, "Bug Catcher", 4, NET),
    TRAINER_CLASS(PKMN_RANGER, "{PKMN} Ranger", 12, NEST),
    TRAINER_CLASS(MAGMA_LEADER, "Magma Leader", 20, HEAVY),
    TRAINER_CLASS(LASS, "Lass", 4, POKE),
    TRAINER_CLASS(YOUNG_COUPLE, "Young Couple", 8, LOVE),
    TRAINER_CLASS(OLD_COUPLE, "Old Couple", 10, ULTRA),
    TRAINER_CLASS(SIS_AND_BRO, "Sis & Bro", 3, DIVE),
    TRAINER_CLASS(SALON_MAIDEN, "Salon Maiden", DEFAULT_MONEY, POKE),
    TRAINER_CLASS(DOME_ACE, "Dome Ace", DEFAULT_MONEY, POKE),
    TRAINER_CLASS(PALACE_MAVEN, "Palace Maven", DEFAULT_MONEY, POKE),
    TRAINER_CLASS(ARENA_TYCOON, "Arena Tycoon", DEFAULT_MONEY, POKE),
    TRAINER_CLASS(FACTORY_HEAD, "Factory Head", DEFAULT_MONEY, POKE),
    TRAINER_CLASS(PIKE_QUEEN, "Pike Queen", DEFAULT_MONEY, POKE),
    TRAINER_CLASS(PYRAMID_KING, "Pyramid King", DEFAULT_MONEY, POKE),
    TRAINER_CLASS(RS_PROTAG, "{PKMN} Trainer", DEFAULT_MONEY, POKE),
    TRAINER_CLASS(BIKER, "Biker", DEFAULT_MONEY, POKE),
};
