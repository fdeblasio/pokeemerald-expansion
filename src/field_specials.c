...
void ShowNatureGirlMessage(void)
{
    static const u8 *const sNatureGirlMessages[NUM_NATURES] = {
        [NATURE_HARDY]   = BattleFrontier_Lounge5_Text_NatureGirlAttackAttack,
        [NATURE_LONELY]  = BattleFrontier_Lounge5_Text_NatureGirlSupportAttack,
        [NATURE_BRAVE]   = BattleFrontier_Lounge5_Text_NatureGirlAttackAttack,
        [NATURE_ADAMANT] = BattleFrontier_Lounge5_Text_NatureGirlAttackAttack,
        [NATURE_NAUGHTY] = BattleFrontier_Lounge5_Text_NatureGirlSupportSupport,
        [NATURE_BOLD]    = BattleFrontier_Lounge5_Text_NatureGirlSupportDefense,
        [NATURE_DOCILE]  = BattleFrontier_Lounge5_Text_NatureGirlDefenseDefense,
        [NATURE_RELAXED] = BattleFrontier_Lounge5_Text_NatureGirlSupportAttack,
        [NATURE_IMPISH]  = BattleFrontier_Lounge5_Text_NatureGirlSupportDefense,
        [NATURE_LAX]     = BattleFrontier_Lounge5_Text_NatureGirlSupportSupport,
        [NATURE_TIMID]   = BattleFrontier_Lounge5_Text_NatureGirlAttackDefense,
        [NATURE_HASTY]   = BattleFrontier_Lounge5_Text_NatureGirlAttackSupport,
        [NATURE_SERIOUS] = BattleFrontier_Lounge5_Text_NatureGirlSupportSupport,
        [NATURE_JOLLY]   = BattleFrontier_Lounge5_Text_NatureGirlSupportDefense,
        [NATURE_NAIVE]   = BattleFrontier_Lounge5_Text_NatureGirlAttackAttack,
        [NATURE_MODEST]  = BattleFrontier_Lounge5_Text_NatureGirlAttackAttack,
        [NATURE_MILD]    = BattleFrontier_Lounge5_Text_NatureGirlDefenseSupport,
        [NATURE_QUIET]   = BattleFrontier_Lounge5_Text_NatureGirlDefenseAttack,
        [NATURE_BASHFUL] = BattleFrontier_Lounge5_Text_NatureGirlDefenseDefense,
        [NATURE_RASH]    = BattleFrontier_Lounge5_Text_NatureGirlSupportSupport,
        [NATURE_CALM]    = BattleFrontier_Lounge5_Text_NatureGirlDefenseDefense,
        [NATURE_GENTLE]  = BattleFrontier_Lounge5_Text_NatureGirlSupportAttack,
        [NATURE_SASSY]   = BattleFrontier_Lounge5_Text_NatureGirlAttackAttack,
        [NATURE_CAREFUL] = BattleFrontier_Lounge5_Text_NatureGirlDefenseSupport,
        [NATURE_QUIRKY]  = BattleFrontier_Lounge5_Text_NatureGirlAttackAttack,
    };
