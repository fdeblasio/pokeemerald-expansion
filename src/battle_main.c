...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    TRAINER_CLASS(HIKER, "Hiker", 10, BALL_HEAVY),
    TRAINER_CLASS(TEAM_AQUA, "Team Aqua", 5, BALL_DIVE),
    TRAINER_CLASS(PKMN_BREEDER, "{PKMN} Breeder", 10, BALL_FRIEND),
    TRAINER_CLASS(ACE_TRAINER, "Ace Trainer", 12, BALL_ULTRA),
    TRAINER_CLASS(BIRD_KEEPER, "Bird Keeper", 8, BALL_NEST),
    TRAINER_CLASS(COLLECTOR, "Collector", 15, BALL_PREMIER),
    TRAINER_CLASS(SWIMMER, "Swimmer", 2, BALL_DIVE),
    TRAINER_CLASS(TEAM_MAGMA, "Team Magma", 5, BALL_HEAVY),
    TRAINER_CLASS(EXPERT, "Expert", 10, BALL_ULTRA),
    TRAINER_CLASS(AQUA_ADMIN, "Aqua Admin", 10, BALL_DIVE),
    TRAINER_CLASS(BLACK_BELT, "Black Belt", 8, BALL_ULTRA),
    TRAINER_CLASS(AQUA_LEADER, "Aqua Leader", 20, BALL_DIVE),
    TRAINER_CLASS(HEX_MANIAC, "Hex Maniac", 6, BALL_DUSK),
    TRAINER_CLASS(AROMA_LADY, "Aroma Lady", 10),
    TRAINER_CLASS(RUIN_MANIAC, "Ruin Maniac", 15, BALL_TIMER),
    TRAINER_CLASS(INTERVIEWER, "Interviewer", 12),
    TRAINER_CLASS(TUBER, "Tuber", 1, BALL_DIVE),
    ...
    TRAINER_CLASS(BUG_MANIAC, "Bug Maniac", 15, BALL_NET),
    TRAINER_CLASS(PSYCHIC, "Psychic", 6),
    TRAINER_CLASS(GENTLEMAN, "Gentleman", 50, BALL_LUXURY),
    ...
    TRAINER_CLASS(POKE_FAN, "Poké Fan", 20, BALL_REPEAT),
    TRAINER_CLASS(YOUNGSTER, "Youngster", 4),
    TRAINER_CLASS(CHAMPION, "Champion", 50, BALL_ULTRA),
    TRAINER_CLASS(FISHERMAN, "Fisherman", 10, BALL_LURE),
    TRAINER_CLASS(TRIATHLETE, "Triathlete", 10, BALL_QUICK),
    TRAINER_CLASS(DRAGON_TAMER, "Dragon Tamer", 12, BALL_ULTRA),
    ...
    TRAINER_CLASS(SAILOR, "Sailor", 8, BALL_DIVE),
    TRAINER_CLASS(COOL_TRAINER, "Cool Trainer", 5, BALL_CHERISH),
    TRAINER_CLASS(MAGMA_ADMIN, "Magma Admin", 10, BALL_HEAVY),
    TRAINER_CLASS(RIVAL, "{PKMN} Trainer", 15),
    TRAINER_CLASS(BUG_CATCHER, "Bug Catcher", 4, BALL_NET),
    TRAINER_CLASS(PKMN_RANGER, "{PKMN} Ranger", 12, BALL_NEST),
    TRAINER_CLASS(MAGMA_LEADER, "Magma Leader", 20, BALL_HEAVY),
    TRAINER_CLASS(LASS, "Lass", 4),
    TRAINER_CLASS(YOUNG_COUPLE, "Young Couple", 8, BALL_LOVE),
    TRAINER_CLASS(OLD_COUPLE, "Old Couple", 10, BALL_ULTRA),
    TRAINER_CLASS(SIS_AND_BRO, "Sis & Bro", 3, BALL_DIVE),
    ...
    TRAINER_CLASS(YOUNGSTER_FRLG, "Youngster", 4),
    TRAINER_CLASS(BUG_CATCHER_FRLG, "Bug Catcher", 3, BALL_NET),
    TRAINER_CLASS(LASS_FRLG, "Lass", 4),
    TRAINER_CLASS(SAILOR_FRLG, "Sailor", 8, BALL_DIVE),
    TRAINER_CLASS(CAMPER_FRLG, "Camper", 5),
    TRAINER_CLASS(PICNICKER_FRLG, "Picnicker", 5),
    TRAINER_CLASS(POKEMANIAC_FRLG, "Poké Maniac", 12),
    TRAINER_CLASS(SUPER_NERD_FRLG, "Super Nerd", 6),
    TRAINER_CLASS(HIKER_FRLG, "Hiker", 9, BALL_HEAVY),
    TRAINER_CLASS(BIKER_FRLG, "Biker", 5),
    TRAINER_CLASS(BURGLAR_FRLG, "Burglar", 22, BALL_DUSK),
    TRAINER_CLASS(ENGINEER_FRLG, "Engineer", 12, BALL_ULTRA),
    TRAINER_CLASS(FISHERMAN_FRLG, "Fisherman", 9, BALL_LURE),
    TRAINER_CLASS(SWIMMER_M_FRLG, "Swimmer♂", 1, BALL_DIVE),
    TRAINER_CLASS(CUE_BALL_FRLG, "Cue Ball", 6, BALL_PREMIER),
    TRAINER_CLASS(GAMER_FRLG, "Gamer", 18),
    TRAINER_CLASS(BEAUTY_FRLG, "Beauty", 18, BALL_GREAT),
    TRAINER_CLASS(SWIMMER_F_FRLG, "Swimmer♀", 1, BALL_DIVE),
    TRAINER_CLASS(PSYCHIC_FRLG, "Psychic", 5),
    TRAINER_CLASS(ROCKER_FRLG, "Rocker", 6, BALL_ULTRA),
    TRAINER_CLASS(JUGGLER_FRLG, "Juggler", 10),
    TRAINER_CLASS(TAMER_FRLG, "Tamer", 10),
    TRAINER_CLASS(BIRD_KEEPER_FRLG, "Bird Keeper", 6, BALL_NEST),
    TRAINER_CLASS(BLACK_BELT_FRLG, "Black Belt", 6, BALL_ULTRA),
    TRAINER_CLASS(RIVAL_EARLY_FRLG, "Rival", 4),
    TRAINER_CLASS(SCIENTIST_FRLG, "Scientist", 12, BALL_REPEAT),
    TRAINER_CLASS(BOSS_FRLG, "Boss", 25),
    TRAINER_CLASS(LEADER_FRLG, "Leader", 25),
    TRAINER_CLASS(TEAM_ROCKET_FRLG, "Team Rocket", 8),
    TRAINER_CLASS(COOLTRAINER_FRLG, "Cool Trainer", 9, BALL_ULTRA),
    TRAINER_CLASS(ELITE_FOUR_FRLG, "Elite Four", 25, BALL_ULTRA),
    TRAINER_CLASS(GENTLEMAN_FRLG, "Gentleman", 18, BALL_LUXURY),
    TRAINER_CLASS(RIVAL_LATE_FRLG, "Rival", 9),
    TRAINER_CLASS(CHAMPION_FRLG, "Champion", 25),
    TRAINER_CLASS(CHANNELER_FRLG, "Channeler", 8, BALL_DUSK),
    TRAINER_CLASS(TWINS_FRLG, "Twins", 3),
    TRAINER_CLASS(COOL_COUPLE_FRLG, "Cool Couple", 6, BALL_ULTRA),
    TRAINER_CLASS(YOUNG_COUPLE_FRLG, "Young Couple", 7),
    TRAINER_CLASS(CRUSH_KIN_FRLG, "Crush Kin", 6, BALL_ULTRA),
    TRAINER_CLASS(SIS_AND_BRO_FRLG, "Sis and Bro", 1),
    TRAINER_CLASS(PKMN_PROF_FRLG, "{PKMN} Prof.", 25),
    TRAINER_CLASS(PLAYER_FRLG, "{PKMN} Trainer", 1),
    TRAINER_CLASS(CRUSH_GIRL_FRLG, "Crush Girl", 6),
    TRAINER_CLASS(TUBER_FRLG, "Tuber", 1),
    TRAINER_CLASS(PKMN_BREEDER_FRLG, "{PKMN} Breeder", 7, BALL_FRIEND),
    TRAINER_CLASS(PKMN_RANGER_FRLG, "{PKMN} Ranger", 9),
    TRAINER_CLASS(AROMA_LADY_FRLG, "Aroma Lady", 7),
    TRAINER_CLASS(RUIN_MANIAC_FRLG, "Ruin Maniac", 12),
    TRAINER_CLASS(LADY_FRLG, "Lady", 50),
    TRAINER_CLASS(PAINTER_FRLG, "Painter", 4),
};
...
void CustomTrainerPartyAssignMoves(struct Pokemon *mon, const struct TrainerMon *partyEntry)
{
    ...
    for (j = 0; j < MAX_MON_MOVES; ++j)
    {
        u8 maxPP = CalculateMaxPP(partyEntry->moves[j]);
...
u32 GetDynamicPower(struct Pokemon *mon, enum Move move, enum BattlerId battler){
