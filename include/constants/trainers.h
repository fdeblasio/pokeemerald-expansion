...
#define TRAINER_PIC_LEADER_MARIBEL        TRAINER_PIC_ELITE_FOUR_LORELEI_FRLG
#define TRAINER_PIC_LEADER_ADAM           TRAINER_PIC_LEADER_BRAWLY
#define TRAINER_PIC_LEADER_LINDA          TRAINER_PIC_LEADER_ROXANNE
#define TRAINER_PIC_LEADER_HELENE         TRAINER_PIC_LEADER_ERIKA_FRLG
#define TRAINER_PIC_LEADER_ERIC           TRAINER_PIC_SUPER_NERD_FRLG
#define TRAINER_PIC_LEADER_YUNDA          TRAINER_PIC_SCIENTIST_FRLG
#define TRAINER_PIC_LEADER_IVANNA         TRAINER_PIC_LEADER_FLANNERY
#define TRAINER_PIC_LEADER_PAT            TRAINER_PIC_LEADER_JUAN
#define TRAINER_PIC_ELITE_FOUR_THUY       TRAINER_PIC_ELITE_FOUR_GLACIA
#define TRAINER_PIC_ELITE_FOUR_BRIAN      TRAINER_PIC_ELITE_FOUR_LANCE_FRLG
#define TRAINER_PIC_ELITE_FOUR_KIMBERLY   TRAINER_PIC_LEADER_WINONA
#define TRAINER_PIC_ELITE_FOUR_RAFAEL_III TRAINER_PIC_ELITE_FOUR_BRUNO_FRLG
...
enum
{
    ...
    RS_FACILITY_CLASS_SCHOOLKID_M,
    RS_FACILITY_CLASS_SCHOOLKID_F,
    RS_FACILITY_CLASS_TEAMMATES,
    RS_FACILITY_CLASS_POKE_FAN_M,
    RS_FACILITY_CLASS_POKE_FAN_F,
...
enum TrainerClassID
{
    ...
    TRAINER_CLASS_POKEMON_BREEDER_M = TRAINER_CLASS_PKMN_BREEDER,
    TRAINER_CLASS_POKEMON_BREEDER_F = TRAINER_CLASS_PKMN_BREEDER,
    TRAINER_CLASS_ACE_TRAINER,
    TRAINER_CLASS_ACE_TRAINER_M = TRAINER_CLASS_ACE_TRAINER,
    TRAINER_CLASS_ACE_TRAINER_F = TRAINER_CLASS_ACE_TRAINER,
    TRAINER_CLASS_BIRD_KEEPER,
    TRAINER_CLASS_COLLECTOR,
    TRAINER_CLASS_SWIMMER,
    TRAINER_CLASS_SWIMMER_M = TRAINER_CLASS_SWIMMER,
    TRAINER_CLASS_SWIMMER_F = TRAINER_CLASS_SWIMMER,
    TRAINER_CLASS_TEAM_MAGMA,
    TRAINER_CLASS_EXPERT,
    TRAINER_CLASS_EXPERT_M = TRAINER_CLASS_EXPERT,
    TRAINER_CLASS_EXPERT_F = TRAINER_CLASS_EXPERT,
    ...
    TRAINER_CLASS_TUBER,
    TRAINER_CLASS_TUBER_M = TRAINER_CLASS_TUBER,
    TRAINER_CLASS_TUBER_F = TRAINER_CLASS_TUBER,
    TRAINER_CLASS_LADY,
    ...
    TRAINER_CLASS_PSYCHIC_F = TRAINER_CLASS_PSYCHIC,
    TRAINER_CLASS_GENTLEMAN,
    TRAINER_CLASS_ELITE_FOUR,
    TRAINER_CLASS_LEADER,
    TRAINER_CLASS_SCHOOLKID,
    TRAINER_CLASS_SCHOOLKID_M = TRAINER_CLASS_SCHOOLKID,
    TRAINER_CLASS_SCHOOLKID_F = TRAINER_CLASS_SCHOOLKID,
    TRAINER_CLASS_TEAMMATES,
    TRAINER_CLASS_WINSTRATE,
    TRAINER_CLASS_POKE_FAN,
    TRAINER_CLASS_POKE_FAN_M = TRAINER_CLASS_POKE_FAN,
    TRAINER_CLASS_POKE_FAN_F = TRAINER_CLASS_POKE_FAN,
    TRAINER_CLASS_YOUNGSTER,
    TRAINER_CLASS_CHAMPION,
    TRAINER_CLASS_FISHERMAN,
    TRAINER_CLASS_TRIATHLETE,
    TRAINER_CLASS_RUNNING_TRIATHLETE_M = TRAINER_CLASS_TRIATHLETE,
    TRAINER_CLASS_RUNNING_TRIATHLETE_F = TRAINER_CLASS_TRIATHLETE,
    TRAINER_CLASS_CYCLING_TRIATHLETE_M = TRAINER_CLASS_TRIATHLETE,
    TRAINER_CLASS_CYCLING_TRIATHLETE_F = TRAINER_CLASS_TRIATHLETE,
    TRAINER_CLASS_SWIMMING_TRIATHLETE_M = TRAINER_CLASS_TRIATHLETE,
    TRAINER_CLASS_SWIMMING_TRIATHLETE_F = TRAINER_CLASS_TRIATHLETE,
    ...
    TRAINER_CLASS_COOL_TRAINER, // Used for only one trainer.
    TRAINER_CLASS_MAGMA_ADMIN,
    TRAINER_CLASS_RIVAL,
    TRAINER_CLASS_BUG_CATCHER,
    TRAINER_CLASS_PKMN_RANGER,
    TRAINER_CLASS_POKEMON_RANGER_M = TRAINER_CLASS_PKMN_RANGER,
    TRAINER_CLASS_POKEMON_RANGER_F = TRAINER_CLASS_PKMN_RANGER,
...
#define TRAINER_ENCOUNTER_MUSIC_TWINS        9 // Used for Twins, Poké Fans, and Teammates
...
#define TRAINER_ENCOUNTER_MUSIC_YOUNGSTER            TRAINER_ENCOUNTER_MUSIC_MALE
#define TRAINER_ENCOUNTER_MUSIC_BUG_CATCHER          TRAINER_ENCOUNTER_MUSIC_MALE
#define TRAINER_ENCOUNTER_MUSIC_SAILOR               TRAINER_ENCOUNTER_MUSIC_MALE
#define TRAINER_ENCOUNTER_MUSIC_CAMPER               TRAINER_ENCOUNTER_MUSIC_MALE
#define TRAINER_ENCOUNTER_MUSIC_SCHOOLKID_M          TRAINER_ENCOUNTER_MUSIC_MALE
#define TRAINER_ENCOUNTER_MUSIC_POKEMON_BREEDER_M    TRAINER_ENCOUNTER_MUSIC_MALE
#define TRAINER_ENCOUNTER_MUSIC_CYCLING_TRIATHLETE_M TRAINER_ENCOUNTER_MUSIC_MALE
#define TRAINER_ENCOUNTER_MUSIC_RUNNING_TRIATHLETE_M TRAINER_ENCOUNTER_MUSIC_MALE

#define TRAINER_ENCOUNTER_MUSIC_LASS                 TRAINER_ENCOUNTER_MUSIC_FEMALE
#define TRAINER_ENCOUNTER_MUSIC_LADY                 TRAINER_ENCOUNTER_MUSIC_FEMALE
#define TRAINER_ENCOUNTER_MUSIC_BEAUTY               TRAINER_ENCOUNTER_MUSIC_FEMALE
#define TRAINER_ENCOUNTER_MUSIC_AROMA_LADY           TRAINER_ENCOUNTER_MUSIC_FEMALE
#define TRAINER_ENCOUNTER_MUSIC_PARASOL_LADY         TRAINER_ENCOUNTER_MUSIC_FEMALE
#define TRAINER_ENCOUNTER_MUSIC_POKEMON_BREEDER_F    TRAINER_ENCOUNTER_MUSIC_FEMALE
#define TRAINER_ENCOUNTER_MUSIC_CYCLING_TRIATHLETE_F TRAINER_ENCOUNTER_MUSIC_FEMALE
#define TRAINER_ENCOUNTER_MUSIC_RUNNING_TRIATHLETE_F TRAINER_ENCOUNTER_MUSIC_FEMALE

#define TRAINER_ENCOUNTER_MUSIC_PICNICKER    TRAINER_ENCOUNTER_MUSIC_GIRL
#define TRAINER_ENCOUNTER_MUSIC_YOUNG_COUPLE TRAINER_ENCOUNTER_MUSIC_GIRL
#define TRAINER_ENCOUNTER_MUSIC_TUBER_F      TRAINER_ENCOUNTER_MUSIC_GIRL
#define TRAINER_ENCOUNTER_MUSIC_TUBER_M      TRAINER_ENCOUNTER_MUSIC_GIRL
#define TRAINER_ENCOUNTER_MUSIC_SCHOOLKID_F  TRAINER_ENCOUNTER_MUSIC_GIRL
#define TRAINER_ENCOUNTER_MUSIC_YOUNG_COUPLE TRAINER_ENCOUNTER_MUSIC_GIRL

#define TRAINER_ENCOUNTER_MUSIC_NINJA_BOY    TRAINER_ENCOUNTER_MUSIC_SUSPICIOUS
#define TRAINER_ENCOUNTER_MUSIC_COLLECTOR    TRAINER_ENCOUNTER_MUSIC_SUSPICIOUS
#define TRAINER_ENCOUNTER_MUSIC_HEX_MANIAC   TRAINER_ENCOUNTER_MUSIC_SUSPICIOUS
#define TRAINER_ENCOUNTER_MUSIC_POKE_MANIAC  TRAINER_ENCOUNTER_MUSIC_SUSPICIOUS
#define TRAINER_ENCOUNTER_MUSIC_BUG_MANIAC   TRAINER_ENCOUNTER_MUSIC_SUSPICIOUS

#define TRAINER_ENCOUNTER_MUSIC_GUITARIST    TRAINER_ENCOUNTER_MUSIC_INTENSE
#define TRAINER_ENCOUNTER_MUSIC_BLACK_BELT   TRAINER_ENCOUNTER_MUSIC_INTENSE
#define TRAINER_ENCOUNTER_MUSIC_BATTLE_GIRL  TRAINER_ENCOUNTER_MUSIC_INTENSE
#define TRAINER_ENCOUNTER_MUSIC_DRAGON_TAMER TRAINER_ENCOUNTER_MUSIC_INTENSE
#define TRAINER_ENCOUNTER_MUSIC_PSYCHIC_M    TRAINER_ENCOUNTER_MUSIC_INTENSE
#define TRAINER_ENCOUNTER_MUSIC_PSYCHIC_F    TRAINER_ENCOUNTER_MUSIC_INTENSE
#define TRAINER_ENCOUNTER_MUSIC_EXPERT_M     TRAINER_ENCOUNTER_MUSIC_INTENSE
#define TRAINER_ENCOUNTER_MUSIC_EXPERT_F     TRAINER_ENCOUNTER_MUSIC_INTENSE
#define TRAINER_ENCOUNTER_MUSIC_OLD_COUPLE   TRAINER_ENCOUNTER_MUSIC_INTENSE

#define TRAINER_ENCOUNTER_MUSIC_ACE_TRAINER_M    TRAINER_ENCOUNTER_MUSIC_COOL
#define TRAINER_ENCOUNTER_MUSIC_ACE_TRAINER_F    TRAINER_ENCOUNTER_MUSIC_COOL
#define TRAINER_ENCOUNTER_MUSIC_BIRD_KEEPER      TRAINER_ENCOUNTER_MUSIC_COOL
#define TRAINER_ENCOUNTER_MUSIC_POKEMON_RANGER_M TRAINER_ENCOUNTER_MUSIC_COOL
#define TRAINER_ENCOUNTER_MUSIC_POKEMON_RANGER_F TRAINER_ENCOUNTER_MUSIC_COOL

#define TRAINER_ENCOUNTER_MUSIC_SWIMMER_M             TRAINER_ENCOUNTER_MUSIC_SWIMMER
#define TRAINER_ENCOUNTER_MUSIC_SWIMMER_F             TRAINER_ENCOUNTER_MUSIC_SWIMMER
#define TRAINER_ENCOUNTER_MUSIC_SIS_AND_BRO           TRAINER_ENCOUNTER_MUSIC_SWIMMER
#define TRAINER_ENCOUNTER_MUSIC_SWIMMING_TRIATHLETE_M TRAINER_ENCOUNTER_MUSIC_SWIMMER
#define TRAINER_ENCOUNTER_MUSIC_SWIMMING_TRIATHLETE_F TRAINER_ENCOUNTER_MUSIC_SWIMMER

#define TRAINER_ENCOUNTER_MUSIC_TEAMMATES    TRAINER_ENCOUNTER_MUSIC_TWINS
#define TRAINER_ENCOUNTER_MUSIC_POKE_FAN_M   TRAINER_ENCOUNTER_MUSIC_TWINS
#define TRAINER_ENCOUNTER_MUSIC_POKE_FAN_F   TRAINER_ENCOUNTER_MUSIC_TWINS

#define TRAINER_ENCOUNTER_MUSIC_RUIN_MANIAC  TRAINER_ENCOUNTER_MUSIC_HIKER
#define TRAINER_ENCOUNTER_MUSIC_KINDLER      TRAINER_ENCOUNTER_MUSIC_HIKER
#define TRAINER_ENCOUNTER_MUSIC_FISHERMAN    TRAINER_ENCOUNTER_MUSIC_HIKER

#define TRAINER_ENCOUNTER_MUSIC_RICH_BOY     TRAINER_ENCOUNTER_MUSIC_RICH
#define TRAINER_ENCOUNTER_MUSIC_GENTLEMAN    TRAINER_ENCOUNTER_MUSIC_RICH

#define TRAINER_GENDER_MALE   0
#define TRAINER_GENDER_FEMALE 1

// Trainer party defines
#define TRAINER_MON_NONE          0
