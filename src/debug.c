...
#define DEBUG_ITEM(Item, String) [Item] = {String, Item}

// *******************************
// List Menu Items
static const struct ListMenuItem sDebugMenu_Items_Main[] =
{
    DEBUG_ITEM(DEBUG_MENU_ITEM_UTILITIES,     COMPOUND_STRING("Utilities…{CLEAR_TO 110}{RIGHT_ARROW}")),
    DEBUG_ITEM(DEBUG_MENU_ITEM_PCBAG,         COMPOUND_STRING("PC/Bag…{CLEAR_TO 110}{RIGHT_ARROW}")),
    DEBUG_ITEM(DEBUG_MENU_ITEM_PARTY,         COMPOUND_STRING("Party…{CLEAR_TO 110}{RIGHT_ARROW}")),
    DEBUG_ITEM(DEBUG_MENU_ITEM_GIVE,          COMPOUND_STRING("Give X…{CLEAR_TO 110}{RIGHT_ARROW}")),
    DEBUG_ITEM(DEBUG_MENU_ITEM_SCRIPTS,       COMPOUND_STRING("Scripts…{CLEAR_TO 110}{RIGHT_ARROW}")),
    DEBUG_ITEM(DEBUG_MENU_ITEM_FLAGVAR,       COMPOUND_STRING("Flags & Vars…{CLEAR_TO 110}{RIGHT_ARROW}")),
    //DEBUG_ITEM(DEBUG_MENU_ITEM_BATTLE,        COMPOUND_STRING("Battle Test{CLEAR_TO 110}{RIGHT_ARROW}")),
    DEBUG_ITEM(DEBUG_MENU_ITEM_SOUND,         COMPOUND_STRING("Sound…{CLEAR_TO 110}{RIGHT_ARROW}")),
    DEBUG_ITEM(DEBUG_MENU_ITEM_CANCEL,        COMPOUND_STRING("Cancel")),
};

static const struct ListMenuItem sDebugMenu_Items_Utilities[] =
{
    DEBUG_ITEM(DEBUG_UTIL_MENU_ITEM_FLY,             COMPOUND_STRING("Fly to map{CLEAR_TO 110}{RIGHT_ARROW}")),
    DEBUG_ITEM(DEBUG_UTIL_MENU_ITEM_WARP,            COMPOUND_STRING("Warp to map warp{CLEAR_TO 110}{RIGHT_ARROW}")),
    DEBUG_ITEM(DEBUG_UTIL_MENU_ITEM_SAVEBLOCK,       COMPOUND_STRING("Save Block space…{CLEAR_TO 110}{RIGHT_ARROW}")),
    DEBUG_ITEM(DEBUG_UTIL_MENU_ITEM_ROM_SPACE,       COMPOUND_STRING("ROM space…{CLEAR_TO 110}{RIGHT_ARROW}")),
    DEBUG_ITEM(DEBUG_UTIL_MENU_ITEM_WEATHER,         COMPOUND_STRING("Set weather…{CLEAR_TO 110}{RIGHT_ARROW}")),
    DEBUG_ITEM(DEBUG_UTIL_MENU_ITEM_FONT_TEST,       COMPOUND_STRING("Font Test…{CLEAR_TO 110}{RIGHT_ARROW}")),
    DEBUG_ITEM(DEBUG_UTIL_MENU_ITEM_CHECKWALLCLOCK,  COMPOUND_STRING("Check wall clock…{CLEAR_TO 110}{RIGHT_ARROW}")),
    DEBUG_ITEM(DEBUG_UTIL_MENU_ITEM_SETWALLCLOCK,    COMPOUND_STRING("Set wall clock…{CLEAR_TO 110}{RIGHT_ARROW}")),
    DEBUG_ITEM(DEBUG_UTIL_MENU_ITEM_WATCHCREDITS,    COMPOUND_STRING("Watch credits…{CLEAR_TO 110}{RIGHT_ARROW}")),
    DEBUG_ITEM(DEBUG_UTIL_MENU_ITEM_PLAYER_NAME,     COMPOUND_STRING("Player name")),
    DEBUG_ITEM(DEBUG_UTIL_MENU_ITEM_PLAYER_GENDER,   COMPOUND_STRING("Toggle gender")),
    DEBUG_ITEM(DEBUG_UTIL_MENU_ITEM_PLAYER_ID,       COMPOUND_STRING("New Trainer ID")),
    DEBUG_ITEM(DEBUG_UTIL_MENU_ITEM_CHEAT,           COMPOUND_STRING("Cheat start")),
    DEBUG_ITEM(DEBUG_UTIL_MENU_ITEM_EXPANSION_VER,   COMPOUND_STRING("Expansion Version")),
    DEBUG_ITEM(DEBUG_UTIL_MENU_ITEM_BERRY_FUNCTIONS, COMPOUND_STRING("Berry Functions…{CLEAR_TO 110}{RIGHT_ARROW}")),
    DEBUG_ITEM(DEBUG_UTIL_MENU_ITEM_EWRAM_COUNTERS,  COMPOUND_STRING("EWRAM Counters…{CLEAR_TO 110}{RIGHT_ARROW}")),
    DEBUG_ITEM(DEBUG_UTIL_MENU_ITEM_STEVEN_MULTI,    COMPOUND_STRING("Steven Multi")),
};

static const struct ListMenuItem sDebugMenu_Items_PCBag[] =
{
    DEBUG_ITEM(DEBUG_PCBAG_MENU_ITEM_ACCESS_PC,   COMPOUND_STRING("Access PC")),
    DEBUG_ITEM(DEBUG_PCBAG_MENU_ITEM_FILL,        COMPOUND_STRING("Fill…{CLEAR_TO 110}{RIGHT_ARROW}")),
    DEBUG_ITEM(DEBUG_PCBAG_MENU_ITEM_CLEAR_BAG,   COMPOUND_STRING("Clear Bag")),
    DEBUG_ITEM(DEBUG_PCBAG_MENU_ITEM_CLEAR_BOXES, COMPOUND_STRING("Clear Storage Boxes")),
};

static const struct ListMenuItem sDebugMenu_Items_PCBag_Fill[] =
{
    DEBUG_ITEM(DEBUG_PCBAG_MENU_ITEM_FILL_PC_BOXES_FAST,    COMPOUND_STRING("Fill PC Boxes Fast")),
    DEBUG_ITEM(DEBUG_PCBAG_MENU_ITEM_FILL_PC_BOXES_SLOW,    COMPOUND_STRING("Fill PC Boxes Slow (LAG!)")),
    DEBUG_ITEM(DEBUG_PCBAG_MENU_ITEM_FILL_PC_ITEMS,         COMPOUND_STRING("Fill PC Items")),
    DEBUG_ITEM(DEBUG_PCBAG_MENU_ITEM_FILL_POCKET_ITEMS,     COMPOUND_STRING("Fill Pocket Items")),
    DEBUG_ITEM(DEBUG_PCBAG_MENU_ITEM_FILL_POCKET_BALLS,     COMPOUND_STRING("Fill Pocket Poké Balls")),
    DEBUG_ITEM(DEBUG_PCBAG_MENU_ITEM_FILL_POCKET_TM,        COMPOUND_STRING("Fill TM Pocket")),
    DEBUG_ITEM(DEBUG_PCBAG_MENU_ITEM_FILL_POCKET_BERRIES,   COMPOUND_STRING("Fill Pocket Berries")),
    DEBUG_ITEM(DEBUG_PCBAG_MENU_ITEM_FILL_POCKET_KEY_ITEMS, COMPOUND_STRING("Fill Pocket Key Items")),
};

static const struct ListMenuItem sDebugMenu_Items_Party[] =
{
    DEBUG_ITEM(DEBUG_PARTY_MENU_ITEM_HATCH_AN_EGG,    COMPOUND_STRING("Hatch an Egg")),
    DEBUG_ITEM(DEBUG_PARTY_MENU_ITEM_HEAL_PARTY,      COMPOUND_STRING("Heal party")),
    DEBUG_ITEM(DEBUG_PARTY_MENU_ITEM_INFLICT_STATUS1, COMPOUND_STRING("Inflict Status1")),
    DEBUG_ITEM(DEBUG_PARTY_MENU_ITEM_CHECK_EVS,       COMPOUND_STRING("Check EVs")),
    DEBUG_ITEM(DEBUG_PARTY_MENU_ITEM_CHECK_IVS,       COMPOUND_STRING("Check IVs")),
    DEBUG_ITEM(DEBUG_PARTY_MENU_ITEM_CLEAR_PARTY,     COMPOUND_STRING("Clear Party")),
};

static const struct ListMenuItem sDebugMenu_Items_Scripts[] =
{
    DEBUG_ITEM(DEBUG_UTIL_MENU_ITEM_SCRIPT_1, COMPOUND_STRING("Script 1")),
    DEBUG_ITEM(DEBUG_UTIL_MENU_ITEM_SCRIPT_2, COMPOUND_STRING("Script 2")),
    DEBUG_ITEM(DEBUG_UTIL_MENU_ITEM_SCRIPT_3, COMPOUND_STRING("Script 3")),
    DEBUG_ITEM(DEBUG_UTIL_MENU_ITEM_SCRIPT_4, COMPOUND_STRING("Script 4")),
    DEBUG_ITEM(DEBUG_UTIL_MENU_ITEM_SCRIPT_5, COMPOUND_STRING("Script 5")),
    DEBUG_ITEM(DEBUG_UTIL_MENU_ITEM_SCRIPT_6, COMPOUND_STRING("Script 6")),
    DEBUG_ITEM(DEBUG_UTIL_MENU_ITEM_SCRIPT_7, COMPOUND_STRING("Script 7")),
    DEBUG_ITEM(DEBUG_UTIL_MENU_ITEM_SCRIPT_8, COMPOUND_STRING("Script 8")),
};

static const struct ListMenuItem sDebugMenu_Items_FlagsVars[] =
{
    DEBUG_ITEM(DEBUG_FLAGVAR_MENU_ITEM_FLAGS,                COMPOUND_STRING("Set Flag XYZ…{CLEAR_TO 110}{RIGHT_ARROW}")),
    DEBUG_ITEM(DEBUG_FLAGVAR_MENU_ITEM_VARS,                 COMPOUND_STRING("Set Var XYZ…{CLEAR_TO 110}{RIGHT_ARROW}")),
    DEBUG_ITEM(DEBUG_FLAGVAR_MENU_ITEM_DEXFLAGS_ALL,         COMPOUND_STRING("Pokédex Flags All")),
    DEBUG_ITEM(DEBUG_FLAGVAR_MENU_ITEM_DEXFLAGS_RESET,       COMPOUND_STRING("Pokédex Flags Reset")),
    DEBUG_ITEM(DEBUG_FLAGVAR_MENU_ITEM_TOGGLE_POKEDEX,       COMPOUND_STRING("Toggle {STR_VAR_1}Pokédex")),
    DEBUG_ITEM(DEBUG_FLAGVAR_MENU_ITEM_TOGGLE_NATDEX,        COMPOUND_STRING("Toggle {STR_VAR_1}National Dex")),
    DEBUG_ITEM(DEBUG_FLAGVAR_MENU_ITEM_TOGGLE_POKENAV,       COMPOUND_STRING("Toggle {STR_VAR_1}PokéNav")),
    DEBUG_ITEM(DEBUG_FLAGVAR_MENU_ITEM_TOGGLE_MATCH_CALL,    COMPOUND_STRING("Toggle {STR_VAR_1}Match Call")),
    DEBUG_ITEM(DEBUG_FLAGVAR_MENU_ITEM_TOGGLE_RUN_SHOES,     COMPOUND_STRING("Toggle {STR_VAR_1}Running Shoes")),
    DEBUG_ITEM(DEBUG_FLAGVAR_MENU_ITEM_TOGGLE_LOCATIONS,     COMPOUND_STRING("Toggle {STR_VAR_1}Fly Flags")),
    DEBUG_ITEM(DEBUG_FLAGVAR_MENU_ITEM_TOGGLE_BADGES_ALL,    COMPOUND_STRING("Toggle {STR_VAR_1}All badges")),
    DEBUG_ITEM(DEBUG_FLAGVAR_MENU_ITEM_TOGGLE_GAME_CLEAR,    COMPOUND_STRING("Toggle {STR_VAR_1}Game clear")),
    DEBUG_ITEM(DEBUG_FLAGVAR_MENU_ITEM_TOGGLE_FRONTIER_PASS, COMPOUND_STRING("Toggle {STR_VAR_1}Frontier Pass")),
    DEBUG_ITEM(DEBUG_FLAGVAR_MENU_ITEM_TOGGLE_COLLISION,     COMPOUND_STRING("Toggle {STR_VAR_1}Collision OFF")),
    DEBUG_ITEM(DEBUG_FLAGVAR_MENU_ITEM_TOGGLE_ENCOUNTER,     COMPOUND_STRING("Toggle {STR_VAR_1}Encounter OFF")),
    DEBUG_ITEM(DEBUG_FLAGVAR_MENU_ITEM_TOGGLE_TRAINER_SEE,   COMPOUND_STRING("Toggle {STR_VAR_1}Trainer See OFF")),
    DEBUG_ITEM(DEBUG_FLAGVAR_MENU_ITEM_TOGGLE_BAG_USE,       COMPOUND_STRING("Toggle {STR_VAR_1}Bag Use OFF")),
    DEBUG_ITEM(DEBUG_FLAGVAR_MENU_ITEM_TOGGLE_CATCHING,      COMPOUND_STRING("Toggle {STR_VAR_1}Catching OFF")),
};

static const struct ListMenuItem sDebugMenu_Items_Battle_0[] =
{
    DEBUG_ITEM(DEBUG_BATTLE_0_MENU_ITEM_WILD,        COMPOUND_STRING("Wild…{CLEAR_TO 110}{RIGHT_ARROW}")),
    DEBUG_ITEM(DEBUG_BATTLE_0_MENU_ITEM_WILD_DOUBLE, COMPOUND_STRING("Wild Double…{CLEAR_TO 110}{RIGHT_ARROW}")),
    DEBUG_ITEM(DEBUG_BATTLE_0_MENU_ITEM_SINGLE,      COMPOUND_STRING("Single…{CLEAR_TO 110}{RIGHT_ARROW}")),
    DEBUG_ITEM(DEBUG_BATTLE_0_MENU_ITEM_DOUBLE,      COMPOUND_STRING("Double…{CLEAR_TO 110}{RIGHT_ARROW}")),
    DEBUG_ITEM(DEBUG_BATTLE_0_MENU_ITEM_MULTI,       COMPOUND_STRING("Multi…{CLEAR_TO 110}{RIGHT_ARROW}")),
};

static const struct ListMenuItem sDebugMenu_Items_Battle_1[] =
{
    DEBUG_ITEM(DEBUG_BATTLE_1_MENU_ITEM_AI_FLAG_00, COMPOUND_STRING("{STR_VAR_1}Check bad move")),
    DEBUG_ITEM(DEBUG_BATTLE_1_MENU_ITEM_AI_FLAG_01, COMPOUND_STRING("{STR_VAR_1}Try to faint")),
    DEBUG_ITEM(DEBUG_BATTLE_1_MENU_ITEM_AI_FLAG_02, COMPOUND_STRING("{STR_VAR_1}Check viability")),
    DEBUG_ITEM(DEBUG_BATTLE_1_MENU_ITEM_AI_FLAG_03, COMPOUND_STRING("{STR_VAR_1}Setup first turn")),
    DEBUG_ITEM(DEBUG_BATTLE_1_MENU_ITEM_AI_FLAG_04, COMPOUND_STRING("{STR_VAR_1}Risky")),
    DEBUG_ITEM(DEBUG_BATTLE_1_MENU_ITEM_AI_FLAG_05, COMPOUND_STRING("{STR_VAR_1}Prefer strongest move")),
    DEBUG_ITEM(DEBUG_BATTLE_1_MENU_ITEM_AI_FLAG_06, COMPOUND_STRING("{STR_VAR_1}Prefer Baton Pass")),
    DEBUG_ITEM(DEBUG_BATTLE_1_MENU_ITEM_AI_FLAG_07, COMPOUND_STRING("{STR_VAR_1}Double battle")),
    DEBUG_ITEM(DEBUG_BATTLE_1_MENU_ITEM_AI_FLAG_08, COMPOUND_STRING("{STR_VAR_1}HP aware")),
    DEBUG_ITEM(DEBUG_BATTLE_1_MENU_ITEM_AI_FLAG_09, COMPOUND_STRING("{STR_VAR_1}Negate Unaware")),
    DEBUG_ITEM(DEBUG_BATTLE_1_MENU_ITEM_AI_FLAG_10, COMPOUND_STRING("{STR_VAR_1}Will suicide")),
    DEBUG_ITEM(DEBUG_BATTLE_1_MENU_ITEM_AI_FLAG_11, COMPOUND_STRING("{STR_VAR_1}Help partner")),
    DEBUG_ITEM(DEBUG_BATTLE_1_MENU_ITEM_AI_FLAG_12, COMPOUND_STRING("{STR_VAR_1}Prefer status moves")),
    DEBUG_ITEM(DEBUG_BATTLE_1_MENU_ITEM_AI_FLAG_13, COMPOUND_STRING("{STR_VAR_1}Stall")),
    DEBUG_ITEM(DEBUG_BATTLE_1_MENU_ITEM_AI_FLAG_14, COMPOUND_STRING("{STR_VAR_1}Screener")),
    DEBUG_ITEM(DEBUG_BATTLE_1_MENU_ITEM_AI_FLAG_15, COMPOUND_STRING("{STR_VAR_1}Smart switching")),
    DEBUG_ITEM(DEBUG_BATTLE_1_MENU_ITEM_AI_FLAG_16, COMPOUND_STRING("{STR_VAR_1}Ace pokemon")),
    DEBUG_ITEM(DEBUG_BATTLE_1_MENU_ITEM_AI_FLAG_17, COMPOUND_STRING("{STR_VAR_1}Omniscient")),
    DEBUG_ITEM(DEBUG_BATTLE_1_MENU_ITEM_CONTINUE,   sDebugText_Continue),
};

static const struct ListMenuItem sDebugMenu_Items_Battle_2[] =
{
    DEBUG_ITEM(DEBUG_BATTLE_2_MENU_ITEM_TERRAIN_0, COMPOUND_STRING("Grass…{CLEAR_TO 110}{RIGHT_ARROW}")),
    DEBUG_ITEM(DEBUG_BATTLE_2_MENU_ITEM_TERRAIN_1, COMPOUND_STRING("Long grass…{CLEAR_TO 110}{RIGHT_ARROW}")),
    DEBUG_ITEM(DEBUG_BATTLE_2_MENU_ITEM_TERRAIN_2, COMPOUND_STRING("Sand…{CLEAR_TO 110}{RIGHT_ARROW}")),
    DEBUG_ITEM(DEBUG_BATTLE_2_MENU_ITEM_TERRAIN_3, COMPOUND_STRING("Underwater…{CLEAR_TO 110}{RIGHT_ARROW}")),
    DEBUG_ITEM(DEBUG_BATTLE_2_MENU_ITEM_TERRAIN_4, COMPOUND_STRING("Water…{CLEAR_TO 110}{RIGHT_ARROW}")),
    DEBUG_ITEM(DEBUG_BATTLE_2_MENU_ITEM_TERRAIN_5, COMPOUND_STRING("Pond…{CLEAR_TO 110}{RIGHT_ARROW}")),
    DEBUG_ITEM(DEBUG_BATTLE_2_MENU_ITEM_TERRAIN_6, COMPOUND_STRING("Mountain…{CLEAR_TO 110}{RIGHT_ARROW}")),
    DEBUG_ITEM(DEBUG_BATTLE_2_MENU_ITEM_TERRAIN_7, COMPOUND_STRING("Cave…{CLEAR_TO 110}{RIGHT_ARROW}")),
    DEBUG_ITEM(DEBUG_BATTLE_2_MENU_ITEM_TERRAIN_8, COMPOUND_STRING("Building…{CLEAR_TO 110}{RIGHT_ARROW}")),
    DEBUG_ITEM(DEBUG_BATTLE_2_MENU_ITEM_TERRAIN_9, COMPOUND_STRING("Plain…{CLEAR_TO 110}{RIGHT_ARROW}")),
};

static const struct ListMenuItem sDebugMenu_Items_Give[] =
{
    DEBUG_ITEM(DEBUG_GIVE_MENU_ITEM_ITEM_X,            COMPOUND_STRING("Give item XYZ…{CLEAR_TO 110}{RIGHT_ARROW}")),
    DEBUG_ITEM(DEBUG_GIVE_MENU_ITEM_POKEMON_SIMPLE,    COMPOUND_STRING("Pokémon (Basic){CLEAR_TO 110}{RIGHT_ARROW}")),
    DEBUG_ITEM(DEBUG_GIVE_MENU_ITEM_POKEMON_COMPLEX,   COMPOUND_STRING("Pokémon (Complex){CLEAR_TO 110}{RIGHT_ARROW}")),
    DEBUG_ITEM(DEBUG_GIVE_MENU_ITEM_MAX_MONEY,         COMPOUND_STRING("Max Money")),
    DEBUG_ITEM(DEBUG_GIVE_MENU_ITEM_MAX_COINS,         COMPOUND_STRING("Max Coins")),
    DEBUG_ITEM(DEBUG_GIVE_MENU_ITEM_MAX_BATTLE_POINTS, COMPOUND_STRING("Max Battle Points")),
    DEBUG_ITEM(DEBUG_GIVE_MENU_ITEM_DAYCARE_EGG,       COMPOUND_STRING("Daycare Egg")),
};

static const struct ListMenuItem sDebugMenu_Items_Sound[] =
{
    DEBUG_ITEM(DEBUG_SOUND_MENU_ITEM_SE,  COMPOUND_STRING("SFX…{CLEAR_TO 110}{RIGHT_ARROW}")),
    DEBUG_ITEM(DEBUG_SOUND_MENU_ITEM_MUS, COMPOUND_STRING("Music…{CLEAR_TO 110}{RIGHT_ARROW}")),
};

static const struct ListMenuItem sDebugMenu_Items_BerryFunctions[] =
{
    DEBUG_ITEM(DEBUG_BERRY_FUNCTIONS_MENU_CLEAR_ALL,  COMPOUND_STRING("Clear map trees")),
    DEBUG_ITEM(DEBUG_BERRY_FUNCTIONS_MENU_READY,      COMPOUND_STRING("Ready map trees")),
    DEBUG_ITEM(DEBUG_BERRY_FUNCTIONS_MENU_NEXT_STAGE, COMPOUND_STRING("Grow map trees")),
    DEBUG_ITEM(DEBUG_BERRY_FUNCTIONS_MENU_PESTS,      COMPOUND_STRING("Give map trees pests")),
    DEBUG_ITEM(DEBUG_BERRY_FUNCTIONS_MENU_WEEDS,      COMPOUND_STRING("Give map trees weeds")),
};
