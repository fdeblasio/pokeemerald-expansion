...
const struct Berry gBerries[] =
{
    [ITEM_CHERI_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .size = 20,
        .maxYield = YIELD_RATE(6, 6, 15, 20),
        .minYield= YIELD_RATE(3, 3, 4, 4),
    ...
    [ITEM_POMEG_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .color = BERRY_COLOR_RED,
        .size = 135,
        .maxYield = YIELD_RATE(12, 12, 20, 26),
        .minYield= YIELD_RATE(3, 3, 3, 3),
