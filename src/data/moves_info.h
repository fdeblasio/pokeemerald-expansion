...
// Stat change effects
#define MOVE_STAT_HP  0
#define MOVE_STAT_ATK 1
#define MOVE_STAT_DEF 2
#define MOVE_STAT_SPA 3
...
#define STAT_CHANGE_2 .defense
#define STAT_CHANGE_3 .spAtk
...
#define EFFECT_MOVE_INFO(Effect, Chance)      \
    .effect = EFFECT_HIT,                     \
    .accuracy = 100,                          \
    .priority = 0,                            \
...
#define STAT_CHANGE_MOVE_INFO(Effect, Stat, Change, Chance) \
    .effect = EFFECT_HIT,                                   \
    .accuracy = 100,                                        \
    .priority = 0,                                          \
    .additionalEffects = ADDITIONAL_EFFECTS({               \
...
#define LOWER_STAT_1_INFO(Stat) \
    STAT_CHANGE_MOVE_INFO(MOVE_EFFECT_STAT_MINUS, Stat, 1, 100)

#define LOWER_STAT_1(Stat)                    \
    .additionalEffects = ADDITIONAL_EFFECTS({ \
...
#define HIGH_CRITICAL_INFO                  \
    .effect = EFFECT_HIT,                   \
    .criticalHitStage = INCREASED_CRITICAL, \
    .priority = 0

#define ABSORBING_MOVES_INFO(Percentage)         \
    .effect = EFFECT_HIT,                        \
    .additionalEffects = ADDITIONAL_EFFECTS({    \
        .moveEffect = MOVE_EFFECT_ABSORB,        \
        .argument.absorbPercentage = Percentage, \
    }),                                          \
...
// 35
#define TRAPPING_35_POWER_MOVE(Message)                  \
    TRAPPING_MOVE(Message),                              \
...
#define SPEED_UP_50_POWER_INFO   \
    ...
    .power = 50,                 \
    .pp = 20,                    \
    RAISE_STAT_1(MOVE_STAT_SPE), \
    .contestEffect = CONTEST_EFFECT_BETTER_WITH_GOOD_CONDITION

#define LOWER_STAT_50_POWER_INFO(Stat)               \
    LOWER_STAT_1_INFO(Stat),                         \
    .power = B_UPDATED_MOVE_DATA >= GEN_6 ? 50 : 30, \
    .pp = 20

#define MULTISTRIKE_INFO(OldContestEffect) \
    BASIC_MOVE,                            \
    .power = 25,                           \
    .pp = 20,                              \
    .multiHit = TRUE,                      \
    .contestEffect = C_UPDATED_MOVE_EFFECTS >= GEN_6 ? CONTEST_EFFECT_QUALITY_DEPENDS_ON_TIMING : OldContestEffect
...
#define EFFECT_60_POWER_INFO(Effect)          \
    EFFECT_MOVE_INFO(Effect, 30),             \
    .power = 60,                              \
    .pp = 25,                                 \
    .target = TARGET_SELECTED,                \
...
#define HIGH_CRIT_HIT_BOTH_60_POWER_INFO             \
    HIGH_CRITICAL_INFO,                              \
...
#define SWITCH_TARGET_60_POWER_INFO     \
...
#define DOUBLE_POWER_IF_LAST_INFO       \
    .description = COMPOUND_STRING(     \
...
#define EAT_BERRY_60_POWER_INFO               \
    .description = COMPOUND_STRING(           \
...
// 65
#define BASIC_65_POWER_INFO \
    BASIC_MOVE,             \
    .power = 65,            \
    .pp = 30,               \
    .contestEffect = CONTEST_EFFECT_HIGHLY_APPEALING

#define EFFECT_65_POWER_INFO(Effect)          \
    EFFECT_MOVE_INFO(Effect, 30),             \
    .power = 65,                              \
    .pp = 20,                                 \
    .target = TARGET_SELECTED,                \
...
#define BEAM_EFFECT_65_POWER_INFO(Effect) \
    BEAM_65_POWER_INFO,                   \
    EFFECT_MOVE_INFO(Effect, 10)

#define BEAM_STAT_65_POWER_INFO(Stat) \
    BEAM_65_POWER_INFO,               \
    STAT_CHANGE_MOVE_INFO(MOVE_EFFECT_STAT_MINUS, Stat, 1, 10)
...
#define LOWER_ACCURACY_65_POWER                                          \
    STAT_CHANGE_MOVE_INFO(MOVE_EFFECT_STAT_MINUS, MOVE_STAT_ACC, 1, 30), \
    .power = 65,                                                         \
    .pp = 10,                                                            \
    .target = TARGET_SELECTED,                                           \
...
// 75
#define ELEMENTAL_PUNCH_INFO(MoveEffect)              \
    EFFECT_MOVE_INFO(MoveEffect, 10),                 \
    .power = 75,                                      \
    .pp = 15,                                         \
    .target = TARGET_SELECTED,                        \
    .category = DAMAGE_CATEGORY_PHYSICAL,             \
...
#define LOWER_DEFENSE_75_POWER_INFO                                      \
    STAT_CHANGE_MOVE_INFO(MOVE_EFFECT_STAT_MINUS, MOVE_STAT_DEF, 1, 50), \
    .power = 75,                                                         \
    .pp = 10,                                                            \
    .target = TARGET_SELECTED,                                           \
    .category = DAMAGE_CATEGORY_PHYSICAL,                                \
...
#define DOUBLE_IF_FAILED_75_POWER_INFO \
...
#define SEMI_INVULNERABLE_80_POWER_INFO(StringId, State)                                    \
    SEMI_INVULNERABLE_INFO(StringId, State),                                                \
    .power = B_UPDATED_MOVE_DATA >= GEN_4 ? 80 : (B_UPDATED_MOVE_DATA >= GEN_2 ? 60 : 100), \
    .accuracy = 100,                                                                        \
    .pp = 10,                                                                               \
...
#define LOWER_STAT_CHANCE_80_POWER_INFO(Stat)                   \
    STAT_CHANGE_MOVE_INFO(MOVE_EFFECT_STAT_MINUS, Stat, 1, 20), \
    .power = 80,                                                \
    .pp = 15,                                                   \
    .target = TARGET_SELECTED,                                  \
    .validApprenticeMove = TRUE
...
// 85
#define BREAK_SCREEN_85_POWER_INFO              \
    BASIC_MOVE,                                 \
    .power = 85,                                \
    .pp = 15,                                   \
    .additionalEffects = ADDITIONAL_EFFECTS({   \
...
#define LOWER_DEFENSE_85_POWER_INFO                                      \
    STAT_CHANGE_MOVE_INFO(MOVE_EFFECT_STAT_MINUS, MOVE_STAT_DEF, 1, 20), \
    .power = 85,                                                         \
    .pp = 10,                                                            \
    .target = TARGET_SELECTED,                                           \
    .contestEffect = CONTEST_EFFECT_SHIFT_JUDGE_ATTENTION

#define ALWAYS_HIT_85_POWER_INFO \
    ALWAYS_HIT_INFO,             \
    .power = 85,                 \
    .pp = 10,                    \
    .target = TARGET_SELECTED,   \
...
#define LOWER_SPECIAL_DEFENSE_90_POWER_INFO                                                          \
    STAT_CHANGE_MOVE_INFO(MOVE_EFFECT_STAT_MINUS, MOVE_STAT_SPD, 1, B_UPDATED_MOVE_DATA >= GEN_2 ? 10 : 33), \
    .power = 90,                                                                                     \
    .pp = 10,                                                                                        \
    .target = TARGET_SELECTED,                                                                       \
    .validApprenticeMove = TRUE
...
#define LOWER_STAT_90_POWER_INFO(Stat) \
    LOWER_STAT_1_INFO(Stat),           \
    .power = 90,                       \
    .pp = 15,                          \
    .target = TARGET_SELECTED,         \
...
#define RECOIL_IF_MISS_100_POWER_INFO                          \
    .effect = EFFECT_RECOIL_IF_MISS,                           \
    .power = B_UPDATED_MOVE_DATA >= GEN_5 ? 100 : (B_UPDATED_MOVE_DATA == GEN_4 ? 85 : 70), \
    .accuracy = 95,                                            \
...
#define HIGH_CRITICAL_INACCURATE_100_POWER_INFO              \
    HIGH_CRITICAL_100_POWER_INFO,                            \
    .accuracy = 80,                                          \
    .pp = 5,                                                 \
...
#define LOWER_OWN_SPEED_100_POWER_INFO         \
    .effect = EFFECT_HIT,                      \
    .power = 100,                              \
    .accuracy = 90,                            \
    .pp = 10,                                  \
...
#define IGNORE_ABILITIES_100_POWER_INFO               \
    BASIC_MOVE,                                       \
    .power = 100,                                     \
    .pp = 10,                                         \
...
#define DYNAMAX_DOUBLE_DAMAGE_INFO             \
...
#define BOOSTED_SUPER_EFFECTIVE_INFO   \
...
// 120
#define HIT_TWICE_120_TOTAL_POWER_INFO \
    HIT_TWICE_INFO,                    \
    .power = 60,                       \
    .pp = 15
...
#define STATUS_HIT_120_POWER_INFO(Status)     \
    .effect = EFFECT_HIT,                     \
    .power = 120,                             \
    .accuracy = 50,                           \
    .pp = 5,                                  \
...
#define LOWER_USER_TWO_STATS_120_POWER_INFO(Stat1, Stat2)      \
    BASIC_MOVE,                                                \
    .power = 120,                                              \
    .pp = 5,                                                   \
    .additionalEffects = ADDITIONAL_EFFECTS({                  \
...
#define TYPE_CHANGE_ON_ITEM_120_POWER_INFO(HoldEffect) \
    .effect = EFFECT_CHANGE_TYPE_ON_ITEM,              \
    .power = B_UPDATED_MOVE_DATA >= GEN_6 ? 120 : 90,  \
    .accuracy = 100,                                   \
    .pp = 10,                                          \
    .target = TARGET_SELECTED,                         \
    .priority = 0,                                     \
    .argument = { .holdEffect = HoldEffect },          \
    .contestEffect = CONTEST_EFFECT_BETTER_WITH_GOOD_CONDITION

#define LEGENDARY_SIGNATURE_HIT_BOTH_120_POWER_INFO \
    .effect = EFFECT_HIT,                           \
    .power = 120,                                   \
    .accuracy = 100,                                \
    .pp = 10,                                       \
...
#define GENIE_STORM_INFO                              \
    LEGENDARY_SIGNATURE_HIT_BOTH_120_POWER_INFO,      \
    .category = DAMAGE_CATEGORY_SPECIAL,              \
    .windMove = TRUE,                                 \
    .alwaysHitsInRain = TRUE

#define GENIE_STORM_STATUS_INFO(Status)       \
    GENIE_STORM_INFO,                         \
    .additionalEffects = ADDITIONAL_EFFECTS({ \
        .moveEffect = Status,                 \
        .chance = 30,                         \
...
#define GENIE_STORM_STAT_LOWER_INFO(Stat)     \
    GENIE_STORM_INFO,                         \
    .additionalEffects = ADDITIONAL_EFFECTS({ \
        .moveEffect = MOVE_EFFECT_STAT_MINUS, \
        STAT_CHANGE(Stat) = 1,                \
...
#define METRONOME_BANNED_HIT_BOTH_LEGENDARY_SIGNATURE_120_POWER_INFO \
    LEGENDARY_SIGNATURE_HIT_BOTH_120_POWER_INFO,                     \
    .metronomeBanned = TRUE
...
#define LOWER_SPECIAL_ATTACK_130_POWER_INFO            \
    LOWER_SPECIAL_ATTACK_INFO,                         \
    .power = B_UPDATED_MOVE_DATA >= GEN_6 ? 130 : 140, \
    .accuracy = 90,                                    \
    .pp = 5

#define LOWER_SPECIAL_ATTACK_LEGENDARY_INFO \
    LOWER_SPECIAL_ATTACK_INFO,              \
    .power = 140,                           \
    .accuracy = 100,                        \
    .pp = 10

#define TWO_TURN_ATTACK_140_POWER_INFO(StringId, MoveEffect) \
    TWO_TURN_ATTACK_INFO(StringId),                          \
    .power = 140,                                            \
    .accuracy = 100,                                         \
    .pp = 10,                                                \
    .target = TARGET_SELECTED,                               \
...
#define RECHARGE_150_POWER_INFO \
    RECHARGE_INFO,              \
    .power = 150,               \
    .accuracy = 90,             \
    .pp = 5

#define RECHARGE_LEGENDARY_INFO \
    RECHARGE_INFO,              \
    .power = 160,               \
    .accuracy = 100,            \
    .pp = 10

#define POWER_BASED_ON_HP_150_POWER_INFO        \
...
#define SWITCH_TARGET_INFO                              \
    ...
    .pp = 20,                                           \
    .target = TARGET_SELECTED,                          \
    .priority = B_UPDATED_MOVE_DATA >= GEN_3 ? -6 : -1, \
    .category = DAMAGE_CATEGORY_STATUS,                 \
...
#define TERRAIN_MOVE_INFO(Terrain)                                \
    ...
    .priority = 0,                                                \
    .category = DAMAGE_CATEGORY_STATUS,                           \
    .argument = { .terrainType = B_TERRAIN_##Terrain },           \
    .ignoresProtect = TRUE,                                       \
    .mirrorMoveBanned = TRUE,                                     \
    .skyBattleBanned = TRUE,                                      \
...
const struct MoveInfo gMovesInfo[MOVES_COUNT_ALL] =
{
    ...
    [MOVE_DOUBLE_SLAP] =
    {
        ...
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .makesContact = TRUE,
        .contestEffect = C_UPDATED_MOVE_EFFECTS >= GEN_6 ? CONTEST_EFFECT_STARTLE_MONS_SAME_TYPE_APPEAL : CONTEST_EFFECT_STARTLE_MON_WITH_JUDGES_ATTENTION,
    ...
    [MOVE_COMET_PUNCH] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "2 to 5 times."),
        MULTISTRIKE_INFO(CONTEST_EFFECT_BETTER_IF_SAME_TYPE),
        .type = TYPE_NORMAL,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .makesContact = TRUE,
        .punchingMove = TRUE,
    ...
    [MOVE_MEGA_PUNCH] =
    {
        ...
        .contestCategory = CONTEST_CATEGORY_TOUGH,
        .contestComboStarterId = 0,
        .contestComboMoves = {COMBO_STARTER_FOCUS_ENERGY, ALWAYS_HIT_COMBOS},
    ...
    [MOVE_FIRE_PUNCH] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "the foe."),
        ELEMENTAL_PUNCH_INFO(MOVE_EFFECT_BURN),
        .type = TYPE_FIRE,
    ...
    [MOVE_ICE_PUNCH] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "freeze the foe."),
        #endif
        ELEMENTAL_PUNCH_INFO(MOVE_EFFECT_FREEZE_OR_FROSTBITE),
        .type = TYPE_ICE,
        .contestCategory = CONTEST_CATEGORY_BEAUTY,
    ...
    [MOVE_THUNDER_PUNCH] =
    {
        ...
        ELEMENTAL_PUNCH_INFO(MOVE_EFFECT_PARALYSIS),
        .type = TYPE_ELECTRIC,
    ...
    [MOVE_RAZOR_WIND] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "high critical-hit ratio."),
        #endif
        TWO_TURN_ATTACK_INFO(STRINGID_PKMNWHIPPEDWHIRLWIND),
        .power = 80,
        .type = TYPE_NORMAL,
    ...
    [MOVE_WHIRLWIND] =
    {
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {ENTRY_HAZARD_COMBOS},
    ...
    [MOVE_FLY] =
    {
        ...
        SEMI_INVULNERABLE_INFO(STRINGID_PKMNFLEWHIGH, STATE_ON_AIR),
        .power = B_UPDATED_MOVE_DATA >= GEN_4 ? 90 : 70,
        .type = TYPE_FLYING,
        .accuracy = 100,
        .pp = 15,
    ...
    [MOVE_BIND] =
    {
        ...
        TRAPPING_35_POWER_MOVE(B_MSG_WRAPPED_BIND),
        .type = TYPE_NORMAL,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .makesContact = TRUE,
        .contestCategory = CONTEST_CATEGORY_TOUGH,
    ...
    [MOVE_VINE_WHIP] =
    {
        ...
        .contestCategory = CONTEST_CATEGORY_COOL,
        .contestComboStarterId = 0,
        .contestComboMoves = {GRASS_COMBOS},
    ...
    [MOVE_JUMP_KICK] =
    {
        ...
        .contestCategory = CONTEST_CATEGORY_COOL,
        .contestComboStarterId = 0,
        .contestComboMoves = {ALWAYS_HIT_COMBOS},
    ...
    [MOVE_HEADBUTT] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "cause flinching."),
        EFFECT_70_POWER_INFO(MOVE_EFFECT_FLINCH),
        .type = TYPE_NORMAL,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .makesContact = TRUE,
        .contestCategory = CONTEST_CATEGORY_TOUGH,
    ...
    [MOVE_FURY_ATTACK] =
    {
        ...
        MULTISTRIKE_INFO(CONTEST_EFFECT_STARTLE_MON_WITH_JUDGES_ATTENTION),
        .type = TYPE_NORMAL,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .makesContact = TRUE,
        .contestCategory = CONTEST_CATEGORY_COOL,
    ...
    [MOVE_WRAP] =
    {
        ...
        TRAPPING_35_POWER_MOVE(B_MSG_WRAPPED_WRAP),
        .type = TYPE_NORMAL,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .makesContact = TRUE,
        NO_COMBO(CONTEST_CATEGORY_TOUGH),
    ...
    [MOVE_POISON_STING] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "etc., that may poison."),
        EFFECT_30_POWER_INFO(MOVE_EFFECT_POISON),
        .type = TYPE_POISON,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .contestEffect = CONTEST_EFFECT_STARTLE_PREV_MON,
        NO_COMBO(CONTEST_CATEGORY_SMART),
    ...
    [MOVE_ROAR] =
    {
        ...
        .contestCategory = CONTEST_CATEGORY_COOL,
        .contestComboStarterId = 0,
        .contestComboMoves = {COMBO_STARTER_ENTRAINMENT, COMBO_STARTER_PLAY_NICE, ENTRY_HAZARD_COMBOS},
    ...
    [MOVE_ACID] =
    {
      ...
      #if B_UPDATED_MOVE_DATA >= GEN_4
            "May lower Sp. Def."),
            EFFECT_40_POWER_STAT_INFO(MOVE_STAT_SPD),
        #else
            "May lower Defense."),
            EFFECT_40_POWER_STAT_INFO(MOVE_STAT_DEF),
        #endif
        .type = TYPE_POISON,
        .target = TARGET_BOTH,
        .category = DAMAGE_CATEGORY_SPECIAL,
    ...
    [MOVE_EMBER] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "inflict a burn."),
        EFFECT_40_POWER_EFFECT_INFO(MOVE_EFFECT_BURN),
        .type = TYPE_FIRE,
        .target = TARGET_SELECTED,
        .category = DAMAGE_CATEGORY_SPECIAL,
    ...
    [MOVE_FLAMETHROWER] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "may inflict a burn."),
        STATUS_90_POWER_INFO(MOVE_EFFECT_BURN),
        .type = TYPE_FIRE,
        .category = DAMAGE_CATEGORY_SPECIAL,
        .contestEffect = CONTEST_EFFECT_HIGHLY_APPEALING,
        .contestCategory = CONTEST_CATEGORY_BEAUTY,
    ...
    [MOVE_ICE_BEAM] =
    {
        ...
        #endif
        STATUS_90_POWER_INFO(MOVE_EFFECT_FREEZE_OR_FROSTBITE), // Also relevant in battle_pike.c. If you cherry-pick this to use something other than the config, make sure to update it there too
        .type = TYPE_ICE,
        .category = DAMAGE_CATEGORY_SPECIAL,
        .beamMove = TRUE,
    ...
    [MOVE_PSYBEAM] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "may confuse the foe."),
        BEAM_EFFECT_65_POWER_INFO(MOVE_EFFECT_CONFUSION),
        .type = TYPE_PSYCHIC,
        .category = DAMAGE_CATEGORY_SPECIAL,
        .contestEffect = C_UPDATED_MOVE_EFFECTS >= GEN_6 ? CONTEST_EFFECT_SHIFT_JUDGE_ATTENTION : CONTEST_EFFECT_SCRAMBLE_NEXT_TURN_ORDER,
        .contestCategory = CONTEST_CATEGORY_BEAUTY,
        .contestComboStarterId = 0,
        .contestComboMoves = {SPECIAL_PSYCHIC_COMBOS},
    ...
    [MOVE_BUBBLE_BEAM] =
    {
        ...
        BEAM_STAT_65_POWER_INFO(MOVE_STAT_SPE),
        .type = TYPE_WATER,
        .category = DAMAGE_CATEGORY_SPECIAL,
        .contestEffect = C_UPDATED_MOVE_EFFECTS >= GEN_6 ? CONTEST_EFFECT_STARTLE_PREV_MON : CONTEST_EFFECT_BADLY_STARTLE_PREV_MONS,
        .contestCategory = CONTEST_CATEGORY_BEAUTY,
    ...
    [MOVE_AURORA_BEAM] =
    {
        ...
        BEAM_STAT_65_POWER_INFO(MOVE_STAT_ATK),
        .type = TYPE_ICE,
        .category = DAMAGE_CATEGORY_SPECIAL,
    ...
    [MOVE_COUNTER] =
    {
        ...
        REFLECT_DOUBLE_DAMAGE_INFO(DAMAGE_CATEGORY_PHYSICAL),
        .type = TYPE_FIGHTING,
        .makesContact = TRUE,
        .copycatBanned = TRUE,
        .contestCategory = CONTEST_CATEGORY_TOUGH,
    ...
    [MOVE_RAZOR_LEAF] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "High critical-hit ratio."),
        HIGH_CRIT_HIT_BOTH_60_POWER_INFO,
        .type = TYPE_GRASS,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .slicingMove = TRUE,
        .contestEffect = C_UPDATED_MOVE_EFFECTS >= GEN_6 ? CONTEST_EFFECT_HIGHLY_APPEALING : CONTEST_EFFECT_AFFECTED_BY_PREV_APPEAL,
    ...
    [MOVE_SOLAR_BEAM] =
    {
        ...
        .contestCategory = CONTEST_CATEGORY_COOL,
        .contestComboStarterId = 0,
        .contestComboMoves = {GRASS_COMBOS, COMBO_STARTER_SUNNY_DAY},
    ...
    [MOVE_STUN_SPORE] =
    {
        ...
        .contestEffect = CONTEST_EFFECT_BADLY_STARTLE_MONS_WITH_GOOD_APPEALS,
        .contestCategory = CONTEST_CATEGORY_SMART,
        .contestComboStarterId = COMBO_STARTER_STUN_SPORE,
    ...
    [MOVE_FIRE_SPIN] =
    {
        ...
        TRAPPING_35_POWER_MOVE(B_MSG_WRAPPED_FIRE_SPIN),
        .type = TYPE_FIRE,
        .category = DAMAGE_CATEGORY_SPECIAL,
        .contestCategory = CONTEST_CATEGORY_BEAUTY,
        .contestComboStarterId = 0,
    ...
    [MOVE_THUNDER_SHOCK] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "may paralyze the foe."),
        EFFECT_40_POWER_EFFECT_INFO(MOVE_EFFECT_PARALYSIS),
        .type = TYPE_ELECTRIC,
        .target = TARGET_SELECTED,
        .contestCategory = CONTEST_CATEGORY_COOL,
        .contestComboStarterId = 0,
    ...
    [MOVE_THUNDERBOLT] =
    {
        ...
        STATUS_90_POWER_INFO(MOVE_EFFECT_PARALYSIS),
        .type = TYPE_ELECTRIC,
        .category = DAMAGE_CATEGORY_SPECIAL,
        .contestEffect = CONTEST_EFFECT_HIGHLY_APPEALING,
        .contestCategory = CONTEST_CATEGORY_COOL,
    ...
    [MOVE_DIG] =
    {
        ...
        SEMI_INVULNERABLE_80_POWER_INFO(STRINGID_PKMNDUGHOLE, STATE_UNDERGROUND),
        .type = TYPE_GROUND,
        .contestEffect = C_UPDATED_MOVE_EFFECTS >= GEN_6 ? CONTEST_EFFECT_AVOID_STARTLE_ONCE : CONTEST_EFFECT_AVOID_STARTLE,
    ...
    [MOVE_CONFUSION] =
    {
        ...
        .contestComboMoves = {SPECIAL_PSYCHIC_COMBOS, COMBO_STARTER_KINESIS, COMBO_STARTER_PSYCHIC},
    ...
    [MOVE_PSYCHIC] =
    {
        ...
        LOWER_SPECIAL_DEFENSE_90_POWER_INFO,
        .type = TYPE_PSYCHIC,
        .category = DAMAGE_CATEGORY_SPECIAL,
        .contestEffect = C_UPDATED_MOVE_EFFECTS >= GEN_6 ? CONTEST_EFFECT_HIGHLY_APPEALING : CONTEST_EFFECT_BADLY_STARTLE_PREV_MONS,
        .contestCategory = CONTEST_CATEGORY_SMART,
        .contestComboStarterId = COMBO_STARTER_PSYCHIC,
        .contestComboMoves = {SPECIAL_PSYCHIC_COMBOS, COMBO_STARTER_CONFUSION, COMBO_STARTER_KINESIS},
    ...
    [MOVE_SELF_DESTRUCT] =
    {
        ...
        .contestCategory = CONTEST_CATEGORY_BEAUTY,
        .contestComboStarterId = 0,
        .contestComboMoves = {TRAPPING_COMBOS},
    ...
    [MOVE_LICK] =
    {
        ...
        EFFECT_30_POWER_INFO(MOVE_EFFECT_PARALYSIS),
        .type = TYPE_GHOST,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .makesContact = TRUE,
        .contestEffect = C_UPDATED_MOVE_EFFECTS >= GEN_6 ? CONTEST_EFFECT_STARTLE_PREV_MON : CONTEST_EFFECT_BADLY_STARTLE_FRONT_MON,
    ...
    [MOVE_SLUDGE] =
    {
        ...
        EFFECT_65_POWER_INFO(MOVE_EFFECT_POISON),
        .type = TYPE_POISON,
        .category = DAMAGE_CATEGORY_SPECIAL,
        .contestEffect = C_UPDATED_MOVE_EFFECTS >= GEN_6 ? CONTEST_EFFECT_STARTLE_PREV_MON : CONTEST_EFFECT_BADLY_STARTLE_FRONT_MON,
        .contestCategory = CONTEST_CATEGORY_TOUGH,
    ...
    [MOVE_CLAMP] =
    {
        ...
        TRAPPING_35_POWER_MOVE(B_MSG_WRAPPED_CLAMP),
        .type = TYPE_WATER,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .makesContact = TRUE,
        .contestCategory = CONTEST_CATEGORY_TOUGH,
    ...
    #endif
        TWO_TURN_ATTACK_INFO(STRINGID_PKMNLOWEREDHEAD),
    ...
    [MOVE_CONSTRICT] =
    {
        ...
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_STAT_MINUS,
            .speed = 1,
            .chance = B_UPDATED_MOVE_DATA >= GEN_2 ? 20 : 33,
        }),
    ...
    [MOVE_DREAM_EATER] =
    {
        ...
        .contestCategory = CONTEST_CATEGORY_SMART,
        .contestComboStarterId = 0,
        .contestComboMoves = {SPECIAL_PSYCHIC_COMBOS, SLEEP_COMBOS},
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_ABSORB,
    ...
    [MOVE_SKY_ATTACK] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "then strikes the next turn."),
    #endif
        TWO_TURN_ATTACK_140_POWER_INFO(STRINGID_CLOAKEDINAHARSHLIGHT, MOVE_EFFECT_FLINCH),
        .type = TYPE_FLYING,
        .category = DAMAGE_CATEGORY_PHYSICAL,
    ...
    [MOVE_BUBBLE] =
    {
        ...
        EFFECT_40_POWER_STAT_INFO(MOVE_STAT_SPE),
        .type = TYPE_WATER,
        .target = TARGET_BOTH,
        .category = DAMAGE_CATEGORY_SPECIAL,
        .contestCategory = CONTEST_CATEGORY_CUTE,
    ...
    [MOVE_DIZZY_PUNCH] =
    {
        ...
        NO_COMBO(C_UPDATED_MOVE_CATEGORIES >= GEN_6 ? CONTEST_CATEGORY_CUTE : CONTEST_CATEGORY_COOL),
    ...
    [MOVE_SLASH] =
    {
        ...
        HIGH_CRITICAL_SLICING_70_POWER_INFO,
        .type = TYPE_NORMAL,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .makesContact = TRUE,
        .contestEffect = C_UPDATED_MOVE_EFFECTS >= GEN_6 ? CONTEST_EFFECT_HIGHLY_APPEALING : CONTEST_EFFECT_AFFECTED_BY_PREV_APPEAL,
    ...
    [MOVE_NIGHTMARE] =
    {
        ...
        .contestCategory = CONTEST_CATEGORY_SMART,
        .contestComboStarterId = 0,
        .contestComboMoves = {SLEEP_COMBOS},
    ...
    [MOVE_FLAME_WHEEL] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "may inflict a burn."),
        EFFECT_60_POWER_INFO(MOVE_EFFECT_BURN),
        .type = TYPE_FIRE,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .makesContact = TRUE,
        .thawsUser = TRUE,
    ...
    [MOVE_AEROBLAST] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "High critical-hit ratio."),
        HIGH_CRIT_LEGENDARY_SIGNATURE_INFO,
        .type = TYPE_FLYING,
        .category = DAMAGE_CATEGORY_SPECIAL,
        .windMove = TRUE,
    ...
    [MOVE_POWDER_SNOW] =
    {
        ...
        #endif
        EFFECT_40_POWER_EFFECT_INFO(MOVE_EFFECT_FREEZE_OR_FROSTBITE),
        .type = TYPE_ICE,
        .target = TARGET_BOTH,
        .category = DAMAGE_CATEGORY_SPECIAL,
        .contestCategory = CONTEST_CATEGORY_BEAUTY,
    ...
    [MOVE_ZAP_CANNON] =
    {
        ...
        STATUS_HIT_120_POWER_INFO(PARALYSIS),
        .type = TYPE_ELECTRIC,
        .category = DAMAGE_CATEGORY_SPECIAL,
        .ballisticMove = TRUE,
    ...
    [MOVE_DESTINY_BOND] =
    {
        ...
        .contestCategory = CONTEST_CATEGORY_SMART,
        .contestComboStarterId = 0,
        .contestComboMoves = {COMBO_STARTER_CURSE, COMBO_STARTER_ENDURE, TRAPPING_COMBOS, MOVE_TRAP_COMBOS},
    ...
    [MOVE_PERISH_SONG] =
    {
        ...
        .contestCategory = CONTEST_CATEGORY_BEAUTY,
        .contestComboStarterId = 0,
        .contestComboMoves = {TRAPPING_COMBOS, COMBO_STARTER_SING},
    ...
    [MOVE_ICY_WIND] =
    {
        ...
        LOWER_STAT_55_POWER_INFO(MOVE_STAT_SPE),
        .type = TYPE_ICE,
        .target = TARGET_BOTH,
        .category = DAMAGE_CATEGORY_SPECIAL,
        .windMove = TRUE,
    ...
    [MOVE_BONE_RUSH] =
    {
        ...
        MULTISTRIKE_INFO(CONTEST_EFFECT_HIGHLY_APPEALING),
        .type = TYPE_GROUND,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .contestCategory = CONTEST_CATEGORY_TOUGH,
    ...
    [MOVE_SPARK] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "may paralyze the foe."),
        EFFECT_65_POWER_INFO(MOVE_EFFECT_PARALYSIS),
        .type = TYPE_ELECTRIC,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .makesContact = TRUE,
        .contestEffect = C_UPDATED_MOVE_EFFECTS >= GEN_6 ? CONTEST_EFFECT_HIGHLY_APPEALING : CONTEST_EFFECT_BADLY_STARTLE_FRONT_MON,
    ...
    [MOVE_DYNAMIC_PUNCH] =
    {
        ...
        STATUS_HIT_120_POWER_INFO(CONFUSION),
        .type = TYPE_FIGHTING,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .makesContact = TRUE,
        .punchingMove = TRUE,
    ...
    [MOVE_DRAGON_BREATH] =
    {
        ...
        EFFECT_60_POWER_INFO(MOVE_EFFECT_PARALYSIS),
        .type = TYPE_DRAGON,
        .category = DAMAGE_CATEGORY_SPECIAL,
        .ignoresKingsRock = B_UPDATED_MOVE_FLAGS < GEN_3,
        .contestEffect = C_UPDATED_MOVE_EFFECTS >= GEN_6 ? CONTEST_EFFECT_STARTLE_PREV_MON : CONTEST_EFFECT_BADLY_STARTLE_PREV_MONS,
    ...
    [MOVE_VITAL_THROW] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "throw that never misses."),
        ALWAYS_HIT_70_POWER_INFO,
        .type = TYPE_FIGHTING,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .makesContact = TRUE,
        .contestCategory = CONTEST_CATEGORY_COOL,
    ...
    [MOVE_CROSS_CHOP] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "High critical-hit ratio."),
        HIGH_CRITICAL_INACCURATE_100_POWER_INFO,
        .type = TYPE_FIGHTING,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .makesContact = TRUE,
        .contestCategory = CONTEST_CATEGORY_COOL,
    ...
    [MOVE_CRUNCH] =
    {
        ...
        #if B_UPDATED_MOVE_DATA >= GEN_4
            "May lower Defense."),
            LOWER_STAT_CHANCE_80_POWER_INFO(MOVE_STAT_DEF),
        #else
            "May lower Sp. Def."),
            LOWER_STAT_CHANCE_80_POWER_INFO(MOVE_STAT_SPD),
        #endif
        .type = TYPE_DARK,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .makesContact = TRUE,
    ...
    [MOVE_MIRROR_COAT] =
    {
        ...
        REFLECT_DOUBLE_DAMAGE_INFO(DAMAGE_CATEGORY_SPECIAL),
        .type = TYPE_PSYCHIC,
    ...
    [MOVE_FUTURE_SIGHT] =
    {
        ...
        .contestCategory = CONTEST_CATEGORY_SMART,
        .contestComboStarterId = 0,
        .contestComboMoves = {SPECIAL_PSYCHIC_COMBOS, COMBO_STARTER_CONFUSION, COMBO_STARTER_KINESIS, COMBO_STARTER_PSYCHIC},
    ...
    [MOVE_WHIRLPOOL] =
    {
        ...
        TRAPPING_35_POWER_MOVE(B_MSG_WRAPPED_WHIRLPOOL),
        .type = TYPE_WATER,
        .category = DAMAGE_CATEGORY_SPECIAL,
        .damagesUnderwater = TRUE,
        .contestCategory = CONTEST_CATEGORY_BEAUTY,
    ...
    [MOVE_SMELLING_SALTS] =
    {
        ...
        DOUBLE_AND_REMOVE_ON_STATUS_70_POWER(STATUS1_PARALYSIS),
        .type = TYPE_NORMAL,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .makesContact = TRUE,
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {PARALYZE_COMBOS},
    ...
    [MOVE_SUPERPOWER] =
    {
        ...
        LOWER_USER_TWO_STATS_120_POWER_INFO(MOVE_STAT_ATK, MOVE_STAT_DEF),
        .type = TYPE_FIGHTING,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .makesContact = TRUE,
        .contestCategory = CONTEST_CATEGORY_TOUGH,
    ...
    [MOVE_ERUPTION] =
    {
        ...
        POWER_BASED_ON_HP_150_POWER_INFO,
        .type = TYPE_FIRE,
        .category = DAMAGE_CATEGORY_SPECIAL,
        .contestComboStarterId = 0,
    ...
    [MOVE_DIVE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "turn and strikes next turn."),
        SEMI_INVULNERABLE_80_POWER_INFO(STRINGID_PKMNHIDUNDERWATER, STATE_UNDERWATER),
        .type = TYPE_WATER,
        .contestEffect = CONTEST_EFFECT_AVOID_STARTLE_ONCE,
        .contestCategory = CONTEST_CATEGORY_BEAUTY,
    ...
    [MOVE_OVERHEAT] =
    {
        ...
        LOWER_SPECIAL_ATTACK_130_POWER_INFO,
        .type = TYPE_FIRE,
        .category = DAMAGE_CATEGORY_SPECIAL,
        .makesContact = B_UPDATED_MOVE_DATA < GEN_4,
        .contestCategory = CONTEST_CATEGORY_BEAUTY,
    ...
    [MOVE_SAND_TOMB] =
    {
        ...
        TRAPPING_35_POWER_MOVE(B_MSG_WRAPPED_SAND_TOMB),
        .type = TYPE_GROUND,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .contestCategory = CONTEST_CATEGORY_SMART,
        .contestComboStarterId = 0,
    ...
    [MOVE_SHEER_COLD] =
    {
        ...
        .contestCategory = CONTEST_CATEGORY_BEAUTY,
        .contestComboStarterId = 0,
        .contestComboMoves = {COMBO_STARTER_HAIL, ALWAYS_HIT_COMBOS},
    ...
    [MOVE_BULLET_SEED] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "to strike the foe."),
        MULTISTRIKE_INFO(CONTEST_EFFECT_BADLY_STARTLE_MONS_WITH_GOOD_APPEALS),
        .type = TYPE_GRASS,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .ballisticMove = TRUE,
        .contestCategory = CONTEST_CATEGORY_COOL,
        .contestComboStarterId = 0,
        .contestComboMoves = {GRASS_COMBOS, COMBO_STARTER_ROTOTILLER},
    ...
    [MOVE_ICICLE_SPEAR] =
    {
        ...
        MULTISTRIKE_INFO(CONTEST_EFFECT_STARTLE_MONS_SAME_TYPE_APPEAL),
        .type = TYPE_ICE,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        NO_COMBO(CONTEST_CATEGORY_BEAUTY),
    ...
    [MOVE_BOUNCE] =
    {
        ...
        SEMI_INVULNERABLE_INFO(STRINGID_PKMNSPRANGUP, STATE_ON_AIR),
        .power = 85,
        .type = TYPE_FLYING,
        .accuracy = 85,
        .pp = 5,
    ...
    [MOVE_WATER_PULSE] =
    {
        ...
        EFFECT_60_POWER_INFO(MOVE_EFFECT_CONFUSION),
        .type = TYPE_WATER,
        .category = DAMAGE_CATEGORY_SPECIAL,
        .pulseMove = TRUE,
        .contestEffect = C_UPDATED_MOVE_EFFECTS >= GEN_6 ? CONTEST_EFFECT_SHIFT_JUDGE_ATTENTION : CONTEST_EFFECT_SCRAMBLE_NEXT_TURN_ORDER,
    ...
    [MOVE_PSYCHO_BOOST] =
    {
        ...
        .description = COMPOUND_STRING(
            "Allows a full-power attack,\n"
            "but harshly lowers Sp. Atk."),
        LOWER_SPECIAL_ATTACK_LEGENDARY_INFO,
        .type = TYPE_PSYCHIC,
        .category = DAMAGE_CATEGORY_SPECIAL,
        .contestCategory = CONTEST_CATEGORY_SMART,
        .contestComboStarterId = 0,
    ...
    [MOVE_GRAVITY] =
    {
        ...
        .skyBattleBanned = TRUE,
        .contestEffect = CONTEST_EFFECT_MAKE_FOLLOWING_MONS_NERVOUS,
        NO_COMBO(C_UPDATED_MOVE_CATEGORIES >= GEN_6 ? CONTEST_CATEGORY_SMART : CONTEST_CATEGORY_BEAUTY),
    ...
    [MOVE_MIRACLE_EYE] =
    {
        ...
        .magicCoatAffected = B_UPDATED_MOVE_FLAGS >= GEN_5,
        .contestEffect = CONTEST_EFFECT_BETTER_IF_FIRST,
        NO_COMBO(C_UPDATED_MOVE_CATEGORIES >= GEN_6 ? CONTEST_CATEGORY_SMART : CONTEST_CATEGORY_CUTE),
    ...
    [MOVE_WAKE_UP_SLAP] =
    {
        ...
        DOUBLE_AND_REMOVE_ON_STATUS_70_POWER(STATUS1_SLEEP),
        .type = TYPE_FIGHTING,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .makesContact = TRUE,
        .contestEffect = CONTEST_EFFECT_APPEAL_AS_GOOD_AS_PREV_ONE,
        .contestCategory = C_UPDATED_MOVE_CATEGORIES >= GEN_6 ? CONTEST_CATEGORY_TOUGH : CONTEST_CATEGORY_SMART,
        .contestComboStarterId = 0,
        .contestComboMoves = {COMBO_STARTER_ENTRAINMENT, COMBO_STARTER_PLAY_NICE, SLEEP_COMBOS},
    ...
    [MOVE_HAMMER_ARM] =
    {
        ...
        LOWER_OWN_SPEED_100_POWER_INFO,
        .type = TYPE_FIGHTING,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .punchingMove = TRUE,
        .contestCategory = C_UPDATED_MOVE_CATEGORIES >= GEN_6 ? CONTEST_CATEGORY_TOUGH : CONTEST_CATEGORY_COOL,
    ...
    [MOVE_HEALING_WISH] =
    {
        ...
        .mirrorMoveBanned = TRUE,
        .contestEffect = CONTEST_EFFECT_GREAT_APPEAL_BUT_NO_MORE_MOVES,
        NO_COMBO(C_UPDATED_MOVE_CATEGORIES >= GEN_6 ? CONTEST_CATEGORY_BEAUTY : CONTEST_CATEGORY_CUTE),
    ...
    [MOVE_NATURAL_GIFT] =
    {
        ...
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .contestEffect = CONTEST_EFFECT_BETTER_WHEN_AUDIENCE_EXCITED,
        NO_COMBO(C_UPDATED_MOVE_CATEGORIES >= GEN_6 ? CONTEST_CATEGORY_SMART : CONTEST_CATEGORY_COOL),
    ...
    [MOVE_TAILWIND] =
    {
        ...
        .mirrorMoveBanned = TRUE,
        .contestEffect = CONTEST_EFFECT_NEXT_APPEAL_EARLIER,
        NO_COMBO(C_UPDATED_MOVE_CATEGORIES >= GEN_6 ? CONTEST_CATEGORY_COOL : CONTEST_CATEGORY_SMART),
    ...
    [MOVE_ACUPRESSURE] =
    {
        ...
        .snatchAffected = B_UPDATED_MOVE_FLAGS < GEN_5,
        .contestEffect = CONTEST_EFFECT_QUALITY_DEPENDS_ON_TIMING,
        NO_COMBO(C_UPDATED_MOVE_CATEGORIES >= GEN_6 ? CONTEST_CATEGORY_TOUGH : CONTEST_CATEGORY_COOL),
    ...
    [MOVE_CLOSE_COMBAT] =
    {
        ...
        LOWER_USER_TWO_STATS_120_POWER_INFO(MOVE_STAT_DEF, MOVE_STAT_SPD),
        .type = TYPE_FIGHTING,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .makesContact = TRUE,
        .contestCategory = C_UPDATED_MOVE_CATEGORIES >= GEN_6 ? CONTEST_CATEGORY_TOUGH : CONTEST_CATEGORY_SMART,
    ...
    [MOVE_GASTRO_ACID] =
    {
        ...
        .magicCoatAffected = TRUE,
        .contestEffect = CONTEST_EFFECT_WORSEN_CONDITION_OF_PREV_MONS,
        NO_COMBO(C_UPDATED_MOVE_CATEGORIES >= GEN_6 ? CONTEST_CATEGORY_TOUGH : CONTEST_CATEGORY_BEAUTY),
    ...
    [MOVE_POISON_JAB] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "may poison the foe."),
        STATUS_80_POWER_INFO(MOVE_EFFECT_POISON),
        .type = TYPE_POISON,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .makesContact = TRUE,
        .contestEffect = CONTEST_EFFECT_HIGHLY_APPEALING,
    ...
    [MOVE_SEED_BOMB] =
    {
        ...
        .contestCategory = C_UPDATED_MOVE_CATEGORIES >= GEN_6 ? CONTEST_CATEGORY_TOUGH : CONTEST_CATEGORY_SMART,
        .contestComboStarterId = 0,
        .contestComboMoves = {COMBO_STARTER_ROTOTILLER, GRASS_COMBOS},
    ...
    [MOVE_BUG_BUZZ] =
    {
        ...
        .ignoresSubstitute = B_UPDATED_MOVE_FLAGS >= GEN_6,
        .contestEffect = CONTEST_EFFECT_BADLY_STARTLE_FRONT_MON,
        NO_COMBO(C_UPDATED_MOVE_CATEGORIES >= GEN_6 ? CONTEST_CATEGORY_BEAUTIFUL : CONTEST_CATEGORY_CUTE),
    ...
    [MOVE_FIRE_FANG] =
    {
        ...
        .contestComboMoves = {COMBO_STARTER_ICE_FANG, COMBO_STARTER_THUNDER_FANG, COMBO_STARTER_SUNNY_DAY},
    ...
    [MOVE_SPACIAL_REND] =
    {
        ...
        .category = DAMAGE_CATEGORY_SPECIAL,
        .contestEffect = CONTEST_EFFECT_USER_MORE_EASILY_STARTLED,
        NO_COMBO(C_UPDATED_MOVE_CATEGORIES >= GEN_6 ? CONTEST_CATEGORY_BEAUTY : CONTEST_CATEGORY_TOUGH),
    ...
    [MOVE_MAGMA_STORM] =
    {
        ...
        TRAPPING_MOVE(B_MSG_WRAPPED_MAGMA_STORM),
    ...
    [MOVE_SHADOW_FORCE] =
    {
        ...
        SEMI_INVULNERABLE_INFO(STRINGID_VANISHEDINSTANTLY, STATE_PHANTOM_FORCE),
        .power = 120,
        .type = TYPE_GHOST,
        .accuracy = 100,
        .pp = 10,
...
#define DOUBLE_ON_STATUS_65_POWER_INFO(Status)   \
    .effect = EFFECT_DOUBLE_POWER_ON_ARG_STATUS, \
    .power = 65,                                 \
    .accuracy = 100,                             \
    .pp = 10,                                    \
    ...
    [MOVE_VENOSHOCK] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "foe is poisoned."),
        DOUBLE_ON_STATUS_65_POWER_INFO(STATUS1_PSN_ANY),
        .type = TYPE_POISON,
        .category = DAMAGE_CATEGORY_SPECIAL,
        .contestEffect = CONTEST_EFFECT_BETTER_IF_SAME_TYPE,
        .contestCategory = CONTEST_CATEGORY_BEAUTY,
        .contestComboStarterId = 0,
        .contestComboMoves = {POISON_COMBOS, COMBO_STARTER_TOXIC_SPIKES},
    ...
    [MOVE_STORED_POWER] =
    {
        ...
        STATS_INCREASE_POWER_INFO,
        .type = TYPE_PSYCHIC,
        .category = DAMAGE_CATEGORY_SPECIAL,
        .contestCategory = CONTEST_CATEGORY_SMART,
        .contestComboStarterId = 0,
        .contestComboMoves = {COMBO_STARTER_AMNESIA, COMBO_STARTER_HONE_CLAWS, SPECIAL_PSYCHIC_COMBOS, COMBO_STARTER_NASTY_PLOT},
    ...
    [MOVE_HEX] =
    {
        ...
        DOUBLE_ON_STATUS_65_POWER_INFO(STATUS1_ANY),
        .type = TYPE_GHOST,
        .category = DAMAGE_CATEGORY_SPECIAL,
        .zMove = { .powerOverride = 160 },
        .contestEffect = CONTEST_EFFECT_STARTLE_MONS_SAME_TYPE_APPEAL,
        .contestCategory = CONTEST_CATEGORY_SMART,
        .contestComboStarterId = 0,
        .contestComboMoves = {POISON_COMBOS, PARALYZE_COMBOS, BURN_COMBOS, SLEEP_COMBOS},
    ...
    [MOVE_INFERNO] =
    {
        ...
        STATUS_HIT_120_POWER_INFO(BURN),
        .type = TYPE_FIRE,
        .category = DAMAGE_CATEGORY_SPECIAL,
        .contestEffect = CONTEST_EFFECT_BADLY_STARTLE_FRONT_MON,
        .contestCategory = CONTEST_CATEGORY_BEAUTY,
        .contestComboStarterId = COMBO_STARTER_INFERNO,
        .contestComboMoves = {COMBO_STARTER_SUNNY_DAY, ALWAYS_HIT_COMBOS},
    ...
    [MOVE_WATER_PLEDGE] =
    {
        ...
        .contestComboMoves = {COMBO_STARTER_FIRE_PLEDGE, COMBO_STARTER_GRASS_PLEDGE, COMBO_STARTER_RAIN_DANCE},
        .additionalEffects = ADDITIONAL_EFFECTS({
    ...
    [MOVE_FIRE_PLEDGE] =
    {
        ...
        .contestComboMoves = {COMBO_STARTER_WATER_PLEDGE, COMBO_STARTER_GRASS_PLEDGE, COMBO_STARTER_SUNNY_DAY},
        .additionalEffects = ADDITIONAL_EFFECTS({
    ...
    [MOVE_GRASS_PLEDGE] =
    {
        ...
        .contestComboMoves = {COMBO_STARTER_WATER_PLEDGE, COMBO_STARTER_FIRE_PLEDGE, GRASS_COMBOS},
        .additionalEffects = ADDITIONAL_EFFECTS({
    ...
    [MOVE_STRUGGLE_BUG] =
    {
        ...
        LOWER_STAT_50_POWER_INFO(MOVE_STAT_SPA),
        .type = TYPE_BUG,
        .target = TARGET_BOTH,
        .category = DAMAGE_CATEGORY_SPECIAL,
        .contestEffect = CONTEST_EFFECT_BETTER_IF_LAST,
    ...
    [MOVE_DRAGON_TAIL] =
    {
        ...
        .contestComboMoves = {COMBO_STARTER_DRAGON_BREATH, COMBO_STARTER_DRAGON_DANCE, COMBO_STARTER_DRAGON_RAGE, COMBO_STARTER_DRAGON_RUSH, ENTRY_HAZARD_COMBOS},
    ...
    [MOVE_HEART_STAMP] =
    {
        ...
        EFFECT_60_POWER_INFO(MOVE_EFFECT_FLINCH),
        .type = TYPE_PSYCHIC,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .makesContact = TRUE,
        .contestEffect = CONTEST_EFFECT_REPETITION_NOT_BORING,
    ...
    [MOVE_GEAR_GRIND] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "that strike twice."),
        HIT_TWICE_120_TOTAL_POWER_INFO,
        .type = TYPE_STEEL,
        .category = DAMAGE_CATEGORY_PHYSICAL,
    ...
    [MOVE_TECHNO_BLAST] =
    {
        ...
        .description = COMPOUND_STRING(
            "The type varies with the\n"
            "kind of Drive held."),
        TYPE_CHANGE_ON_ITEM_120_POWER_INFO(HOLD_EFFECT_DRIVE),
        .type = TYPE_NORMAL,
        .category = DAMAGE_CATEGORY_SPECIAL,
        .metronomeBanned = TRUE,
        NO_COMBO(CONTEST_CATEGORY_COOL),
    ...
    [MOVE_FIERY_DANCE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "May raise Sp. Atk."),
        RAISE_STAT_80_POWER_INFO(MOVE_STAT_SPA),
        .type = TYPE_FIRE,
        .category = DAMAGE_CATEGORY_SPECIAL,
        .danceMove = TRUE,
        .contestCategory = CONTEST_CATEGORY_BEAUTY,
    ...
    [MOVE_FREEZE_SHOCK] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "may paralyze the foe."),
        TWO_TURN_ATTACK_140_POWER_INFO(STRINGID_CLOAKEDINAFREEZINGLIGHT, MOVE_EFFECT_PARALYSIS),
        .type = TYPE_ICE,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .metronomeBanned = TRUE,
        NO_COMBO(CONTEST_CATEGORY_BEAUTY),
    ...
    [MOVE_ICE_BURN] =
    {
        ...
        .description = COMPOUND_STRING(
            "A powerful 2-turn move that\n"
            "may inflict a burn."),
        TWO_TURN_ATTACK_140_POWER_INFO(STRINGID_CLOAKEDINAFREEZINGLIGHT, MOVE_EFFECT_BURN),
        .type = TYPE_ICE,
        .category = DAMAGE_CATEGORY_SPECIAL,
        .metronomeBanned = TRUE,
        NO_COMBO(CONTEST_CATEGORY_BEAUTY),
    ...
    [MOVE_SNARL] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "lowering its Sp. Atk."),
        LOWER_STAT_55_POWER_INFO(MOVE_STAT_SPA),
        .type = TYPE_DARK,
        .target = TARGET_BOTH,
        .category = DAMAGE_CATEGORY_SPECIAL,
        .ignoresSubstitute = B_UPDATED_MOVE_FLAGS >= GEN_6,
    ...
    [MOVE_PARABOLIC_CHARGE] =
    {
        ...
        ABSORBING_MOVES_INFO(50),
        .power = B_UPDATED_MOVE_DATA >= GEN_7 ? 75 : 50,
        .type = TYPE_ELECTRIC,
        .accuracy = 100,
        .pp = 20,
        .target = TARGET_BOTH,
    ...
    [MOVE_STEAM_ERUPTION] =
    {
        ...
        .contestCategory = CONTEST_CATEGORY_BEAUTY,
        .contestComboStarterId = 0,
        .contestComboMoves = {COMBO_STARTER_SCALD, COMBO_STARTER_RAIN_DANCE},
    ...
    [MOVE_HYPERSPACE_HOLE] =
    {
        ...
        .contestComboMoves = {COMBO_STARTER_HYPERSPACE_FURY, SPECIAL_PSYCHIC_COMBOS},
    ...
    [MOVE_VENOM_DRENCH] =
    {
        ...
        .contestCategory = CONTEST_CATEGORY_SMART,
        .contestComboStarterId = 0,
        .contestComboMoves = {POISON_COMBOS},
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = STAT_CHANGE_EFFECT_MINUS,
            .attack = 1,
            .spAtk = 1,
    ...
    [MOVE_INFESTATION] =
    {
        ...
        TRAPPING_35_POWER_MOVE(B_MSG_WRAPPED_INFESTATION),
        .type = TYPE_BUG,
        .category = DAMAGE_CATEGORY_SPECIAL,
        .makesContact = TRUE,
        NO_COMBO(CONTEST_CATEGORY_CUTE),
    ...
    [MOVE_ORIGIN_PULSE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "blast both foes."),
        METRONOME_BANNED_HIT_BOTH_LEGENDARY_SIGNATURE_120_POWER_INFO,
        .type = TYPE_WATER,
        .category = DAMAGE_CATEGORY_SPECIAL,
        .pulseMove = TRUE,
    ...
    [MOVE_LUNGE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "its Attack stat."),
        LOWER_STAT_80_POWER_INFO(MOVE_STAT_ATK),
        .type = TYPE_BUG,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .makesContact = TRUE,
        NO_COMBO(CONTEST_CATEGORY_CUTE),
    ...
    [MOVE_FIRE_LASH] =
    {
        ...
        LOWER_STAT_90_POWER_INFO(MOVE_STAT_DEF),
        .type = TYPE_FIRE,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .makesContact = TRUE,
        .contestCategory = CONTEST_CATEGORY_BEAUTY,
    ...
    [MOVE_TROP_KICK] =
    {
        ...
        LOWER_STAT_90_POWER_INFO(MOVE_STAT_ATK),
        .type = TYPE_GRASS,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .makesContact = TRUE,
        .kickingMove = TRUE,
    ...
    [MOVE_BEAK_BLAST] =
    {
        ...
        .type = TYPE_FLYING,
        .accuracy = 100,
        .pp = B_UPDATED_MOVE_DATA >= GEN_CHAMPIONS ? 10 : 15,
        .target = TARGET_SELECTED,
        .priority = -3,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .mirrorMoveBanned = TRUE,
    ...
    [MOVE_STOMPING_TANTRUM] =
    {
        ...
        DOUBLE_IF_FAILED_75_POWER_INFO,
        .type = TYPE_GROUND,
        .makesContact = TRUE,
    ...
    [MOVE_SUNSTEEL_STRIKE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "ignores Abilities."),
        IGNORE_ABILITIES_100_POWER_INFO,
        .type = TYPE_STEEL,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .makesContact = TRUE,
        NO_COMBO(CONTEST_CATEGORY_COOL),
    ...
    [MOVE_MULTI_ATTACK] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "with Memories."),
        TYPE_CHANGE_ON_ITEM_120_POWER_INFO(HOLD_EFFECT_MEMORY),
        .type = TYPE_NORMAL,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .makesContact = TRUE,
        NO_COMBO(CONTEST_CATEGORY_BEAUTY),
    ...
    PLACEHOLDER_MOVE(680),
    PLACEHOLDER_MOVE(681),
    PLACEHOLDER_MOVE(682),
    PLACEHOLDER_MOVE(683),
    PLACEHOLDER_MOVE(684),
    PLACEHOLDER_MOVE(685),
    PLACEHOLDER_MOVE(686),
    PLACEHOLDER_MOVE(687),
    PLACEHOLDER_MOVE(688),
    ...
    [MOVE_DRUM_BEATING] =
    {
        ...
        LOWER_STAT_80_POWER_INFO(MOVE_STAT_SPE),
        .type = TYPE_GRASS,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .metronomeBanned = TRUE,
        .contestCategory = CONTEST_CATEGORY_SMART,
    ...
    [MOVE_SNAP_TRAP] =
    {
        ...
        TRAPPING_35_POWER_MOVE(B_MSG_WRAPPED_SNAP_TRAP),
    ...
    [MOVE_APPLE_ACID] =
    {
        ...
        LOWER_STAT_90_POWER_INFO(MOVE_STAT_SPD),
        .type = TYPE_GRASS,
        .category = DAMAGE_CATEGORY_SPECIAL,
        .metronomeBanned = TRUE,
        .contestCategory = CONTEST_CATEGORY_TOUGH,
    ...
    [MOVE_METEOR_BEAM] =
    {
        ...
        TWO_TURN_ATTACK_INFO(STRINGID_METEORBEAMCHARGING),
        .power = 120,
        .type = TYPE_ROCK,
        .accuracy = 90,
        .pp = 10,
    ...
    [MOVE_SCORCHING_SANDS] =
    {
        ...
        EFFECT_70_POWER_INFO(MOVE_EFFECT_BURN),
        .type = TYPE_GROUND,
        .category = DAMAGE_CATEGORY_SPECIAL,
        .thawsUser = TRUE,
        NO_COMBO(CONTEST_CATEGORY_TOUGH),
    ...
    [MOVE_SPRINGTIDE_STORM] =
    {
        ...
        GENIE_STORM_STAT_LOWER_INFO(MOVE_STAT_ATK),
        .type = TYPE_FAIRY,
        .metronomeBanned = TRUE,
        .contestComboMoves = {COMBO_STARTER_RAIN_DANCE},
    ...
    [MOVE_INFERNAL_PARADE] =
    {
        ...
        .effect = EFFECT_DOUBLE_POWER_ON_ARG_STATUS,
        .power = B_UPDATED_MOVE_DATA >= GEN_CHAMPIONS ? 75 : 60,
        .type = TYPE_GHOST,
        .accuracy = 100,
        .pp = 15,
        .target = TARGET_SELECTED,
    ...
    [MOVE_BLEAKWIND_STORM] =
    {
        ...
        GENIE_STORM_STAT_LOWER_INFO(MOVE_STAT_SPE),
        .type = TYPE_FLYING,
        .contestComboMoves = {COMBO_STARTER_RAIN_DANCE},
    ...
    [MOVE_WILDBOLT_STORM] =
    {
        ...
        GENIE_STORM_STATUS_INFO(MOVE_EFFECT_PARALYSIS),
        .type = TYPE_ELECTRIC,
    ...
    [MOVE_SANDSEAR_STORM] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "May inflict a burn."),
        GENIE_STORM_STATUS_INFO(MOVE_EFFECT_BURN),
        .type = TYPE_GROUND,
        .contestComboMoves = {COMBO_STARTER_RAIN_DANCE},
    ...
    [MOVE_MAKE_IT_RAIN] =
    {
        ...
        .power = 120,
        .type = TYPE_STEEL,
        .accuracy = B_UPDATED_MOVE_DATA >= GEN_CHAMPIONS ? 100 : 100,
        .pp = 10,
        .target = TARGET_BOTH,
        .priority = 0,
        .category = DAMAGE_CATEGORY_SPECIAL,
    ...
    [MOVE_POUNCE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "lowering its Speed."),
        LOWER_STAT_50_POWER_INFO(MOVE_STAT_SPE),
        .type = TYPE_BUG,
        .target = TARGET_SELECTED,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .makesContact = TRUE,
    ...
    [MOVE_CHILLING_WATER] =
    {
        ...
        LOWER_STAT_50_POWER_INFO(MOVE_STAT_ATK),
        .type = TYPE_WATER,
        .target = TARGET_SELECTED,
        .category = DAMAGE_CATEGORY_SPECIAL,
        .metronomeBanned = TRUE,
    ...
    [MOVE_PSYBLADE] =
    {
        ...
        .makesContact = TRUE,
        .slicingMove = TRUE,
        .contestComboMoves = {COMBO_STARTER_ELECTRIC_TERRAIN, COMBO_STARTER_PSYCHIC_TERRAIN},
    ...
    [MOVE_HYDRO_STEAM] =
    {
        ...
        .category = DAMAGE_CATEGORY_SPECIAL,
        .thawsUser = TRUE,
        .contestComboMoves = {COMBO_STARTER_SUNNY_DAY, COMBO_STARTER_RAIN_DANCE},
    ...
    [MOVE_ELECTRO_SHOT] =
    {
        ...
        TWO_TURN_ATTACK_INFO(STRINGID_ELECTROSHOTCHARGING, BATTLE_WEATHER_RAIN),
        .power = 130,
        .type = TYPE_ELECTRIC,
        .accuracy = 100,
        .pp = 10,
...
#define CUSTOM_BASIC_MOVE_INFO(Type, Category)         \
    ...
    {
        .name = COMPOUND_STRING("Heart Scale Shot"),
        .description = COMPOUND_STRING(
            "Shoots scales 2 to 5 times.\n"
            "Increases Speed."),
        .effect = EFFECT_HEART_SCALE_SHOT,
        .power = 25,
        .type = TYPE_WATER,
        .accuracy = 100,
        .pp = 20,
        ...
        .contestEffect = CONTEST_EFFECT_QUALITY_DEPENDS_ON_TIMING,
        NO_COMBO(CONTEST_CATEGORY_CUTE),
        .battleAnimScript = gBattleAnimMove_HeartScaleShot,
    },
...
#define DMAX_LOWER_STAT_INFO(Stat)            \
    MAX_MOVE_INFO,                            \
    .power = 1,                               \
    .additionalEffects = ADDITIONAL_EFFECTS({ \
        .moveEffect = MOVE_EFFECT_STAT_MINUS, \
...
#define DMAX_RAISE_STAT_INFO(Stat)            \
    MAX_MOVE_INFO,                            \
    .power = 1,                               \
    .additionalEffects = ADDITIONAL_EFFECTS({ \
        .moveEffect = MOVE_EFFECT_STAT_PLUS,  \
    ...
    [MOVE_MAX_FLUTTERBY] =
    {
        ...
        .description = COMPOUND_STRING(
            "Bug Dynamax attack.\n"
            "Lowers foes' Sp. Atk."),
        DMAX_LOWER_STAT_INFO(MOVE_STAT_SPA),
        .type = TYPE_BUG,
    ...
    [MOVE_MAX_STRIKE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "Lowers foes' Speed."),
        DMAX_LOWER_STAT_INFO(MOVE_STAT_SPE),
        .type = TYPE_NORMAL,
    ...
    [MOVE_MAX_KNUCKLE] =
    {
        ...
        DMAX_RAISE_STAT_INFO(MOVE_STAT_ATK),
        .type = TYPE_FIGHTING,
    ...
    [MOVE_MAX_PHANTASM] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "Lowers foes' Defense."),
        DMAX_LOWER_STAT_INFO(MOVE_STAT_DEF),
        .type = TYPE_GHOST,
    ...
    [MOVE_MAX_OOZE] =
    {
        ...
        DMAX_RAISE_STAT_INFO(MOVE_STAT_SPA),
        .type = TYPE_POISON,
    ...
    [MOVE_MAX_AIRSTREAM] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "Raises allies' Speed."),
        DMAX_RAISE_STAT_INFO(MOVE_STAT_SPE),
        .type = TYPE_FLYING,
    ...
    [MOVE_MAX_WYRMWIND] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "Lowers foes' Attack."),
        DMAX_LOWER_STAT_INFO(MOVE_STAT_ATK),
        .type = TYPE_DRAGON,
    ...
    [MOVE_MAX_QUAKE] =
    {
        ...
        DMAX_RAISE_STAT_INFO(MOVE_STAT_SPD),
        .type = TYPE_GROUND,
        .skyBattleBanned = B_EXTRAPOLATED_MOVE_FLAGS,
    ...
    [MOVE_MAX_DARKNESS] =
    {
        ...
        .description = COMPOUND_STRING(
            "Dark Dynamax attack.\n"
            "Lowers foes' Sp. Def."),
        DMAX_LOWER_STAT_INFO(MOVE_STAT_SPD),
        .type = TYPE_DARK,
    ...
    [MOVE_MAX_STEELSPIKE] =
    {
        ...
        DMAX_RAISE_STAT_INFO(MOVE_STAT_DEF),
        .type = TYPE_STEEL,
