...
#define MOTHIM_SPECIES_INFO                                                 \
    ...
    [SPECIES_BUNEARY] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 23, SPECIES_LOPUNNY}),
    },
    ...
    [SPECIES_GLAMEOW] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 34, SPECIES_PURUGLY}),
    },
...
#define ROTOM_CATCH_RATE BOOSTED_CATCH_RATE(45)
