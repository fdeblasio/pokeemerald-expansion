...
#define SPECIES_DESERT_RUINS_LEGENDARY  SPECIES_REGIROCK
#define SPECIES_ISLAND_CAVE_LEGENDARY   SPECIES_REGICE
#define SPECIES_ANCIENT_TOMB_LEGENDARY  SPECIES_REGISTEEL
