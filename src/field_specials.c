...
{
    u16 monData;
    CreateRandomMon(&gParties[B_TRAINER_0][0], SPECIES_NORMAN_LEND, 7);
    monData = TRUE;
    ...
    SetMonData(&gParties[B_TRAINER_0][0], MON_DATA_POKEBALL, &monData);
}
...
static const u8 *const sScrollableMultichoiceOptions[][MAX_SCROLL_MULTI_LENGTH] =
{
    ...
    {
        COMPOUND_STRING("Kiss Poster{CLEAR_TO 0x5E}1BP"),
        COMPOUND_STRING("Kiss Cushion{CLEAR_TO 0x5E}1BP"),
        COMPOUND_STRING("Smoochum Doll{CLEAR_TO 0x5E}1BP"),
        COMPOUND_STRING("Togepi Doll{CLEAR_TO 0x5E}1BP"),
        COMPOUND_STRING("Meowth Doll{CLEAR_TO 0x5E}1BP"),
        COMPOUND_STRING("Clefairy Doll{CLEAR_TO 0x5E}1BP"),
        COMPOUND_STRING("Ditto Doll{CLEAR_TO 0x5E}1BP"),
        COMPOUND_STRING("Cyndaquil Doll{CLEAR_TO 0x5E}2BP"),
        COMPOUND_STRING("Chikorita Doll{CLEAR_TO 0x5E}2BP"),
        COMPOUND_STRING("Totodile Doll{CLEAR_TO 0x5E}2BP"),
        gText_Exit
    },
    [SCROLL_MULTI_BF_EXCHANGE_CORNER_DECOR_VENDOR_2] =
    {
        COMPOUND_STRING("Lapras Doll{CLEAR_TO 0x58}4BP"),
        COMPOUND_STRING("Snorlax Doll{CLEAR_TO 0x58}4BP"),
        COMPOUND_STRING("Venusaur Doll{CLEAR_TO 0x58}4BP"),
        COMPOUND_STRING("Charizard Doll{CLEAR_TO 0x58}4BP"),
        COMPOUND_STRING("Blastoise Doll{CLEAR_TO 0x58}4BP"),
        COMPOUND_STRING("Regirock Doll{CLEAR_TO 0x58}4BP"),
        COMPOUND_STRING("Regice Doll{CLEAR_TO 0x58}4BP"),
        COMPOUND_STRING("Registeel Doll{CLEAR_TO 0x58}4BP"),
        gText_Exit
    },
