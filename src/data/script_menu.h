...
{
    {COMPOUND_STRING("Ledyba")},
    {COMPOUND_STRING("Patrat")},
    {COMPOUND_STRING("Munchlax")},
};

static const struct MenuAction MultichoiceList_Mechadoll2_Q2[] =
{
    {COMPOUND_STRING("Yungoos")},
