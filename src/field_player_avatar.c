...
{
    [PLAYER_AVATAR_STATE_NORMAL]     = {OBJ_EVENT_GFX_RIVAL_KYLE_NORMAL,     OBJ_EVENT_GFX_RIVAL_KELLI_NORMAL},
    [PLAYER_AVATAR_STATE_MACH_BIKE]  = {OBJ_EVENT_GFX_RIVAL_KYLE_MACH_BIKE,  OBJ_EVENT_GFX_RIVAL_KELLI_MACH_BIKE},
    [PLAYER_AVATAR_STATE_ACRO_BIKE]  = {OBJ_EVENT_GFX_RIVAL_KYLE_ACRO_BIKE,  OBJ_EVENT_GFX_RIVAL_KELLI_ACRO_BIKE},
    [PLAYER_AVATAR_STATE_SURFING]    = {OBJ_EVENT_GFX_RIVAL_KYLE_SURFING,    OBJ_EVENT_GFX_RIVAL_KELLI_SURFING},
    [PLAYER_AVATAR_STATE_UNDERWATER] = {OBJ_EVENT_GFX_KYLE_UNDERWATER,       OBJ_EVENT_GFX_KELLI_UNDERWATER},
    [PLAYER_AVATAR_STATE_FIELD_MOVE] = {OBJ_EVENT_GFX_RIVAL_KYLE_FIELD_MOVE, OBJ_EVENT_GFX_RIVAL_KELLI_FIELD_MOVE},
    [PLAYER_AVATAR_STATE_FISHING]    = {OBJ_EVENT_GFX_KYLE_FISHING,          OBJ_EVENT_GFX_KELLI_FISHING},
    [PLAYER_AVATAR_STATE_WATERING]   = {OBJ_EVENT_GFX_KYLE_WATERING,         OBJ_EVENT_GFX_KELLI_WATERING},
    [PLAYER_AVATAR_STATE_VSSEEKER]   = {OBJ_EVENT_GFX_RIVAL_KYLE_FIELD_MOVE, OBJ_EVENT_GFX_RIVAL_KELLI_FIELD_MOVE},
};

static const u8 sPlayerAvatarGfxIds[][2] =
{
    [PLAYER_AVATAR_STATE_NORMAL]     = {OBJ_EVENT_GFX_KYLE_NORMAL,     OBJ_EVENT_GFX_KELLI_NORMAL},
    [PLAYER_AVATAR_STATE_MACH_BIKE]  = {OBJ_EVENT_GFX_KYLE_MACH_BIKE,  OBJ_EVENT_GFX_KELLI_MACH_BIKE},
    [PLAYER_AVATAR_STATE_ACRO_BIKE]  = {OBJ_EVENT_GFX_KYLE_ACRO_BIKE,  OBJ_EVENT_GFX_KELLI_ACRO_BIKE},
    [PLAYER_AVATAR_STATE_SURFING]    = {OBJ_EVENT_GFX_KYLE_SURFING,    OBJ_EVENT_GFX_KELLI_SURFING},
    [PLAYER_AVATAR_STATE_UNDERWATER] = {OBJ_EVENT_GFX_KYLE_UNDERWATER, OBJ_EVENT_GFX_KELLI_UNDERWATER},
    [PLAYER_AVATAR_STATE_FIELD_MOVE] = {OBJ_EVENT_GFX_KYLE_FIELD_MOVE, OBJ_EVENT_GFX_KELLI_FIELD_MOVE},
    [PLAYER_AVATAR_STATE_FISHING]    = {OBJ_EVENT_GFX_KYLE_FISHING,    OBJ_EVENT_GFX_KELLI_FISHING},
    [PLAYER_AVATAR_STATE_WATERING]   = {OBJ_EVENT_GFX_KYLE_WATERING,   OBJ_EVENT_GFX_KELLI_WATERING},
    [PLAYER_AVATAR_STATE_VSSEEKER]   = {OBJ_EVENT_GFX_KYLE_FIELD_MOVE, OBJ_EVENT_GFX_KELLI_FIELD_MOVE},
};
...
{
    [MALE]   = OBJ_EVENT_GFX_LINK_RS_KYLE,
    [FEMALE] = OBJ_EVENT_GFX_LINK_RS_KELLI
};
...
static const u8 sPlayerAvatarGfxToStateFlag[GENDER_COUNT][5][2] =
{
    ...
    [FEMALE] =
    {
        {OBJ_EVENT_GFX_KELLI_NORMAL,         PLAYER_AVATAR_FLAG_ON_FOOT},
        {OBJ_EVENT_GFX_KELLI_MACH_BIKE,      PLAYER_AVATAR_FLAG_MACH_BIKE},
        {OBJ_EVENT_GFX_KELLI_ACRO_BIKE,      PLAYER_AVATAR_FLAG_ACRO_BIKE},
        {OBJ_EVENT_GFX_KELLI_SURFING,        PLAYER_AVATAR_FLAG_SURFING},
        {OBJ_EVENT_GFX_KELLI_UNDERWATER,     PLAYER_AVATAR_FLAG_UNDERWATER},
    }
};
...
u8 GetPlayerAvatarGenderByGraphicsId(u16 gfxId)
{
    switch (gfxId)
    {
    case OBJ_EVENT_GFX_KELLI_NORMAL:
    case OBJ_EVENT_GFX_KELLI_MACH_BIKE:
    case OBJ_EVENT_GFX_KELLI_ACRO_BIKE:
    case OBJ_EVENT_GFX_KELLI_SURFING:
    case OBJ_EVENT_GFX_KELLI_FIELD_MOVE:
    case OBJ_EVENT_GFX_KELLI_UNDERWATER:
    case OBJ_EVENT_GFX_KELLI_FISHING:
    case OBJ_EVENT_GFX_KELLI_WATERING:
        return FEMALE;
    default:
        return MALE;
    }
