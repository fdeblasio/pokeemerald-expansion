...
enum {
    ...
    NATIONAL_DEX_LEDYBULK,
    NATIONAL_DEX_PACHIRIKKU,
};
...
#define JOHTO_DEX_COUNT     NATIONAL_DEX_CELEBI
    ...
    #define NATIONAL_DEX_COUNT  NATIONAL_DEX_PACHIRIKKU
...
enum {
    ...
    HOENN_DEX_ABOMASNOW,
    HOENN_DEX_ZERAORA,
    HOENN_DEX_LANDORUS_THERIAN,
    HOENN_DEX_CHIEN_PAO,
    HOENN_DEX_SOLGALEO,
};

#define HOENN_DEX_COUNT (HOENN_DEX_SOLGALEO + 1)
