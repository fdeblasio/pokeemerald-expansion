...
[REMATCH_##trainer] =            \
{                                \
    .trainerIds = {TRAINER_##trainer, TRAINER_##trainer, TRAINER_##trainer, TRAINER_##trainer, TRAINER_##trainer}, \
    .mapGroup = MAP_GROUP(map),  \
    .mapNum = MAP_NUM(map),      \
}
...
{
    REMATCH(ROSE, MAP_ROUTE118),
    REMATCH(ANDRES, MAP_ROUTE105),
    REMATCH(DUSTY, MAP_ROUTE111),
    REMATCH(LOLA, MAP_ROUTE109),
    REMATCH(RICKY, MAP_ROUTE109),
    REMATCH(LILA_AND_ROY, MAP_ROUTE124),
    REMATCH(CRISTIN, MAP_ROUTE121),
    REMATCH(BROOKE, MAP_ROUTE111),
    REMATCH(WILTON, MAP_ROUTE111),
    REMATCH(VALERIE, MAP_MT_PYRE_6F),
    REMATCH(CINDY, MAP_ROUTE104_NORTH),
    REMATCH(THALIA, MAP_ABANDONED_SHIP_ROOMS_1F),
    REMATCH(JESSICA, MAP_ROUTE121),
    REMATCH(WINSTON, MAP_ROUTE104),
    REMATCH(STEVE, MAP_ROUTE114),
    REMATCH(TONY, MAP_ROUTE107),
    REMATCH(NOB, MAP_ROUTE115),
    REMATCH(KOJI, MAP_ROUTE127),
    REMATCH(FERNANDO, MAP_ROUTE123),
    ...
    REMATCH(WALTER, MAP_ROUTE121),
    REMATCH(KAREN, MAP_ROUTE116),
    REMATCH(JERRY, MAP_ROUTE116),
    REMATCH(ANNA_AND_MEG, MAP_ROUTE117),
    REMATCH(ISABEL, MAP_ROUTE110),
    REMATCH(MIGUEL, MAP_ROUTE103),
    REMATCH(TIMOTHY, MAP_ROUTE115),
    REMATCH(SHELBY, MAP_MT_CHIMNEY),
    REMATCH(CALVIN, MAP_ROUTE102),
    REMATCH(ELLIOT, MAP_ROUTE106),
    REMATCH(ISAIAH, MAP_ROUTE128),
    REMATCH(MARIA, MAP_ROUTE117),
    REMATCH(ABIGAIL, MAP_ROUTE110),
    REMATCH(DYLAN, MAP_ROUTE117),
    ...
    REMATCH(MADELINE, MAP_ROUTE113),
    REMATCH(JENNY, MAP_ROUTE124),
    REMATCH(DIANA, MAP_JAGGED_PASS),
    REMATCH(AMY_AND_LIV, MAP_ROUTE103),
    REMATCH(ERNEST, MAP_ROUTE125),
    REMATCH(CORY, MAP_ROUTE108),
    REMATCH(EDWIN, MAP_ROUTE110),
    REMATCH(LYDIA, MAP_ROUTE117),
    REMATCH(ISAAC, MAP_ROUTE117),
    REMATCH(GABRIELLE, MAP_MT_PYRE_3F),
    REMATCH(CATHERINE, MAP_ROUTE119),
    REMATCH(JACKSON, MAP_ROUTE119),
    REMATCH(HALEY, MAP_ROUTE104_NORTH),
    REMATCH(JAMES, MAP_PETALBURG_WOODS),
    REMATCH(TRENT, MAP_ROUTE112),
    REMATCH(SAWYER, MAP_MT_CHIMNEY),
    REMATCH(KIRA_AND_DAN, MAP_ABANDONED_SHIP_ROOMS2_1F),
    REMATCH_WALLY(WALLY_VICTORY_ROAD, MAP_VICTORY_ROAD_1F),
    REMATCH_GYM_LEADER(ROXANNE, MAP_RUSTBORO_CITY),
    REMATCH_GYM_LEADER(BRAWLY, MAP_DEWFORD_TOWN),
    REMATCH_GYM_LEADER(WATTSON, MAP_MAUVILLE_CITY),
    REMATCH_GYM_LEADER(FLANNERY, MAP_LAVARIDGE_TOWN),
    REMATCH_GYM_LEADER(NORMAN, MAP_PETALBURG_CITY),
    REMATCH_GYM_LEADER(WINONA, MAP_FORTREE_CITY),
    REMATCH_GYM_LEADER(TATE_AND_LIZA, MAP_MOSSDEEP_CITY),
    REMATCH_GYM_LEADER(JUAN, MAP_SOOTOPOLIS_CITY),
    REMATCH_E4(SIDNEY, MAP_EVER_GRANDE_CITY),
    REMATCH_E4(PHOEBE, MAP_EVER_GRANDE_CITY),
    REMATCH_E4(GLACIA, MAP_EVER_GRANDE_CITY),
    REMATCH_E4(DRAKE, MAP_EVER_GRANDE_CITY),
    REMATCH_E4(WALLACE, MAP_EVER_GRANDE_CITY),
};
...
{
    CreateMaleMon(&gParties[B_TRAINER_OPPONENT_A][0], SPECIES_WALLY_STARTER, 5);
    LockPlayerFieldControls();
