...
const u8 gText_MatchCallPkmnTrainer_Duncan_Strategy[] = _("We let it all hang out.");
const u8 gText_MatchCallPkmnTrainer_Duncan_Pokemon[] = _("The 1st Pokémon I caught.");
const u8 gText_MatchCallPkmnTrainer_Duncan_Intro1[] = _("Pokémon and I have grown");
const u8 gText_MatchCallPkmnTrainer_Duncan_Intro2[] = _("stronger together.");
...
const u8 gText_MatchCallDandyCharm_Juan_Strategy[] = _("I use splendid grasspower.");
...
const u8 *const gMatchCallFlavorTexts[REMATCH_TABLE_ENTRIES][CHECK_PAGE_ENTRY_COUNT] =
{
    ...
    [REMATCH_DUNCAN_VICTORY_ROAD] = MCFLAVOR(PkmnTrainer_Duncan),
