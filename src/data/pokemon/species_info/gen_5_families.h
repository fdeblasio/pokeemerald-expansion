...
const struct SpeciesInfo gSpeciesInfoGen5[] =
{
    ...
    [SPECIES_WOOBAT] =
    {
        ...
        .abilities = { ABILITY_UNAWARE, ABILITY_SIMPLE, ABILITY_SYNCHRONIZE },
        .bodyColor = BODY_COLOR_BLUE,
...
#define COTTONEE_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_GRASS)
    ...
    [SPECIES_DARUMAKA] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 32, SPECIES_DARMANITAN_STANDARD}),
    },
    ...
    [SPECIES_GOTHITELLE] =
    {
        ...
        .baseSpDefense = 110,
        .types = MON_TYPES(TYPE_PSYCHIC),
        .catchRate = DEFAULT_CATCH_RATE(50),
    ...
    [SPECIES_KLINK] =
    {
        ...
        .catchRate = DEFAULT_CATCH_RATE(130),
        .expYield = 60,
        .evYield_Defense = 1,
        .genderRatio = MON_GENDERLESS,
        .eggCycles = 20,
    ...
    [SPECIES_CRYOGONAL] =
    {
        ...
        .baseSpDefense = 135,
        .types = MON_TYPES(TYPE_ICE),
        .catchRate = DEFAULT_CATCH_RATE(25),
    ...
    [SPECIES_ACCELGOR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_HYDRATION, ABILITY_DRY_SKIN, ABILITY_SPEED_BOOST },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_DRUDDIGON] =
    {
        ...
        .abilities = { ABILITY_ROUGH_SKIN, ABILITY_SHEER_FORCE, ABILITY_ROCK_HEAD },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_RUFFLET] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 35, SPECIES_BRAVIARY, CONDITIONS({IF_NOT_REGION, REGION_HISUI})}
                            #if P_HISUIAN_FORMS
                                ,{EVO_LEVEL, 35, SPECIES_BRAVIARY_HISUI, CONDITIONS({IF_REGION, REGION_HISUI})}
                            #endif
                            ),
    },
    ...
    [SPECIES_VOLCARONA] =
    {
        ...
        .baseSpDefense = 105,
        .types = MON_TYPES(TYPE_BUG, TYPE_FIRE),
        .catchRate = DEFAULT_CATCH_RATE(15),
