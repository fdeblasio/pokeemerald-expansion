...
const u32 gObjectEventPic_Frank[] = INCGFX_U32("graphics/object_events/pics/people/frank.png", ".4bpp", "-mwidth 2 -mheight 4");
const u16 gObjectEventPal_Frank[] = INCGFX_U16("graphics/object_events/palettes/frank.pal", ".gbapal");
