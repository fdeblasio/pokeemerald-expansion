...
const struct TrainerSprite gTrainerSprites[] =
{
    ...
    TRAINER_SPRITE(FRANK, Frank, 0, 0, 0x200),
    TRAINER_SPRITE(ROCKER, Rocker, 0, 0, 0x200),
    TRAINER_SPRITE(COOL_COUPLE, CoolCouple, 0, 0, 0x200),
    TRAINER_SPRITE(BIKER, Biker, 0, 0, 0x200),
    TRAINER_SPRITE(LEADER_BROCK, LeaderBrock, 0, 0, 0x200),
    TRAINER_SPRITE(LEADER_MISTY, LeaderMisty, 0, 0, 0x200),
    TRAINER_SPRITE(LEADER_LT_SURGE, LeaderLtSurge, 0, 0, 0x200),
    TRAINER_SPRITE(LEADER_ERIKA, LeaderErika, 0, 0, 0x200),
    TRAINER_SPRITE(LEADER_KOGA, LeaderKoga, 0, 0, 0x200),
    TRAINER_SPRITE(LEADER_SABRINA, LeaderSabrina, 0, 0, 0x200),
    TRAINER_SPRITE(LEADER_BLAINE, LeaderBlaine, 0, 0, 0x200),
    TRAINER_SPRITE(LEADER_GIOVANNI, LeaderGiovanni, 0, 0, 0x200),
    TRAINER_SPRITE(ELITE_FOUR_LORELEI, EliteFourLorelei, -8, 0, 0x200),
    TRAINER_SPRITE(ELITE_FOUR_BRUNO, EliteFourBruno, -10, 0, 0x200),
    TRAINER_SPRITE(ELITE_FOUR_AGATHA, EliteFourAgatha, 0, 0, 0x200),
    TRAINER_SPRITE(ELITE_FOUR_LANCE, EliteFourLance, -32, 0, 0x200),
    TRAINER_SPRITE(BURGLAR, Burglar, 0, 0, 0x200),
};
