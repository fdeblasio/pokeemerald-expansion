...
RIVAL_BATTLES(MAY, GRASS, CHEWTLE, DREDNAW, STRONG_JAW, VULPIX, NINETALES, FLASH_FIRE),
RIVAL_BATTLES(MAY, FIRE, GOSSIFLEUR, ELDEGOSS, COTTON_DOWN, CHEWTLE, DREDNAW, STRONG_JAW),
RIVAL_BATTLES(MAY, WATER, VULPIX, NINETALES, FLASH_FIRE, GOSSIFLEUR, ELDEGOSS, COTTON_DOWN),
...
#define WATTSON_EELEKTROSS(rematch, tier)                                          \
    {                                                                              \
    REMATCH_MON(EELEKTROSS, tier, rematch),                                        \
    .ability = ABILITY_LEVITATE,                                                   \
    .nature = NATURE_ADAMANT,                                                      \
    EV_SPREAD_SPA_SPE_DEF,                                                         \
...
#define TATE_CHIMECHO(rematch, tier)                                             \
    {                                                                            \
    REMATCH_MON(CHIMECHO, tier, rematch),                                        \
    .ability = ABILITY_LEVITATE,                                                 \
    .nature = NATURE_MODEST,                                                     \
    EV_SPREAD_SPA_SPD_HP,                                                        \
...
[DIFFICULTY_NORMAL][TRAINER_SIDNEY] =
{
    ...
    .partySize = 5,
    .party = (const struct TrainerMon[]) {
        SIDNEY_UMBREON(60, TIER3),
        SIDNEY_MABOSSTIFF(60, TIER3),
        SIDNEY_HONCHKROW(61, TIER3),
        SIDNEY_ZOROARK(61, TIER3),
        SIDNEY_ABSOL(62, ACE),
    },
},
...
[DIFFICULTY_NORMAL][TRAINER_GLACIA] =
{
    ...
    .partySize = 5,
    .party = (const struct TrainerMon[]) {
        GLACIA_EISCUE(62, TIER3),
        GLACIA_GLACEON(62, TIER3),
        GLACIA_NINETALES(63, TIER3),
        GLACIA_FROSMOTH(63, TIER3),
        GLACIA_MAMOSWINE(64, ACE),
    },
},
...
[DIFFICULTY_NORMAL][TRAINER_GLACIA_REMATCH] =
{
    ...
    .partySize = 6,
    .party = (const struct TrainerMon[]) {
        GLACIA_BEARTIC(86, TIER3),
        GLACIA_EISCUE(86, TIER3),
        GLACIA_GLACEON(86, TIER3),
        GLACIA_NINETALES(88, TIER2),
        GLACIA_FROSMOTH(88, TIER3),
        GLACIA_MAMOSWINE(90, ACE),
    },
},
...
[DIFFICULTY_NORMAL][TRAINER_DRAKE] =
{
    ...
    .party = (const struct TrainerMon[]) {
        ...
        DRAKE_HAXORUS(63, TIER3),
        DRAKE_DRAGONITE(64, TIER3),
...
[DIFFICULTY_NORMAL][TRAINER_DRAKE_REMATCH] =
{
    ...
    .party = (const struct TrainerMon[]) {
        ...
        DRAKE_HAXORUS(86, TIER3),
        DRAKE_DRAGONITE(88, TIER3),
...
{                                                                                        \
    ...
    .party = (const struct TrainerMon[]) {                                               \
        ...
        {                                                                                \
        .lvl = (AceLevel - 2),                                                           \
        .species = AceLevel < REMATCH_3_LEVEL_6 ? SPECIES_GLIGAR : SPECIES_GLISCOR,      \
        .ability = ABILITY_SAND_VEIL,                                                    \
        IVS(IVs),                                                                        \
        .gender = TRAINER_MON_MALE,                                                      \
        ...
        {                                                                                \
        .lvl = AceLevel,                                                                 \
        .species = AceLevel < REMATCH_3_LEVEL_6 ? SPECIES_CHARCADET : SPECIES_ARMAROUGE, \
        .ability = ABILITY_FLASH_FIRE,                                                   \
        IVS(IVs),                                                                        \
        .gender = TRAINER_MON_MALE,                                                      \
        }                                                                                \
...
{                                                                                        \
    ...
    .party = (const struct TrainerMon[]) {                                               \
        ...
        {                                                                                \
        .lvl = AceLevel,                                                                 \
        .species = AceLevel < REMATCH_3_LEVEL_6 ? SPECIES_CHARCADET : SPECIES_CERULEDGE, \
        .ability = ABILITY_FLASH_FIRE,                                                   \
        IVS(IVs),                                                                        \
        .gender = TRAINER_MON_FEMALE,                                                    \
        }                                                                                \
...
#define MR_BUN(Level)                                            \
    ...
    .ability = ABILITY_HUGE_POWER,                               \
    .gender = TRAINER_MON_MALE,                                  \
    .nickname = COMPOUND_STRING("Mr. Bun")

#define MR_SKUN(Level)                                                        \
    RICH_BOY_MON(Level),                                                      \
    .species = Level < REMATCH_3_LEVEL_6 ? SPECIES_STUNKY : SPECIES_SKUNTANK, \
    .ability = ABILITY_AFTERMATH,                                             \
    .gender = TRAINER_MON_MALE,                                               \
    .nickname = COMPOUND_STRING("Mr. Skun")

#define MR_STUN(Level)          \
    RICH_BOY_MON(Level),        \
    .species = Level < REMATCH_4_LEVEL_6 ? SPECIES_PAWMI : (Level < REMATCH_5_LEVEL_6 ? SPECIES_PAWMO : SPECIES_PAWMOT), \
    .gender = TRAINER_MON_MALE, \
    .nickname = COMPOUND_STRING("Mr. Stun")
...
#define MR_RUN(Level)                                                             \
    ...
    .ability = ABILITY_SHEER_FORCE,                                                \
    .gender = TRAINER_MON_MALE,                                                   \
    .nickname = COMPOUND_STRING("Mr. Run")
...
[DIFFICULTY_NORMAL][TRAINER_WINSTON_2] =
{
    ...
    .party = (const struct TrainerMon[]) {
        {
        MR_SKUN(REMATCH_2_LEVEL_2),
        },
        {
        MR_BUN(REMATCH_2_LEVEL_1),
        }
    },
},
...
[DIFFICULTY_NORMAL][TRAINER_WINSTON_3] =
{
    ...
    .party = (const struct TrainerMon[]) {
        {
        MR_STUN(REMATCH_3_LEVEL_2),
        },
        {
        MR_SKUN(REMATCH_3_LEVEL_2),
        },
        {
        MR_BUN(REMATCH_3_LEVEL_1),
        }
    },
},
...
[DIFFICULTY_NORMAL][TRAINER_WINSTON_4] =
{
    ...
    .party = (const struct TrainerMon[]) {
        {
        MR_RUN(REMATCH_4_LEVEL_2),
        },
        {
        MR_STUN(REMATCH_4_LEVEL_2),
        },
        {
        MR_SKUN(REMATCH_4_LEVEL_2),
        },
        {
        MR_BUN(REMATCH_4_LEVEL_1),
        }
    },
},
...
[DIFFICULTY_NORMAL][TRAINER_WINSTON_5] =
{
    ...
    .party = (const struct TrainerMon[]) {
        {
        MR_RUN(REMATCH_5_LEVEL_2),
        IVS(24),
        .moves = {MOVE_RAGING_BULL, MOVE_ZEN_HEADBUTT, MOVE_IRON_HEAD, MOVE_STOMPING_TANTRUM},
        },
        {
        MR_STUN(REMATCH_5_LEVEL_2),
        IVS(24),
        .moves = {MOVE_THUNDER_PUNCH, MOVE_DRAIN_PUNCH, MOVE_THUNDER_WAVE, MOVE_REVIVAL_BLESSING},
        },
        {
        MR_SKUN(REMATCH_5_LEVEL_2),
        IVS(24),
        .moves = {MOVE_POISON_JAB, MOVE_CRUNCH, MOVE_FLAMETHROWER, MOVE_TOXIC},
        },
        {
        MR_BUN(REMATCH_5_MINI_BOSS),
        PERFECT_IVS,
        .moves = {MOVE_BODY_SLAM, MOVE_EARTHQUAKE, MOVE_BOUNCE, MOVE_SWORDS_DANCE},
        }
    },
},
...
#define JAMES_VENONAT(Level)                                    \
    .lvl = Level,                                               \
    .species = Level < 31 ? SPECIES_VENONAT : SPECIES_VENOMOTH, \
    .gender = TRAINER_MON_MALE

#define JAMES_LEDIAN(Level) \
    .lvl = Level,             \
    .species = Level < REMATCH_3_LEVEL_6 ? SPECIES_LEDYBA : SPECIES_LEDIAN, \
    .gender = TRAINER_MON_MALE

#define JAMES_SEWADDLE(Level) \
    .lvl = Level,             \
    .species = Level < REMATCH_4_LEVEL_6 ? SPECIES_SEWADDLE : (Level < REMATCH_5_LEVEL_6 ? SPECIES_SWADLOON : SPECIES_LEAVANNY), \
    .gender = TRAINER_MON_FEMALE
...
[DIFFICULTY_NORMAL][TRAINER_JAMES_2] =
{
    ...
    .party = (const struct TrainerMon[]) {
        {
        JAMES_LEDIAN(REMATCH_2_LEVEL_2),
        IVS(2),
        },
        {
        JAMES_VENONAT(REMATCH_2_LEVEL_2),
        IVS(2),
        }
    },
},
...
[DIFFICULTY_NORMAL][TRAINER_JAMES_3] =
{
    ...
    .party = (const struct TrainerMon[]) {
        {
        JAMES_SEWADDLE(REMATCH_3_LEVEL_3),
        IVS(3),
        },
        {
        JAMES_LEDIAN(REMATCH_3_LEVEL_3),
        IVS(3),
        },
        {
        JAMES_VENONAT(REMATCH_3_LEVEL_3),
        IVS(3),
        }
    },
},
...
[DIFFICULTY_NORMAL][TRAINER_JAMES_4] =
{
    ...
    .party = (const struct TrainerMon[]) {
        ...
        {
        JAMES_SEWADDLE(REMATCH_4_LEVEL_4),
        IVS(4),
        },
        {
        JAMES_LEDIAN(REMATCH_4_LEVEL_4),
        IVS(4),
        },
        {
        JAMES_VENONAT(REMATCH_4_LEVEL_4),
        IVS(4),
        }
    },
},
...
[DIFFICULTY_NORMAL][TRAINER_JAMES_5] =
{
    ...
    .party = (const struct TrainerMon[]) {
        ...
        {
        JAMES_SEWADDLE(REMATCH_5_LEVEL_5),
        IVS(5),
        },
        {
        JAMES_LEDIAN(REMATCH_5_LEVEL_5),
        IVS(5),
        },
        {
        JAMES_VENONAT(REMATCH_5_LEVEL_5),
        IVS(5),
        }
    },
},
...
[DIFFICULTY_NORMAL][TRAINER_CINDY_2] =
{
    ...
    .party = (const struct TrainerMon[]) {
        {
        CINDY_SKWOVET(REMATCH_2_LEVEL_1),
        IVS(2),
        }
    },
},
...
[DIFFICULTY_NORMAL][TRAINER_CINDY_3] =
{
    ...
    .party = (const struct TrainerMon[]) {
        {
        CINDY_SKWOVET(REMATCH_3_LEVEL_1),
        IVS(3),
        }
    },
},
...
[DIFFICULTY_NORMAL][TRAINER_CINDY_4] =
{
    ...
    .party = (const struct TrainerMon[]) {
        {
        CINDY_SKWOVET(REMATCH_4_LEVEL_1),
        IVS(4),
        }
    },
},
...
[DIFFICULTY_NORMAL][TRAINER_CINDY_5] =
{
    ...
    .party = (const struct TrainerMon[]) {
        {
        CINDY_SKWOVET(REMATCH_5_LEVEL_1),
        IVS(5),
        .moves = {MOVE_BODY_SLAM, MOVE_SEED_BOMB, MOVE_CRUNCH, MOVE_TAIL_SLAP},
        }
    },
},
...
#define HALEY_BOUNSWEET(Level) \
    .lvl = Level,              \
    .species = Level < REMATCH_4_LEVEL_6 ? SPECIES_BOUNSWEET : (Level < REMATCH_5_LEVEL_6 ? SPECIES_STEENEE : SPECIES_TSAREENA), \
    .ability = 1,              \
    .gender = TRAINER_MON_FEMALE
...
[DIFFICULTY_NORMAL][TRAINER_HALEY_2] =
{
    ...
    .party = (const struct TrainerMon[]) {
        {
        HALEY_BOUNSWEET(REMATCH_2_LEVEL_3),
        IVS(2),
        },
        {
...
[DIFFICULTY_NORMAL][TRAINER_HALEY_3] =
{
    ...
    .party = (const struct TrainerMon[]) {
        {
        HALEY_BOUNSWEET(REMATCH_3_LEVEL_3),
        IVS(3),
        },
        {
...
[DIFFICULTY_NORMAL][TRAINER_HALEY_4] =
{
    ...
    .party = (const struct TrainerMon[]) {
        {
        HALEY_BOUNSWEET(REMATCH_4_LEVEL_3),
        IVS(4),
        },
        {
...
[DIFFICULTY_NORMAL][TRAINER_HALEY_5] =
{
    ...
    .party = (const struct TrainerMon[]) {
        {
        HALEY_BOUNSWEET(REMATCH_5_LEVEL_3),
        IVS(5),
        },
        {
...
#define JERRY_MIME_JR(Level)                                                 \
    .lvl = Level,                                                            \
    .species = Level < REMATCH_4_LEVEL_6 ? SPECIES_MIME_JR: SPECIES_MR_MIME, \
...
[DIFFICULTY_NORMAL][TRAINER_JERRY_3] =
{
    ...
    .party = (const struct TrainerMon[]) {
        {
        JERRY_MIME_JR(REMATCH_3_LEVEL_3),
        IVS(3),
        },
        {
...
[DIFFICULTY_NORMAL][TRAINER_JERRY_4] =
{
    ...
    .party = (const struct TrainerMon[]) {
        {
        JERRY_MIME_JR(REMATCH_4_LEVEL_3),
        IVS(4),
        },
        {
...
[DIFFICULTY_NORMAL][TRAINER_JERRY_5] =
{
    ...
    .party = (const struct TrainerMon[]) {
        {
        JERRY_MIME_JR(REMATCH_5_LEVEL_3),
        IVS(5),
        },
        {
...
#define KAREN_AIPOM(Level)                                                  \
    .lvl = Level,                                                           \
    .species = Level < REMATCH_4_LEVEL_6 ? SPECIES_AIPOM : SPECIES_AMBIPOM, \
    .ability = 0,                                                           \
    .gender = TRAINER_MON_FEMALE
...
#define DALTON_TOXTRICITY(Level)                                \
    .lvl = Level,                                               \
...
[DIFFICULTY_NORMAL][TRAINER_DALTON_2] =
{
    ...
    .party = (const struct TrainerMon[]) {
        ...
        {
        DALTON_TOXTRICITY(REMATCH_2_LEVEL_3),
        IVS(2),
        }
    },
},
...
[DIFFICULTY_NORMAL][TRAINER_DALTON_3] =
{
    ...
    .party = (const struct TrainerMon[]) {
        ...
        {
        DALTON_TOXTRICITY(REMATCH_3_LEVEL_3),
        IVS(3),
        }
    },
},
...
[DIFFICULTY_NORMAL][TRAINER_DALTON_4] =
{
    ...
    .party = (const struct TrainerMon[]) {
        ...
        {
        DALTON_TOXTRICITY(REMATCH_4_LEVEL_3),
        IVS(4),
        }
    },
},
...
[DIFFICULTY_NORMAL][TRAINER_DALTON_5] =
{
    ...
    .party = (const struct TrainerMon[]) {
        ...
        {
        DALTON_TOXTRICITY(REMATCH_5_LEVEL_3),
        IVS(5),
        }
    },
},
...
[DIFFICULTY_NORMAL][TRAINER_ABIGAIL_2] =
{
    ...
    .party = (const struct TrainerMon[]) {
        {
        ABIGAIL_ROTOM(REMATCH_2_LEVEL_2, 2),
        },
        {
...
[DIFFICULTY_NORMAL][TRAINER_ABIGAIL_3] =
{
    ...
    .party = (const struct TrainerMon[]) {
        ...
        {
        ABIGAIL_ROTOM(REMATCH_3_LEVEL_3, 3),
        },
        {
...
[DIFFICULTY_NORMAL][TRAINER_ABIGAIL_4] =
{
    ...
    .party = (const struct TrainerMon[]) {
        ...
        {
        ABIGAIL_ROTOM(REMATCH_4_LEVEL_3, 4),
        },
        {
...
[DIFFICULTY_NORMAL][TRAINER_ABIGAIL_5] =
{
    ...
    .party = (const struct TrainerMon[]) {
        ...
        {
        ABIGAIL_ROTOM(REMATCH_5_LEVEL_3, 5),
        },
        {
...
#define BENJAMIN_JOLTEON(Level, IV) \
    TRIATHLETE_MON(Level, IV),      \
...
[DIFFICULTY_NORMAL][TRAINER_BENJAMIN_2] =
{
    ...
    .party = (const struct TrainerMon[]) {
        {
        BENJAMIN_JOLTEON(REMATCH_2_LEVEL_2, 2),
        },
        {
...
[DIFFICULTY_NORMAL][TRAINER_BENJAMIN_3] =
{
    ...
    .party = (const struct TrainerMon[]) {
        ...
        {
        BENJAMIN_JOLTEON(REMATCH_3_LEVEL_3, 3),
        },
        {
...
[DIFFICULTY_NORMAL][TRAINER_BENJAMIN_4] =
{
    ...
    .party = (const struct TrainerMon[]) {
        ...
        {
        BENJAMIN_JOLTEON(REMATCH_4_LEVEL_3, 4),
        },
        {
...
[DIFFICULTY_NORMAL][TRAINER_BENJAMIN_5] =
{
    ...
    .party = (const struct TrainerMon[]) {
        ...
        {
        BENJAMIN_JOLTEON(REMATCH_5_LEVEL_3, 5),
        },
        {
...
#define WILTON_BOUFFALANT(Level)   \
    .lvl = Level,                  \
...
[DIFFICULTY_NORMAL][TRAINER_WILTON_2] =
{
    ...
    .party = (const struct TrainerMon[]) {
        {
        WILTON_BOUFFALANT(REMATCH_2_LEVEL_3),
        IVS(13),
        },
        {
...
[DIFFICULTY_NORMAL][TRAINER_WILTON_3] =
{
    ...
    .party = (const struct TrainerMon[]) {
        {
        WILTON_BOUFFALANT(REMATCH_3_LEVEL_3),
        IVS(14),
        },
        {
...
[DIFFICULTY_NORMAL][TRAINER_WILTON_4] =
{
    ...
    .party = (const struct TrainerMon[]) {
        {
        WILTON_BOUFFALANT(REMATCH_4_LEVEL_3),
        IVS(15),
        },
        {
...
[DIFFICULTY_NORMAL][TRAINER_WILTON_5] =
{
    ...
    .party = (const struct TrainerMon[]) {
        {
        WILTON_BOUFFALANT(REMATCH_5_LEVEL_3),
        IVS(17),
        },
        {
...
#define BROOKE_PONYTA(Level)                                   \
    .lvl = Level,                                              \
    .species = Level < 40 ? SPECIES_PONYTA : SPECIES_RAPIDASH, \
    .ability = ABILITY_FLASH_FIRE,                             \
    .gender = TRAINER_MON_FEMALE

#define BROOKE_DEWPIDER(Level)                                                   \
    .lvl = Level,                                                                \
    .species = Level < REMATCH_2_LEVEL_6 ? SPECIES_DEWPIDER : SPECIES_ARAQUANID, \
    .ability = ABILITY_WATER_BUBBLE,                                             \
    .gender = TRAINER_MON_FEMALE
...
[DIFFICULTY_NORMAL][TRAINER_BROOKE_2] =
{
    ...
    .party = (const struct TrainerMon[]) {
        {
        BROOKE_DEWPIDER(REMATCH_2_LEVEL_3),
        IVS(13),
        },
        {
        BROOKE_PONYTA(REMATCH_2_LEVEL_3),
        IVS(13),
        },
        {
...
[DIFFICULTY_NORMAL][TRAINER_BROOKE_3] =
{
    ...
    .party = (const struct TrainerMon[]) {
        {
        BROOKE_DEWPIDER(REMATCH_3_LEVEL_3),
        IVS(14),
        },
        {
        BROOKE_PONYTA(REMATCH_3_LEVEL_3),
        IVS(14),
        },
        {
...
[DIFFICULTY_NORMAL][TRAINER_BROOKE_4] =
{
    ...
    .party = (const struct TrainerMon[]) {
        {
        BROOKE_DEWPIDER(REMATCH_4_LEVEL_3),
        IVS(15),
        },
        {
        BROOKE_PONYTA(REMATCH_4_LEVEL_3),
        IVS(15),
        },
        {
...
[DIFFICULTY_NORMAL][TRAINER_BROOKE_5] =
{
    ...
    .party = (const struct TrainerMon[]) {
        {
        BROOKE_DEWPIDER(REMATCH_5_LEVEL_3),
        IVS(17),
        },
        {
        BROOKE_PONYTA(REMATCH_5_LEVEL_3),
        IVS(17),
        },
        {
...
[DIFFICULTY_NORMAL][TRAINER_MADELINE_5] =
{
    ...
    .party = (const struct TrainerMon[]) {
        ...
        .species = SPECIES_SUNFLORA,
        IVS(5),
        .moves = {MOVE_GIGA_DRAIN, MOVE_SOLAR_BEAM, MOVE_MORNING_SUN, MOVE_SUNNY_DAY}
        },
        {
...
#define LAO_STUNKY(Level)                                      \
    .lvl = Level,                                              \
    .species = Level < 34 ? SPECIES_STUNKY : SPECIES_SKUNTANK, \
    .ability = ABILITY_AFTERMATH,                              \
    .gender = TRAINER_MON_MALE,                                \
    .moves = {Level < 48 ? MOVE_POISON_FANG : MOVE_POISON_JAB, Level < 48 ? MOVE_BITE : MOVE_CRUNCH, MOVE_SMOKESCREEN, MOVE_POISON_GAS}
...
#define LAO_ACCELGOR(Level)      \
    .lvl = Level,                \
    .species = SPECIES_ACCELGOR, \
    .ability = ABILITY_DRY_SKIN, \
    .gender = TRAINER_MON_MALE,  \
    .moves = {MOVE_SIGNAL_BEAM, MOVE_WATER_SHURIKEN, MOVE_GIGA_DRAIN, MOVE_DOUBLE_TEAM}
...
[DIFFICULTY_NORMAL][TRAINER_LAO_2] =
{
    ...
    .party = (const struct TrainerMon[]) {
        {
        LAO_ACCELGOR(REMATCH_2_LEVEL_4),
        },
        {
        LAO_TORKOAL(REMATCH_2_LEVEL_4),
        },
        {
        LAO_STUNKY(REMATCH_2_LEVEL_4),
        },
        {
...
[DIFFICULTY_NORMAL][TRAINER_LAO_3] =
{
    ...
    .party = (const struct TrainerMon[]) {
        {
        LAO_ACCELGOR(REMATCH_3_LEVEL_4),
        IVS(3),
        },
        {
...
[DIFFICULTY_NORMAL][TRAINER_LAO_4] =
{
    ...
    .party = (const struct TrainerMon[]) {
        {
        LAO_ACCELGOR(REMATCH_4_LEVEL_4),
        IVS(3),
        },
        {
...
[DIFFICULTY_NORMAL][TRAINER_LAO_5] =
{
    ...
    .party = (const struct TrainerMon[]) {
        {
        LAO_ACCELGOR(REMATCH_5_LEVEL_4),
        IVS(4),
        },
        {
...
[DIFFICULTY_NORMAL][TRAINER_ETHAN_2] =
{
    ...
    .party = (const struct TrainerMon[]) {
        {
        ETHAN_DIGGERSBY(REMATCH_2_LEVEL_3),
        IVS(2),
        },
        {
...
[DIFFICULTY_NORMAL][TRAINER_ETHAN_3] =
{
    ...
    .party = (const struct TrainerMon[]) {
        ...
        {
        ETHAN_DIGGERSBY(REMATCH_3_LEVEL_4),
        IVS(3),
        },
        {
...
[DIFFICULTY_NORMAL][TRAINER_ETHAN_4] =
{
    ...
    .party = (const struct TrainerMon[]) {
        ...
        {
        ETHAN_DIGGERSBY(REMATCH_4_LEVEL_5),
        IVS(4),
        },
        {
        ...
        {
        ETHAN_STUNKY(REMATCH_4_LEVEL_5),
        IVS(4),
        }
    },
},
...
[DIFFICULTY_NORMAL][TRAINER_ETHAN_5] =
{
    ...
    .party = (const struct TrainerMon[]) {
        ...
        {
        ETHAN_DIGGERSBY(REMATCH_5_LEVEL_5),
        IVS(5),
        },
        {
        ...
        {
        ETHAN_STUNKY(REMATCH_5_LEVEL_5),
        IVS(5),
        }
    },
},
...
#define TONY_DEWPIDER(Level)                                                     \
    .lvl = Level,                                                                \
    .species = Level < REMATCH_4_LEVEL_6 ? SPECIES_DEWPIDER : SPECIES_ARAQUANID, \
...
[DIFFICULTY_NORMAL][TRAINER_TONY_3] =
{
    ...
    .party = (const struct TrainerMon[]) {
        {
        TONY_DEWPIDER(REMATCH_3_LEVEL_2),
        IVS(3),
        },
        {
...
[DIFFICULTY_NORMAL][TRAINER_TONY_4] =
{
    ...
    .party = (const struct TrainerMon[]) {
        {
        TONY_DEWPIDER(REMATCH_4_LEVEL_2),
        IVS(4),
        },
        {
...
[DIFFICULTY_NORMAL][TRAINER_TONY_5] =
{
    ...
    .party = (const struct TrainerMon[]) {
        {
        TONY_DEWPIDER(REMATCH_5_LEVEL_2),
        IVS(5),
        },
        {
...
#define THALIA_TOGEPI(Level)         \
    .lvl = Level,                    \
    .species = Level < REMATCH_2_LEVEL_2 ? SPECIES_TOGEPI : (Level < REMATCH_4_LEVEL_6 ? SPECIES_TOGETIC : SPECIES_TOGEKISS), \
    .ability = ABILITY_SERENE_GRACE, \
    .gender = TRAINER_MON_FEMALE
...
[DIFFICULTY_NORMAL][TRAINER_THALIA_2] =
{
    ...
    .party = (const struct TrainerMon[]) {
        ...
        {
        THALIA_TOGEPI(REMATCH_2_LEVEL_2),
        IVS(1),
        }
    },
},
...
[DIFFICULTY_NORMAL][TRAINER_THALIA_3] =
{
    ...
    .party = (const struct TrainerMon[]) {
        {
        THALIA_MILOTIC(REMATCH_3_LEVEL_3),
        IVS(3),
        },
        {
        ...
        {
        THALIA_TOGEPI(REMATCH_3_LEVEL_3),
        IVS(3),
        }
    },
},
...
[DIFFICULTY_NORMAL][TRAINER_THALIA_4] =
{
    ...
    .party = (const struct TrainerMon[]) {
        {
        THALIA_MILOTIC(REMATCH_4_LEVEL_3),
        IVS(4),
        },
        {
        ...
        {
        THALIA_TOGEPI(REMATCH_4_LEVEL_3),
        IVS(4),
        }
    },
},
...
[DIFFICULTY_NORMAL][TRAINER_THALIA_5] =
{
    ...
    .party = (const struct TrainerMon[]) {
        {
        THALIA_MILOTIC(REMATCH_5_LEVEL_3),
        IVS(5),
        },
        {
        ...
        {
        THALIA_TOGEPI(REMATCH_5_LEVEL_3),
        IVS(5),
        }
    },
},
...
#define KIRA_CLEFFA(Level) \
    .lvl = Level,          \
    .species = Level < REMATCH_2_LEVEL_2 ? SPECIES_CLEFFA : (Level < REMATCH_4_LEVEL_6 ? SPECIES_CLEFAIRY : SPECIES_CLEFABLE), \
    .ability = ABILITY_CUTE_CHARM

#define DAN_GOOMY(Level) \
    .lvl = Level,        \
    .species = Level < REMATCH_2_LEVEL_2 ? SPECIES_GOOMY : (Level < REMATCH_4_LEVEL_6 ? SPECIES_SLIGGOO : SPECIES_GOODRA), \
    .ability = ABILITY_SAP_SIPPER
...
[DIFFICULTY_NORMAL][TRAINER_KIRA_AND_DAN_2] =
{
    ...
    .party = (const struct TrainerMon[]) {
        {
        DAN_GOOMY(REMATCH_2_LEVEL_2),
        IVS(1),
        },
        {
        KIRA_CLEFFA(REMATCH_2_LEVEL_2),
        IVS(1),
        }
    },
},
...
[DIFFICULTY_NORMAL][TRAINER_KIRA_AND_DAN_3] =
{
    ...
    .party = (const struct TrainerMon[]) {
        {
        DAN_GOOMY(REMATCH_3_LEVEL_2),
        IVS(3),
        },
        {
        KIRA_CLEFFA(REMATCH_3_LEVEL_2),
        IVS(3),
        }
    },
},
...
[DIFFICULTY_NORMAL][TRAINER_KIRA_AND_DAN_4] =
{
    ...
    .party = (const struct TrainerMon[]) {
        {
        DAN_GOOMY(REMATCH_4_LEVEL_2),
        IVS(4),
        },
        {
        KIRA_CLEFFA(REMATCH_4_LEVEL_2),
        IVS(4),
        }
    },
},
...
[DIFFICULTY_NORMAL][TRAINER_KIRA_AND_DAN_5] =
{
    ...
    .party = (const struct TrainerMon[]) {
        {
        DAN_GOOMY(REMATCH_5_LEVEL_2),
        IVS(5),
        },
        {
        KIRA_CLEFFA(REMATCH_5_LEVEL_2),
        IVS(5),
        }
    },
},
...
#define JACKSON_ROWLET(Level)  \
    .lvl = Level,              \
    .species = Level < REMATCH_2_LEVEL_1 ? SPECIES_ROWLET : (Level < REMATCH_4_LEVEL_6 ? SPECIES_DARTRIX : SPECIES_DECIDUEYE), \
    IVS(10),                   \
    .gender = TRAINER_MON_MALE
...
[DIFFICULTY_NORMAL][TRAINER_JACKSON_2] =
{
    ...
    .party = (const struct TrainerMon[]) {
        {
        JACKSON_ROWLET(REMATCH_2_LEVEL_1),
        },
        {
...
[DIFFICULTY_NORMAL][TRAINER_JACKSON_3] =
{
    ...
    .party = (const struct TrainerMon[]) {
        ...
        {
        JACKSON_ROWLET(REMATCH_3_LEVEL_1),
        },
        {
...
[DIFFICULTY_NORMAL][TRAINER_JACKSON_4] =
{
    ...
    .party = (const struct TrainerMon[]) {
        ...
        {
        JACKSON_ROWLET(REMATCH_4_LEVEL_1),
        },
        {
...
[DIFFICULTY_NORMAL][TRAINER_JACKSON_5] =
{
    ...
    .party = (const struct TrainerMon[]) {
        ...
        {
        JACKSON_ROWLET(REMATCH_5_MINI_BOSS),
        },
        {
...
AQUA_HIDEOUT_GRUNT(3, M, PRINPLUP, LOMBRE),
