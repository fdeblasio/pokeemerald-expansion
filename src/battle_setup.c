...
{
    REMATCH(ROSE, ROUTE118),
    REMATCH(ANDRES, ROUTE105),
    REMATCH(DUSTY, ROUTE111),
    REMATCH(LOLA, ROUTE109),
    REMATCH(RICKY, ROUTE109),
    REMATCH(LILA_AND_ROY, ROUTE124),
    REMATCH(CRISTIN, ROUTE121),
    REMATCH(BROOKE, ROUTE111),
    REMATCH(WILTON, ROUTE111),
    REMATCH(VALERIE, MT_PYRE_6F),
    REMATCH(CINDY, ROUTE104),
    REMATCH(THALIA, ABANDONED_SHIP_ROOMS_1F),
    REMATCH(JESSICA, ROUTE121),
    REMATCH(WINSTON, ROUTE104),
    REMATCH(STEVE, ROUTE114),
    REMATCH(TONY, ROUTE107),
    REMATCH(NOB, ROUTE115),
    REMATCH(KOJI, ROUTE127),
    REMATCH(FERNANDO, ROUTE123),
    REMATCH(DALTON, ROUTE118),
    REMATCH(BERNIE, ROUTE114),
    REMATCH(ETHAN, JAGGED_PASS),
    REMATCH(JOHN_AND_JAY, METEOR_FALLS_1F_2R),
    REMATCH(JEFFREY, ROUTE120),
    REMATCH(CAMERON, ROUTE123),
    REMATCH(JACKI, ROUTE123),
    REMATCH(WALTER, ROUTE121),
    REMATCH(KAREN, ROUTE116),
    REMATCH(JERRY, ROUTE116),
    REMATCH(ANNA_AND_MEG, ROUTE117),
    REMATCH(ISABEL, ROUTE110),
    REMATCH(MIGUEL, ROUTE103),
    REMATCH(TIMOTHY, ROUTE115),
    REMATCH(SHELBY, MT_CHIMNEY),
    REMATCH(CALVIN, ROUTE102),
    REMATCH(ELLIOT, ROUTE106),
    REMATCH(ISAIAH, ROUTE128),
    REMATCH(MARIA, ROUTE117),
    REMATCH(ABIGAIL, ROUTE110),
    REMATCH(DYLAN, ROUTE117),
    REMATCH(KATELYN, ROUTE128),
    REMATCH(BENJAMIN, ROUTE110),
    REMATCH(PABLO, ROUTE126),
    REMATCH(NICOLAS, METEOR_FALLS_1F_2R),
    REMATCH(ROBERT, ROUTE120),
    REMATCH(LAO, ROUTE113),
    REMATCH(CYNDY, ROUTE115),
    REMATCH(MADELINE, ROUTE113),
    REMATCH(JENNY, ROUTE124),
    REMATCH(DIANA, JAGGED_PASS),
    REMATCH(AMY_AND_LIV, ROUTE103),
    REMATCH(ERNEST, ROUTE125),
    REMATCH(CORY, ROUTE108),
    REMATCH(EDWIN, ROUTE110),
    REMATCH(LYDIA, ROUTE117),
    REMATCH(ISAAC, ROUTE117),
    REMATCH(GABRIELLE, MT_PYRE_3F),
    REMATCH(CATHERINE, ROUTE119),
    REMATCH(JACKSON, ROUTE119),
    REMATCH(HALEY, ROUTE104),
    REMATCH(JAMES, PETALBURG_WOODS),
    ...
    REMATCH_GYM_LEADER(ROXANNE, RUSTBORO_CITY),
    REMATCH_GYM_LEADER(BRAWLY, DEWFORD_TOWN),
    REMATCH_GYM_LEADER(WATTSON, MAUVILLE_CITY),
    REMATCH_GYM_LEADER(FLANNERY, LAVARIDGE_TOWN),
    REMATCH_GYM_LEADER(NORMAN, PETALBURG_CITY),
    REMATCH_GYM_LEADER(WINONA, FORTREE_CITY),
    REMATCH_GYM_LEADER(TATE_AND_LIZA, MOSSDEEP_CITY),
    REMATCH_GYM_LEADER(JUAN, SOOTOPOLIS_CITY),
    REMATCH_E4(SIDNEY, EVER_GRANDE_CITY),
    REMATCH_E4(PHOEBE, EVER_GRANDE_CITY),
    REMATCH_E4(GLACIA, EVER_GRANDE_CITY),
    REMATCH_E4(DRAKE, EVER_GRANDE_CITY),
    REMATCH_E4(WALLACE, EVER_GRANDE_CITY),
};
