                                    ...
                                    [0] =
                                        {
                                            ...
                                            .hpEV = EV_SPLIT_SIX,
                                            .attackEV = EV_SPLIT_SIX,
                                            .defenseEV = EV_SPLIT_SIX,
                                            .speedEV = EV_SPLIT_SIX,
                                            .spAttackEV = EV_SPLIT_SIX,
                                            .spDefenseEV = EV_SPLIT_SIX,
                                            .otId = TRAINER_HILL_OTID,
                                            .hpIV = 5,
                                            .attackIV = 5,
                                            .defenseIV = 5,
