...
static const u16 sPyramidPickupItems[TOTAL_PYRAMID_ROUNDS][PICKUP_ITEMS_PER_ROUND] =
{
    {ITEM_HYPER_POTION, ITEM_LUM_BERRY, ITEM_ELIXIR, ITEM_REVIVE, ITEM_LEFTOVERS,  ITEM_SCOPE_LENS, ITEM_BRIGHT_POWDER, ITEM_ASSAULT_VEST, ITEM_FULL_RESTORE, ITEM_SACRED_ASH},
    {ITEM_HYPER_POTION, ITEM_LUM_BERRY, ITEM_ELIXIR, ITEM_REVIVE, ITEM_SHELL_BELL, ITEM_KINGS_ROCK, ITEM_QUICK_CLAW,    ITEM_ROCKY_HELMET, ITEM_FULL_RESTORE, ITEM_SACRED_ASH},
    {ITEM_HYPER_POTION, ITEM_LUM_BERRY, ITEM_ELIXIR, ITEM_REVIVE, ITEM_LEFTOVERS,  ITEM_SCOPE_LENS, ITEM_BRIGHT_POWDER, ITEM_ASSAULT_VEST, ITEM_FULL_RESTORE, ITEM_SACRED_ASH},
    {ITEM_HYPER_POTION, ITEM_LUM_BERRY, ITEM_ELIXIR, ITEM_REVIVE, ITEM_SHELL_BELL, ITEM_KINGS_ROCK, ITEM_QUICK_CLAW,    ITEM_ROCKY_HELMET, ITEM_FULL_RESTORE, ITEM_SACRED_ASH},
    {ITEM_HYPER_POTION, ITEM_LUM_BERRY, ITEM_ELIXIR, ITEM_REVIVE, ITEM_LEFTOVERS,  ITEM_SCOPE_LENS, ITEM_BRIGHT_POWDER, ITEM_ASSAULT_VEST, ITEM_FULL_RESTORE, ITEM_SACRED_ASH},
    {ITEM_HYPER_POTION, ITEM_LUM_BERRY, ITEM_ELIXIR, ITEM_REVIVE, ITEM_SHELL_BELL, ITEM_KINGS_ROCK, ITEM_QUICK_CLAW,    ITEM_ROCKY_HELMET, ITEM_FULL_RESTORE, ITEM_SACRED_ASH},
...
static const u8 sItemPercentages[PICKUP_ITEMS_PER_ROUND] = {30, 45, 60, 70, 75, 80, 85, 90, 95, 100};

#define PYRAMID_ENCOUNTER_MUSIC(class, music) {TRAINER_CLASS_##class, TRAINER_ENCOUNTER_MUSIC_##music}

static const struct PyramidTrainerEncounterMusic sTrainerClassEncounterMusic[54] =
{
    PYRAMID_ENCOUNTER_MUSIC(TEAM_AQUA, AQUA),
    PYRAMID_ENCOUNTER_MUSIC(AQUA_ADMIN, AQUA),
    PYRAMID_ENCOUNTER_MUSIC(AQUA_LEADER, AQUA),
    PYRAMID_ENCOUNTER_MUSIC(AROMA_LADY, FEMALE),
    PYRAMID_ENCOUNTER_MUSIC(BATTLE_GIRL, INTENSE),
    PYRAMID_ENCOUNTER_MUSIC(SWIMMER, FEMALE),
    PYRAMID_ENCOUNTER_MUSIC(POKE_FAN, TWINS),
    PYRAMID_ENCOUNTER_MUSIC(DRAGON_TAMER, INTENSE),
    PYRAMID_ENCOUNTER_MUSIC(ACE_TRAINER, COOL),
    PYRAMID_ENCOUNTER_MUSIC(GUITARIST, INTENSE),
    PYRAMID_ENCOUNTER_MUSIC(SAILOR, MALE),
    PYRAMID_ENCOUNTER_MUSIC(TWINS, TWINS),
    PYRAMID_ENCOUNTER_MUSIC(INTERVIEWER, INTERVIEWER),
    PYRAMID_ENCOUNTER_MUSIC(RUIN_MANIAC, HIKER),
    PYRAMID_ENCOUNTER_MUSIC(GENTLEMAN, RICH),
    PYRAMID_ENCOUNTER_MUSIC(SWIMMER, FEMALE),
    PYRAMID_ENCOUNTER_MUSIC(POKE_MANIAC, SUSPICIOUS),
    PYRAMID_ENCOUNTER_MUSIC(BLACK_BELT, INTENSE),
    PYRAMID_ENCOUNTER_MUSIC(OLD_COUPLE, INTENSE),
    PYRAMID_ENCOUNTER_MUSIC(BUG_MANIAC, SUSPICIOUS),
    PYRAMID_ENCOUNTER_MUSIC(CAMPER, MALE),
    PYRAMID_ENCOUNTER_MUSIC(KINDLER, HIKER),
    PYRAMID_ENCOUNTER_MUSIC(TEAM_MAGMA, MAGMA),
    PYRAMID_ENCOUNTER_MUSIC(MAGMA_ADMIN, MAGMA),
    PYRAMID_ENCOUNTER_MUSIC(MAGMA_LEADER, MAGMA),
    PYRAMID_ENCOUNTER_MUSIC(LASS, FEMALE),
    PYRAMID_ENCOUNTER_MUSIC(BUG_CATCHER, MALE),
    PYRAMID_ENCOUNTER_MUSIC(NINJA_BOY, SUSPICIOUS),
    PYRAMID_ENCOUNTER_MUSIC(RICH_BOY, RICH),
    PYRAMID_ENCOUNTER_MUSIC(HEX_MANIAC, SUSPICIOUS),
    PYRAMID_ENCOUNTER_MUSIC(BEAUTY, FEMALE),
    PYRAMID_ENCOUNTER_MUSIC(LADY, FEMALE),
    PYRAMID_ENCOUNTER_MUSIC(PARASOL_LADY, FEMALE),
    PYRAMID_ENCOUNTER_MUSIC(PICNICKER, GIRL),
    PYRAMID_ENCOUNTER_MUSIC(PKMN_BREEDER, FEMALE),
    PYRAMID_ENCOUNTER_MUSIC(COLLECTOR, SUSPICIOUS),
    PYRAMID_ENCOUNTER_MUSIC(PKMN_RANGER, COOL),
    PYRAMID_ENCOUNTER_MUSIC(RIVAL, MALE),
    PYRAMID_ENCOUNTER_MUSIC(YOUNG_COUPLE, GIRL),
    PYRAMID_ENCOUNTER_MUSIC(PSYCHIC, INTENSE),
    PYRAMID_ENCOUNTER_MUSIC(TEAMMATES, TWINS),
    PYRAMID_ENCOUNTER_MUSIC(ELITE_FOUR, FEMALE),
    PYRAMID_ENCOUNTER_MUSIC(YOUNGSTER, MALE),
    PYRAMID_ENCOUNTER_MUSIC(EXPERT, INTENSE),
    PYRAMID_ENCOUNTER_MUSIC(TRIATHLETE, MALE),
    PYRAMID_ENCOUNTER_MUSIC(BIRD_KEEPER, COOL),
    PYRAMID_ENCOUNTER_MUSIC(FISHERMAN, HIKER),
    PYRAMID_ENCOUNTER_MUSIC(CHAMPION, MALE),
    PYRAMID_ENCOUNTER_MUSIC(TUBER, MALE),
    PYRAMID_ENCOUNTER_MUSIC(TUBER, GIRL),
    PYRAMID_ENCOUNTER_MUSIC(SIS_AND_BRO, SWIMMER),
    PYRAMID_ENCOUNTER_MUSIC(HIKER, HIKER),
    PYRAMID_ENCOUNTER_MUSIC(LEADER, FEMALE),
    PYRAMID_ENCOUNTER_MUSIC(SCHOOLKID, MALE),
};
...
static const u8 sTrainerTextGroups[50][2] =
{
    ...
    {FACILITY_CLASS_SCHOOLKID_M, 0},
    {FACILITY_CLASS_SCHOOLKID_F, 1},
    {FACILITY_CLASS_POKE_FAN_M, 4},
    {FACILITY_CLASS_POKE_FAN_F, 5},
...
static void SetPickupItem(void)
{
    ...
    for (i = 0; i < ARRAY_COUNT(sItemPercentages); i++)
    {
        if (randVal < sItemPercentages[i])
            break;
    }

    gSpecialVar_0x8000 = sPyramidPickupItems[round][i];
...
static void InitPyramidBagItems(u8 lvlMode)
{
    ...
    AddPyramidBagItem(ITEM_HYPER_POTION, 2);
    AddPyramidBagItem(ITEM_ELIXIR, 2);
}
...
u16 GetBattlePyramidPickupItemId(void)
{
    ...
    return sPyramidPickupItems[round][i];
}
