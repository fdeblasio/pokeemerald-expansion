...
static const u8 *const sHelpBarTexts[HELPBAR_COUNT] =
{
    ...
    [HELPBAR_MAP_ZOOMED_OUT_DEXNAV] = COMPOUND_STRING("{A_BUTTON}Zoom {B_BUTTON}Cancel {L_BUTTON}Wild"),
    [HELPBAR_MAP_ZOOMED_IN_DEXNAV]  = COMPOUND_STRING("{A_BUTTON}Full {B_BUTTON}Cancel {L_BUTTON}Wild"),
