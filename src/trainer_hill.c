...
#define TRAINER_HILL_CLASS_MUSIC(class, music) {TRAINER_CLASS_##class, TRAINER_ENCOUNTER_MUSIC_##music}
...
{
    TRAINER_HILL_CLASS_MUSIC(TEAM_AQUA, AQUA),
    TRAINER_HILL_CLASS_MUSIC(AQUA_ADMIN, AQUA),
    TRAINER_HILL_CLASS_MUSIC(AQUA_LEADER, AQUA),
    TRAINER_HILL_CLASS_MUSIC(AROMA_LADY, FEMALE),
    TRAINER_HILL_CLASS_MUSIC(BATTLE_GIRL, INTENSE),
    TRAINER_HILL_CLASS_MUSIC(SWIMMER, FEMALE),
    TRAINER_HILL_CLASS_MUSIC(POKE_FAN, TWINS),
    TRAINER_HILL_CLASS_MUSIC(DRAGON_TAMER, INTENSE),
    TRAINER_HILL_CLASS_MUSIC(ACE_TRAINER, COOL),
    TRAINER_HILL_CLASS_MUSIC(GUITARIST, INTENSE),
    TRAINER_HILL_CLASS_MUSIC(SAILOR, MALE),
    TRAINER_HILL_CLASS_MUSIC(TWINS, TWINS),
    TRAINER_HILL_CLASS_MUSIC(INTERVIEWER, INTERVIEWER),
    TRAINER_HILL_CLASS_MUSIC(RUIN_MANIAC, HIKER),
    TRAINER_HILL_CLASS_MUSIC(GENTLEMAN, RICH),
    TRAINER_HILL_CLASS_MUSIC(SWIMMER, FEMALE),
    TRAINER_HILL_CLASS_MUSIC(POKE_MANIAC, SUSPICIOUS),
    TRAINER_HILL_CLASS_MUSIC(BLACK_BELT, INTENSE),
    TRAINER_HILL_CLASS_MUSIC(OLD_COUPLE, INTENSE),
    TRAINER_HILL_CLASS_MUSIC(BUG_MANIAC, SUSPICIOUS),
    TRAINER_HILL_CLASS_MUSIC(CAMPER, MALE),
    TRAINER_HILL_CLASS_MUSIC(KINDLER, HIKER),
    TRAINER_HILL_CLASS_MUSIC(TEAM_MAGMA, MAGMA),
    TRAINER_HILL_CLASS_MUSIC(MAGMA_ADMIN, MAGMA),
    TRAINER_HILL_CLASS_MUSIC(MAGMA_LEADER, MAGMA),
    TRAINER_HILL_CLASS_MUSIC(LASS, FEMALE),
    TRAINER_HILL_CLASS_MUSIC(BUG_CATCHER, MALE),
    TRAINER_HILL_CLASS_MUSIC(NINJA_BOY, SUSPICIOUS),
    TRAINER_HILL_CLASS_MUSIC(RICH_BOY, RICH),
    TRAINER_HILL_CLASS_MUSIC(HEX_MANIAC, SUSPICIOUS),
    TRAINER_HILL_CLASS_MUSIC(BEAUTY, FEMALE),
    TRAINER_HILL_CLASS_MUSIC(LADY, FEMALE),
    TRAINER_HILL_CLASS_MUSIC(PARASOL_LADY, FEMALE),
    TRAINER_HILL_CLASS_MUSIC(PICNICKER, GIRL),
    TRAINER_HILL_CLASS_MUSIC(PKMN_BREEDER, FEMALE),
    TRAINER_HILL_CLASS_MUSIC(COLLECTOR, SUSPICIOUS),
    TRAINER_HILL_CLASS_MUSIC(PKMN_RANGER, COOL),
    TRAINER_HILL_CLASS_MUSIC(RIVAL, MALE),
    TRAINER_HILL_CLASS_MUSIC(YOUNG_COUPLE, GIRL),
    TRAINER_HILL_CLASS_MUSIC(PSYCHIC, INTENSE),
    TRAINER_HILL_CLASS_MUSIC(TEAMMATES, TWINS),
    TRAINER_HILL_CLASS_MUSIC(ELITE_FOUR, FEMALE),
    TRAINER_HILL_CLASS_MUSIC(YOUNGSTER, MALE),
    TRAINER_HILL_CLASS_MUSIC(EXPERT, INTENSE),
    TRAINER_HILL_CLASS_MUSIC(TRIATHLETE, MALE),
    TRAINER_HILL_CLASS_MUSIC(BIRD_KEEPER, COOL),
    TRAINER_HILL_CLASS_MUSIC(FISHERMAN, HIKER),
    TRAINER_HILL_CLASS_MUSIC(CHAMPION, MALE),
    TRAINER_HILL_CLASS_MUSIC(TUBER, MALE),
    TRAINER_HILL_CLASS_MUSIC(TUBER, GIRL),
    TRAINER_HILL_CLASS_MUSIC(SIS_AND_BRO, SWIMMER),
    TRAINER_HILL_CLASS_MUSIC(HIKER, HIKER),
    TRAINER_HILL_CLASS_MUSIC(LEADER, FEMALE),
    TRAINER_HILL_CLASS_MUSIC(SCHOOLKID, MALE),
};
...
static const enum Item sPrizeListRoar[]        = {ITEM_ELIXIR,           ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_GREAT_BALL};
static const enum Item sPrizeListSludgeBomb[]  = {ITEM_ELIXIR,           ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_GREAT_BALL};
static const enum Item sPrizeListToxic[]       = {ITEM_ELIXIR,           ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_GREAT_BALL};
static const enum Item sPrizeListSunnyDay[]    = {ITEM_ELIXIR,           ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_GREAT_BALL};
static const enum Item sPrizeListEarthQuake[]  = {ITEM_ELIXIR,           ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_GREAT_BALL};
...
static const enum Item sPrizeListBrickBreak[]  = {ITEM_ELIXIR,           ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_GREAT_BALL};
static const enum Item sPrizeListTorment[]     = {ITEM_ELIXIR,           ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_GREAT_BALL};
static const enum Item sPrizeListSkillSwap[]   = {ITEM_ELIXIR,           ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_GREAT_BALL};
static const enum Item sPrizeListGigaDrain[]   = {ITEM_ELIXIR,           ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_GREAT_BALL};
static const enum Item sPrizeListAttract[]     = {ITEM_ELIXIR,           ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_GREAT_BALL};
