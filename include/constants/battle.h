...
enum BattleEnvironments
{
    ...
    //Type-based
    //BATTLE_ENVIRONMENT_TYPE_BUG,
    BATTLE_ENVIRONMENT_TYPE_DARK,
    //BATTLE_ENVIRONMENT_TYPE_DRAGON,
    //BATTLE_ENVIRONMENT_TYPE_ELECTRIC,
    //BATTLE_ENVIRONMENT_TYPE_FAIRY,
    BATTLE_ENVIRONMENT_TYPE_FIGHTING,
    //BATTLE_ENVIRONMENT_TYPE_FIRE,
    BATTLE_ENVIRONMENT_TYPE_FLYING,
    //BATTLE_ENVIRONMENT_TYPE_GHOST,
    BATTLE_ENVIRONMENT_TYPE_GRASS,
    //BATTLE_ENVIRONMENT_TYPE_GROUND,
    BATTLE_ENVIRONMENT_TYPE_ICE,
    //BATTLE_ENVIRONMENT_TYPE_NORMAL,
    //BATTLE_ENVIRONMENT_TYPE_POISON,
    BATTLE_ENVIRONMENT_TYPE_PSYCHIC,
    BATTLE_ENVIRONMENT_TYPE_ROCK,
    //BATTLE_ENVIRONMENT_TYPE_STEEL,
    //BATTLE_ENVIRONMENT_TYPE_WATER,
