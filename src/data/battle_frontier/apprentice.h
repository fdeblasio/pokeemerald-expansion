...
const struct ApprenticeTrainer gApprentices[NUM_APPRENTICES] =
{
    ...
    },
    {
        ...
        .species = {SPECIES_SKARMORY, SPECIES_GOLEM, SPECIES_GIGALITH, SPECIES_CAMERUPT, SPECIES_DONPHAN, SPECIES_TORKOAL, SPECIES_MUDSDALE, SPECIES_GOLEM_ALOLA, SPECIES_TYRANITAR, SPECIES_RHYPERIOR},
        .id = 9,
