...
#define CORVIKNIGHT_GMAX_INFO                         \
    ...
    [SPECIES_ROOKIDEE_PARTNER] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_ZEPHYR, ABILITY_KEEN_EYE, ABILITY_BIG_PECKS },
...
#define CORVIKNIGHT_PARTNER_SPE 80
    ...
    [SPECIES_CORVIKNIGHT_PARTNER] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_ZEPHYR, ABILITY_KEEN_EYE, ABILITY_MIRROR_ARMOR },
        .bodyColor = BODY_COLOR_GRAY,
        .speciesName = _("Corviknight"),
        .cryId = CRY_CORVIKNIGHT,
        .natDexNum = NATIONAL_DEX_CORVIKNIGHT,
    ...
    [SPECIES_CORVIKNIGHT_MEGA_G] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = MEGA_ABILITY(ABILITY_MIRROR_ARMOR),
        .bodyColor = BODY_COLOR_GRAY,
        .speciesName = _("Corviknight"),
        .cryId = CRY_CORVIKNIGHT,
        .natDexNum = NATIONAL_DEX_CORVIKNIGHT,
...
#define ALCREMIE_REGULAR_SPECIES_INFO(sweet, cream, color)                                      \
    ...
    [SPECIES_SNOM] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 21, SPECIES_FROSMOTH}),
    },
