...
enum HoennDexOrder
{
    ...
    HOENN_DEX_DEWPIDER,
    HOENN_DEX_ARAQUANID, // Good Rod start
    HOENN_DEX_BUDEW, // Good Rod end
    HOENN_DEX_ROSELIA,
    HOENN_DEX_ROSERADE,
    HOENN_DEX_BOUNSWEET,
    HOENN_DEX_STEENEE,
    ...
    HOENN_DEX_CRADILY,
    HOENN_DEX_ANORITH,
    HOENN_DEX_ARMALDO, // Surf start // Surf end
    HOENN_DEX_IGGLYBUFF,
    ...
    HOENN_DEX_MEDITITE,
    HOENN_DEX_MEDICHAM,
    HOENN_DEX_FALINKS, // Dive and Super Rod start // Dive and Super Rod end
    HOENN_DEX_SWINUB,
    HOENN_DEX_PILOSWINE,
    HOENN_DEX_MAMOSWINE,
    HOENN_DEX_DELIBIRD,
