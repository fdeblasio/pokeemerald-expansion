...
- Squirtle/Wartortle/Blastoise (postgame):
...
- Snorunt/Glalie/Froslass (postgame):
...
- Hisuian Zorua/Hisuian Zoroark (postgame):
...
- Braixen/Delphox (postgame):
    - Learn Flame Burst by level up

- Froakie/Frogadier (postgame):
