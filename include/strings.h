...
extern const u8 gText_DefaultNameThomas[];
extern const u8 gText_DefaultNameThoma[];
extern const u8 gText_DefaultNameVannessa[];
extern const u8 gText_DefaultNameKristen[];
extern const u8 gText_DefaultNameAna[];
