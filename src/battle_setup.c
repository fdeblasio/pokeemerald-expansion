...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    REMATCH(FLANNERY, LAVARIDGE_TOWN),
    REMATCH(NORMAN, PETALBURG_CITY),
    REMATCH(WINONA, FORTREE_CITY),
    REMATCH(TATE_AND_LIZA, MOSSDEEP_CITY),
    REMATCH(JUAN, SOOTOPOLIS_CITY),
...
{
    CreateMaleMon(&gEnemyParty[0], WALLY_STARTER, 5);
    LockPlayerFieldControls();
