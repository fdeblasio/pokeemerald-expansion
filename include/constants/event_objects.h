...
//    OBJ_EVENT_GFX_BATTLE_GIRL = OBJ_EVENT_GFX_GIRL_3, //already in use by FRLG, although that should be renamed to Crush Girl
    OBJ_EVENT_GFX_SCHOOLKID_F = OBJ_EVENT_GFX_GIRL_3,
    ...
    OBJ_EVENT_GFX_POKEMON_BREEDER_F = OBJ_EVENT_GFX_WOMAN_2,
    OBJ_EVENT_GFX_LADY = OBJ_EVENT_GFX_WOMAN_2,
    OBJ_EVENT_GFX_AROMA_LADY = OBJ_EVENT_GFX_WOMAN_2,
    ...
    OBJ_EVENT_GFX_YOUNG_COUPLE_F = OBJ_EVENT_GFX_WOMAN_4,
    OBJ_EVENT_GFX_COOK,
    OBJ_EVENT_GFX_LINK_RECEPTIONIST,
    OBJ_EVENT_GFX_OLD_MAN,
    OBJ_EVENT_GFX_OLD_WOMAN,
    OBJ_EVENT_GFX_CAMPER,
    OBJ_EVENT_GFX_POKEMON_RANGER_M = OBJ_EVENT_GFX_CAMPER,
    OBJ_EVENT_GFX_PICNICKER,
    OBJ_EVENT_GFX_POKEMON_RANGER_F = OBJ_EVENT_GFX_PICNICKER,
    OBJ_EVENT_GFX_MAN_3,
    OBJ_EVENT_GFX_ACE_TRAINER_M = OBJ_EVENT_GFX_MAN_3,
    OBJ_EVENT_GFX_WOMAN_5,
    OBJ_EVENT_GFX_ACE_TRAINER_F = OBJ_EVENT_GFX_WOMAN_5,
    OBJ_EVENT_GFX_PARASOL_LADY = OBJ_EVENT_GFX_WOMAN_5,
    OBJ_EVENT_GFX_YOUNGSTER,
    OBJ_EVENT_GFX_BUG_CATCHER,
    OBJ_EVENT_GFX_PSYCHIC_M,
    OBJ_EVENT_GFX_BIRD_KEEPER = OBJ_EVENT_GFX_PSYCHIC_M,
    OBJ_EVENT_GFX_DRAGON_TAMER = OBJ_EVENT_GFX_PSYCHIC_M,
    OBJ_EVENT_GFX_SCHOOLKID_M,
    OBJ_EVENT_GFX_MANIAC,
    OBJ_EVENT_GFX_POKE_MANIAC = OBJ_EVENT_GFX_MANIAC,
    OBJ_EVENT_GFX_BUG_MANIAC = OBJ_EVENT_GFX_MANIAC,
    OBJ_EVENT_GFX_COLLECTOR = OBJ_EVENT_GFX_MANIAC,
    OBJ_EVENT_GFX_HEX_MANIAC,
    OBJ_EVENT_GFX_RAYQUAZA_STILL,
    OBJ_EVENT_GFX_SWIMMER_M,
    OBJ_EVENT_GFX_SWIMMING_TRIATHLETE_M = OBJ_EVENT_GFX_SWIMMER_M,
    OBJ_EVENT_GFX_SWIMMER_F,
    OBJ_EVENT_GFX_SWIMMING_TRIATHLETE_F = OBJ_EVENT_GFX_SWIMMER_F,
    OBJ_EVENT_GFX_BLACK_BELT,
    OBJ_EVENT_GFX_BEAUTY,
    OBJ_EVENT_GFX_SCIENTIST_1,
    OBJ_EVENT_GFX_LASS,
    OBJ_EVENT_GFX_PSYCHIC_F = OBJ_EVENT_GFX_LASS,
    ...
    OBJ_EVENT_GFX_HIKER,
    OBJ_EVENT_GFX_RUIN_MANIAC = OBJ_EVENT_GFX_HIKER,
    ...
    OBJ_EVENT_GFX_MAN_4,
    OBJ_EVENT_GFX_POKEMON_BREEDER_M = OBJ_EVENT_GFX_MAN_4,
    OBJ_EVENT_GFX_YOUNG_COUPLE_M = OBJ_EVENT_GFX_MAN_4,
    OBJ_EVENT_GFX_MAN_5,
    OBJ_EVENT_GFX_GUITARIST = OBJ_EVENT_GFX_MAN_5,
    OBJ_EVENT_GFX_KINDLER = OBJ_EVENT_GFX_MAN_5,
    ...
    OBJ_EVENT_GFX_REGIROCK, //Unused
    OBJ_EVENT_GFX_REGICE, //Unused
    OBJ_EVENT_GFX_REGISTEEL, //Unused
    OBJ_EVENT_GFX_SKITTY, //Unused
    OBJ_EVENT_GFX_KECLEON,
    OBJ_EVENT_GFX_KYOGRE_ASLEEP,
    OBJ_EVENT_GFX_GROUDON_ASLEEP,
    OBJ_EVENT_GFX_RAYQUAZA,
    OBJ_EVENT_GFX_ZIGZAGOON_2, //Unused
    OBJ_EVENT_GFX_PIKACHU, //Unused
    OBJ_EVENT_GFX_AZUMARILL, //Unused
    OBJ_EVENT_GFX_WINGULL, //Unused
    OBJ_EVENT_GFX_KECLEON_BRIDGE_SHADOW,
    OBJ_EVENT_GFX_TUBER_M_SWIMMING,
    OBJ_EVENT_GFX_AZURILL, //Unused
    OBJ_EVENT_GFX_MOM,
    ...
    OBJ_EVENT_GFX_KIRLIA, //Unused
    OBJ_EVENT_GFX_DUSCLOPS, //Unused
    ...
    OBJ_EVENT_GFX_LUGIA, //Unused
    OBJ_EVENT_GFX_HOOH, //Unused
    OBJ_EVENT_GFX_HO_OH = OBJ_EVENT_GFX_HOOH,
...
// FRLG objects
    ...
    OBJ_EVENT_GFX_PSYCHIC_M_FRLG = OBJ_EVENT_GFX_COOLTRAINER_M,
    ...
    OBJ_EVENT_GFX_PSYCHIC_F_FRLG = OBJ_EVENT_GFX_WOMAN_1_FRLG,
    ...
    OBJ_EVENT_GFX_POKEMON_RANGER_M_FRLG = OBJ_EVENT_GFX_CAMPER_FRLG,
    OBJ_EVENT_GFX_PICNICKER_FRLG,
    OBJ_EVENT_GFX_POKEMON_RANGER_F_FRLG = OBJ_EVENT_GFX_PICNICKER_FRLG,
