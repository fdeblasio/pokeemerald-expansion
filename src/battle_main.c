...
static const u16 sTrainerBallTable[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_MAGMA_LEADER] = ITEM_HEAVY_BALL,
    [TRAINER_CLASS_AQUA_LEADER] = ITEM_DIVE_BALL,
    [TRAINER_CLASS_MAGMA_ADMIN] = ITEM_HEAVY_BALL,
    [TRAINER_CLASS_AQUA_ADMIN] = ITEM_DIVE_BALL,
    [TRAINER_CLASS_TEAM_MAGMA] = ITEM_HEAVY_BALL,
    [TRAINER_CLASS_TEAM_AQUA] = ITEM_DIVE_BALL,
    [TRAINER_CLASS_WINSTRATE] = ITEM_ULTRA_BALL,
    [TRAINER_CLASS_COOLTRAINER] = ITEM_ULTRA_BALL,
    [TRAINER_CLASS_COOLTRAINER_2] = ITEM_CHERISH_BALL,
    ...
    [TRAINER_CLASS_POKEFAN] = ITEM_REPEAT_BALL,
    [TRAINER_CLASS_PKMN_RANGER] = ITEM_GREAT_BALL,
