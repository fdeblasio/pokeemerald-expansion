...
{
    TRAINER_CLASS(PKMN_TRAINER_1, "{PKMN} Trainer", 15, DEFAULT_BALL),
    TRAINER_CLASS(PKMN_TRAINER_2, "{PKMN} Trainer", DEFAULT_MONEY, DEFAULT_BALL),
    TRAINER_CLASS(HIKER, "Hiker", 10, ITEM_HEAVY_BALL),
    TRAINER_CLASS(TEAM_AQUA, "Team Aqua", 5, ITEM_DIVE_BALL),
    TRAINER_CLASS(PKMN_BREEDER, "{PKMN} Breeder", 10, ITEM_FRIEND_BALL),
    TRAINER_CLASS(COOLTRAINER, "Ace Trainer", 12, ITEM_ULTRA_BALL),
    TRAINER_CLASS(BIRD_KEEPER, "Bird Keeper", 8, ITEM_NEST_BALL),
    TRAINER_CLASS(COLLECTOR, "Collector", 15, ITEM_PREMIER_BALL),
    TRAINER_CLASS(SWIMMER_M, "Swimmer♂", 2, ITEM_DIVE_BALL),
    TRAINER_CLASS(TEAM_MAGMA, "Team Magma", 5, ITEM_HEAVY_BALL),
    ...
    TRAINER_CLASS(AQUA_LEADER, "Aqua Leader", 20, ITEM_DIVE_BALL),
    ...
    TRAINER_CLASS(INTERVIEWER, "Interviewers", 12, DEFAULT_BALL),
    ...
    TRAINER_CLASS(BEAUTY, "Beauty", 20, ITEM_GREAT_BALL),
    TRAINER_CLASS(RICH_BOY, "Rich Boy", 50, ITEM_LUXURY_BALL),
    TRAINER_CLASS(POKEMANIAC, "Poké Maniac", 15, DEFAULT_BALL),
    ...
    TRAINER_CLASS(SCHOOL_KID, "Schoolkid", 5, DEFAULT_BALL),
    ...
    TRAINER_CLASS(SAILOR, "Sailor", 8, ITEM_DIVE_BALL),
    TRAINER_CLASS(COOLTRAINER_2, "Cool Trainer", DEFAULT_MONEY, ITEM_CHERISH_BALL),
    TRAINER_CLASS(MAGMA_ADMIN, "Magma Admin", 10, ITEM_HEAVY_BALL),
    TRAINER_CLASS(RIVAL, "{PKMN} Trainer", 15, DEFAULT_BALL),
    TRAINER_CLASS(BUG_CATCHER, "Bug Catcher", 4, ITEM_NET_BALL),
    TRAINER_CLASS(PKMN_RANGER, "{PKMN} Ranger", 12, ITEM_NEST_BALL),
    TRAINER_CLASS(MAGMA_LEADER, "Magma Leader", 20, ITEM_HEAVY_BALL),
    TRAINER_CLASS(LASS, "Lass", 4, DEFAULT_BALL),
    TRAINER_CLASS(YOUNG_COUPLE, "Young Couple", 8, ITEM_LOVE_BALL),
    TRAINER_CLASS(OLD_COUPLE, "Old Couple", 10, ITEM_ULTRA_BALL),
    TRAINER_CLASS(SIS_AND_BRO, "Sis & Bro", 3, ITEM_DIVE_BALL),
    ...
    TRAINER_CLASS(BIKER, "Biker", DEFAULT_MONEY, DEFAULT_BALL),
};
