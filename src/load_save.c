...
struct LoadedSaveData
{
 ...
 /*0x0130*/ struct ItemSlot TMsHMs[BAG_TM_COUNT];
...
void LoadPlayerBag(void)
{
    ...
    for (i = 0; i < BAG_TM_COUNT; i++)
        gLoadedSaveData.TMsHMs[i] = gSaveBlock1Ptr->bagPocket_TM[i];
...
void SavePlayerBag(void)
{
    ...
    for (i = 0; i < BAG_TM_COUNT; i++)
        gSaveBlock1Ptr->bagPocket_TM[i] = gLoadedSaveData.TMsHMs[i];
