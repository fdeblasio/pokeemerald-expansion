...
const struct SpeciesInfo gSpeciesInfoGen7[] =
{
    ...
    [SPECIES_DARTRIX] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 36, SPECIES_DECIDUEYE}
                            #if P_HISUIAN_FORMS
                                ,{EVO_ITEM, ITEM_DUSK_STONE, SPECIES_DECIDUEYE_HISUI}
                            #endif
                            ),
    },
...
#define ORICORIO_INFO(Color)                                     \
    ...
    [SPECIES_BEWEAR] =
    {
        ...
        .baseSpDefense = 60,
        .types = MON_TYPES(TYPE_NORMAL, TYPE_FIGHTING),
        .catchRate = DEFAULT_CATCH_RATE(70),
        .expYield = 175,
        .evYield_Attack = 2,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 15,
    ...
    [SPECIES_BOUNSWEET] =
    {
        ...
        .baseSpDefense = 38,
        .types = MON_TYPES(TYPE_GRASS),
        .catchRate = DEFAULT_CATCH_RATE(235),
        .expYield = 42,
        .evYield_HP = 1,
    ...
    [SPECIES_TYPE_NULL] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 45, SPECIES_SILVALLY_NORMAL}),
    },
...
#define MINIOR_CORE_SPECIES_INFO(Form, color, iconPal, heldItem)\
    ...
    [SPECIES_MINIOR_CORE_ORANGE]   = MINIOR_CORE_SPECIES_INFO(Orange, BODY_COLOR_ORANGE, 0, ITEM_HARD_STONE),
    ...
    [SPECIES_TURTONATOR] =
    {
        ...
        .catchRate = BOOSTED_CATCH_RATE(70),
        .expYield = 170,
        .evYield_Defense = 2,
...
#define MIMIKYU_TOTEM_INFO \
    ...
    [SPECIES_DHELMISE] =
    {
        ...
        .catchRate = BOOSTED_CATCH_RATE(25),
        .expYield = 181,
        .evYield_Attack = 2,
        .genderRatio = MON_GENDERLESS,
        .eggCycles = 25,
...
#define ULTRA_BEAST_INFO                                              \
    ...
    [SPECIES_MELTAN] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_MELMETAL}),
    },
